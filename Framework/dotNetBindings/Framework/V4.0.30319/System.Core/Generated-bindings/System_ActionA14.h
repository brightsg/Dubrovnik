//++Dubrovnik.CodeGenerator System_ActionA14.h
//
// Managed class : Action`14
//
@interface System_ActionA14 : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
