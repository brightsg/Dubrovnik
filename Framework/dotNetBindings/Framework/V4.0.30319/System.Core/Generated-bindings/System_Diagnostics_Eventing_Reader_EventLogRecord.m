...
//++Dubrovnik.CodeGenerator System_Diagnostics_Eventing_Reader_EventLogRecord.m
//
...
@implementation System_Diagnostics_Eventing_Reader_EventLogRecord
...
#pragma mark Setup
	...
	{
		return "System.Diagnostics.Eventing.Reader.EventLogRecord";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    @synthesize containerLog = _containerLog;
    - (NSString *)containerLog
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "ContainerLog");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_containerLog isEqualToMonoObject:monoObject]) return _containerLog;					
		_containerLog = [NSString stringWithMonoString:DB_STRING(monoObject)];
    ...
    @synthesize matchedQueryIds = _matchedQueryIds;
    - (System_Collections_Generic_IEnumerableA1 *)matchedQueryIds
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "MatchedQueryIds");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_matchedQueryIds isEqualToMonoObject:monoObject]) return _matchedQueryIds;					
		_matchedQueryIds = [System_Collections_Generic_IEnumerableA1 bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (id <System_Collections_Generic_IListA1>)getPropertyValues_withPropertySelector:(System_Diagnostics_Eventing_Reader_EventLogPropertySelector *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetPropertyValues(System.Diagnostics.Eventing.Reader.EventLogPropertySelector)" withNumArgs:1, [p1 monoRTInvokeArg]];
