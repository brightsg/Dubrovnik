//++Dubrovnik.CodeGenerator System_Diagnostics_Eventing_Reader_EventRecord.h
//
// Managed class : EventRecord
//
@interface System_Diagnostics_Eventing_Reader_EventRecord : System_Object <System_IDisposable_>
