//++Dubrovnik.CodeGenerator System_FuncA10.h
//
// Managed class : Func`10
//
@interface System_FuncA10 : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
