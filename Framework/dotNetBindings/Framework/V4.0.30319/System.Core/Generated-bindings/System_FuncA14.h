//++Dubrovnik.CodeGenerator System_FuncA14.h
//
// Managed class : Func`14
//
@interface System_FuncA14 : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
