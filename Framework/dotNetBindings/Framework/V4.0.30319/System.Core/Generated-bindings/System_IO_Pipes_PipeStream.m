...
//++Dubrovnik.CodeGenerator System_IO_Pipes_PipeStream.m
//
...
@implementation System_IO_Pipes_PipeStream
...
#pragma mark Properties
    ...
    @synthesize inBufferSize = _inBufferSize;
    - (int32_t)inBufferSize
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "InBufferSize");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_inBufferSize = monoObject;
    ...
    - (BOOL)isConnected
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "IsConnected");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		BOOL monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_isConnected = monoObject;
    ...
    - (void)setIsConnected:(BOOL)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "IsConnected");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
    ...
    - (BOOL)isMessageComplete
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "IsMessageComplete");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		BOOL monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_isMessageComplete = monoObject;
	...
	// Managed property type : System.Int32
    @synthesize outBufferSize = _outBufferSize;
    - (int32_t)outBufferSize
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "OutBufferSize");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_outBufferSize = monoObject;
    ...
    - (int32_t)readMode
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "ReadMode");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_readMode = monoObject;
    ...
    @synthesize safePipeHandle = _safePipeHandle;
    - (Microsoft_Win32_SafeHandles_SafePipeHandle *)safePipeHandle
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "SafePipeHandle");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_safePipeHandle isEqualToMonoObject:monoObject]) return _safePipeHandle;					
		_safePipeHandle = [Microsoft_Win32_SafeHandles_SafePipeHandle bestObjectWithMonoObject:monoObject];

		return _safePipeHandle;
	}
...
#pragma mark Methods
    ...
    - (System_IO_Pipes_PipeSecurity *)getAccessControl
    {
		...
		return [System_IO_Pipes_PipeSecurity bestObjectWithMonoObject:monoObject];
    }
    ...
    - (void)setAccessControl_withPipeSecurity:(System_IO_Pipes_PipeSecurity *)p1
    {
		...
		[self invokeMonoMethod:"SetAccessControl(System.IO.Pipes.PipeSecurity)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)waitForPipeDrain
    {
		...
		[self invokeMonoMethod:"WaitForPipeDrain()" withNumArgs:0];
