//++Dubrovnik.CodeGenerator System_Linq_Expressions_ConstantExpression.h
//
// Managed class : ConstantExpression
//
@interface System_Linq_Expressions_ConstantExpression : System_Linq_Expressions_Expression
