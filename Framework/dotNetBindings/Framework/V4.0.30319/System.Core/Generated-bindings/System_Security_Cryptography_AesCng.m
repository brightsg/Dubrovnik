...
//++Dubrovnik.CodeGenerator System_Security_Cryptography_AesCng.m
//
...
@implementation System_Security_Cryptography_AesCng
...
#pragma mark Setup
	...
	{
		return "System.Security.Cryptography.AesCng";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Security_Cryptography_AesCng *)new_withKeyName:(NSString *)p1
    {
		...
		System_Security_Cryptography_AesCng * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Security_Cryptography_AesCng *)new_withKeyName:(NSString *)p1 provider:(System_Security_Cryptography_CngProvider *)p2
    {
		...
		System_Security_Cryptography_AesCng * object = [[self alloc] initWithSignature:"string,System.Security.Cryptography.CngProvider" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Security_Cryptography_AesCng *)new_withKeyName:(NSString *)p1 provider:(System_Security_Cryptography_CngProvider *)p2 openOptions:(int32_t)p3
    {
		...
		System_Security_Cryptography_AesCng * object = [[self alloc] initWithSignature:"string,System.Security.Cryptography.CngProvider,System.Security.Cryptography.CngKeyOpenOptions" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], DB_VALUE(p3)];
