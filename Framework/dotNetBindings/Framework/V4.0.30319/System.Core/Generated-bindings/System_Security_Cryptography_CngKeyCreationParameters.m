...
//++Dubrovnik.CodeGenerator System_Security_Cryptography_CngKeyCreationParameters.m
//
...
@implementation System_Security_Cryptography_CngKeyCreationParameters
...
#pragma mark Setup
	...
	{
		return "System.Security.Cryptography.CngKeyCreationParameters";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    - (System_NullableA1 *)exportPolicy
    {
		...
		if ([self object:_exportPolicy isEqualToMonoObject:monoObject]) return _exportPolicy;					
		_exportPolicy = [System_NullableA1 bestObjectWithMonoObject:monoObject];

		return _exportPolicy;
	}
    - (void)setExportPolicy:(System_NullableA1 *)value
	{
		_exportPolicy = value;
    ...
    @synthesize keyCreationOptions = _keyCreationOptions;
    - (int32_t)keyCreationOptions
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "KeyCreationOptions");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_keyCreationOptions = monoObject;

		return _keyCreationOptions;
	}
    - (void)setKeyCreationOptions:(int32_t)value
	{
		_keyCreationOptions = value;
		typedef void (*Thunk)(MonoObject *, int32_t, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "KeyCreationOptions");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
    ...
    - (System_NullableA1 *)keyUsage
    {
		...
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_keyUsage isEqualToMonoObject:monoObject]) return _keyUsage;					
		_keyUsage = [System_NullableA1 bestObjectWithMonoObject:monoObject];

		return _keyUsage;
	}
    - (void)setKeyUsage:(System_NullableA1 *)value
	{
		_keyUsage = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "KeyUsage");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
    ...
    - (System_Security_Cryptography_CngPropertyCollection *)parameters
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_parameters = [System_Security_Cryptography_CngPropertyCollection bestObjectWithMonoObject:monoObject];
    ...
    - (void)setProvider:(System_Security_Cryptography_CngProvider *)value
	{
		_provider = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
    ...
    - (void)setUIPolicy:(System_Security_Cryptography_CngUIPolicy *)value
	{
		_uIPolicy = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "UIPolicy");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
