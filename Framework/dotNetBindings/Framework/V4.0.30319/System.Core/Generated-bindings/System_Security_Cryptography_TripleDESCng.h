//++Dubrovnik.CodeGenerator System_Security_Cryptography_TripleDESCng.h
//
// Managed class : TripleDESCng
//
@interface System_Security_Cryptography_TripleDESCng : System_Security_Cryptography_TripleDES <System_IDisposable_>
