...
//++Dubrovnik.CodeGenerator Microsoft_SqlServer_Server_SqlFacetAttribute.m
//
...
@implementation Microsoft_SqlServer_Server_SqlFacetAttribute
...
#pragma mark Setup
	...
	{
		return "Microsoft.SqlServer.Server.SqlFacetAttribute";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    - (void)setMaxSize:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "MaxSize");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
