...
//++Dubrovnik.CodeGenerator System_Data_Common_DbDataReader.m
//
...
@implementation System_Data_Common_DbDataReader
...
#pragma mark Methods
    ...
    - (System_Threading_Tasks_TaskA1 *)getFieldValueAsync_withOrdinal:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetFieldValueAsync(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (System_Threading_Tasks_TaskA1 *)isDBNullAsync_withOrdinal:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IsDBNullAsync(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (System_Threading_Tasks_TaskA1 *)nextResultAsync
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"NextResultAsync()" withNumArgs:0];
