//++Dubrovnik.CodeGenerator System_Data_Common_DbDataRecord.h
//
// Managed class : DbDataRecord
//
@interface System_Data_Common_DbDataRecord : System_Object <System_ComponentModel_ICustomTypeDescriptor_, System_Data_IDataRecord_>
