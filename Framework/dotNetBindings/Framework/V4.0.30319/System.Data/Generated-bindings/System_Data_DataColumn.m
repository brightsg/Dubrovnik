...
#pragma mark Constructors
    ...
    + (System_Data_DataColumn *)new_withColumnName:(NSString *)p1 dataType:(System_Type *)p2
    {
		...
		System_Data_DataColumn * object = [[self alloc] initWithSignature:"string,System.Type" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Data_DataColumn *)new_withColumnName:(NSString *)p1 dataType:(System_Type *)p2 expr:(NSString *)p3 type:(int32_t)p4
    {
		...
		System_Data_DataColumn * object = [[self alloc] initWithSignature:"string,System.Type,string,System.Data.MappingType" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], DB_VALUE(p4)];
    ...
    + (System_Data_DataColumn *)new_withColumnName:(NSString *)p1
    {
		...
		System_Data_DataColumn * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Data_DataColumn *)new_withColumnName:(NSString *)p1 dataType:(System_Type *)p2 expr:(NSString *)p3
    {
		...
		System_Data_DataColumn * object = [[self alloc] initWithSignature:"string,System.Type,string" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    @synthesize columnMapping = _columnMapping;
    - (int32_t)columnMapping
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "ColumnMapping");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_columnMapping = monoObject;

		return _columnMapping;
	}
    - (void)setColumnMapping:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "ColumnMapping");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
    ...
    - (void)setDateTimeMode:(int32_t)value
	{
		_dateTimeMode = value;
		typedef void (*Thunk)(MonoObject *, int32_t, MonoObject**);
		static Thunk thunk;
...
#pragma mark Methods
    ...
    - (void)setOrdinal_withOrdinal:(int32_t)p1
    {
		...
		[self invokeMonoMethod:"SetOrdinal(int)" withNumArgs:1, DB_VALUE(p1)];
