...
//++Dubrovnik.CodeGenerator System_Data_Odbc_OdbcDataReader.m
//
...
@implementation System_Data_Odbc_OdbcDataReader
...
#pragma mark Setup
	...
	{
		return "System.Data.Odbc.OdbcDataReader";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    - (NSDate *)getDate_withI:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetDate(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (System_TimeSpan *)getTime_withI:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetTime(int)" withNumArgs:1, DB_VALUE(p1)];
