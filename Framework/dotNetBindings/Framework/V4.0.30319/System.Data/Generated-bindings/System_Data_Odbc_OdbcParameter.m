...
//++Dubrovnik.CodeGenerator System_Data_Odbc_OdbcParameter.m
//
...
@implementation System_Data_Odbc_OdbcParameter
...
#pragma mark Setup
	...
	{
		return "System.Data.Odbc.OdbcParameter";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Data_Odbc_OdbcParameter *)new_withName:(NSString *)p1 value:(System_Object *)p2
    {
		...
		System_Data_Odbc_OdbcParameter * object = [[self alloc] initWithSignature:"string,object" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Data_Odbc_OdbcParameter *)new_withName:(NSString *)p1 type:(int32_t)p2
    {
		...
		System_Data_Odbc_OdbcParameter * object = [[self alloc] initWithSignature:"string,System.Data.Odbc.OdbcType" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    + (System_Data_Odbc_OdbcParameter *)new_withName:(NSString *)p1 type:(int32_t)p2 size:(int32_t)p3
    {
		...
		System_Data_Odbc_OdbcParameter * object = [[self alloc] initWithSignature:"string,System.Data.Odbc.OdbcType,int" withNumArgs:3, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3)];
    ...
    + (System_Data_Odbc_OdbcParameter *)new_withName:(NSString *)p1 type:(int32_t)p2 size:(int32_t)p3 sourcecolumn:(NSString *)p4
    {
		...
		System_Data_Odbc_OdbcParameter * object = [[self alloc] initWithSignature:"string,System.Data.Odbc.OdbcType,int,string" withNumArgs:4, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3), [p4 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (int32_t)odbcType
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "OdbcType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_odbcType = monoObject;

		return _odbcType;
	}
    - (void)setOdbcType:(int32_t)value
	{
		_odbcType = value;
		typedef void (*Thunk)(MonoObject *, int32_t, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "OdbcType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
...
#pragma mark Methods
    ...
    - (void)resetOdbcType
    {
		...
		[self invokeMonoMethod:"ResetOdbcType()" withNumArgs:0];
