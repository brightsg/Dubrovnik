...
//++Dubrovnik.CodeGenerator System_Data_OleDb_OleDbCommand.m
//
...
@implementation System_Data_OleDb_OleDbCommand
...
#pragma mark Setup
	...
	{
		return "System.Data.OleDb.OleDbCommand";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Data_OleDb_OleDbCommand *)new_withCmdText:(NSString *)p1
    {
		...
		System_Data_OleDb_OleDbCommand * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Data_OleDb_OleDbCommand *)new_withCmdText:(NSString *)p1 connection:(System_Data_OleDb_OleDbConnection *)p2
    {
		...
		System_Data_OleDb_OleDbCommand * object = [[self alloc] initWithSignature:"string,System.Data.OleDb.OleDbConnection" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Data_OleDb_OleDbCommand *)new_withCmdText:(NSString *)p1 connection:(System_Data_OleDb_OleDbConnection *)p2 transaction:(System_Data_OleDb_OleDbTransaction *)p3
    {
		...
		System_Data_OleDb_OleDbCommand * object = [[self alloc] initWithSignature:"string,System.Data.OleDb.OleDbConnection,System.Data.OleDb.OleDbTransaction" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (void)setConnection:(System_Data_OleDb_OleDbConnection *)value
	{
		_connection = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
    ...
    - (System_Data_OleDb_OleDbParameterCollection *)parameters
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_parameters = [System_Data_OleDb_OleDbParameterCollection bestObjectWithMonoObject:monoObject];
    ...
    - (System_Data_OleDb_OleDbTransaction *)transaction
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_transaction = [System_Data_OleDb_OleDbTransaction bestObjectWithMonoObject:monoObject];

		return _transaction;
	}
    - (void)setTransaction:(System_Data_OleDb_OleDbTransaction *)value
	{
		_transaction = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
