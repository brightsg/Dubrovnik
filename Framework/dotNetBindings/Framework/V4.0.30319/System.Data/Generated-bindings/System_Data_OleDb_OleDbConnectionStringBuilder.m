...
//++Dubrovnik.CodeGenerator System_Data_OleDb_OleDbConnectionStringBuilder.m
//
...
@implementation System_Data_OleDb_OleDbConnectionStringBuilder
...
#pragma mark Setup
	...
	{
		return "System.Data.OleDb.OleDbConnectionStringBuilder";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Data_OleDb_OleDbConnectionStringBuilder *)new_withConnectionString:(NSString *)p1
    {
		...
		System_Data_OleDb_OleDbConnectionStringBuilder * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    @synthesize oleDbServices = _oleDbServices;
    - (int32_t)oleDbServices
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "OleDbServices");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_oleDbServices = monoObject;

		return _oleDbServices;
	}
    - (void)setOleDbServices:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "OleDbServices");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
