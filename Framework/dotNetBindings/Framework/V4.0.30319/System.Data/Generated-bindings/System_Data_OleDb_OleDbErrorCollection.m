...
//++Dubrovnik.CodeGenerator System_Data_OleDb_OleDbErrorCollection.m
//
...
@implementation System_Data_OleDb_OleDbErrorCollection
...
#pragma mark Setup
	...
	{
		return "System.Data.OleDb.OleDbErrorCollection";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    - (System_Data_OleDb_OleDbError *)item
    {
		...
		_item = [System_Data_OleDb_OleDbError bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (void)copyTo_withArraySDOOleDbError:(DBSystem_Array *)p1 indexInt:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Data.OleDb.OleDbError[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
