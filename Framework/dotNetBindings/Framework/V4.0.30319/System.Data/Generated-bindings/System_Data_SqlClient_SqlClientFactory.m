...
//++Dubrovnik.CodeGenerator System_Data_SqlClient_SqlClientFactory.m
//
...
@implementation System_Data_SqlClient_SqlClientFactory
...
#pragma mark Fields
    ...
    static System_Data_SqlClient_SqlClientFactory * m_instance;
    + (System_Data_SqlClient_SqlClientFactory *)instance
    {
		...
		m_instance = [System_Data_SqlClient_SqlClientFactory bestObjectWithMonoObject:monoObject];
