...
//++Dubrovnik.CodeGenerator System_Data_SqlClient_SqlClientPermission.m
//
...
@implementation System_Data_SqlClient_SqlClientPermission
...
#pragma mark Setup
	...
	{
		return "System.Data.SqlClient.SqlClientPermission";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Data_SqlClient_SqlClientPermission *)new_withState:(int32_t)p1
    {
		...
		System_Data_SqlClient_SqlClientPermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.PermissionState" withNumArgs:1, DB_VALUE(p1)];
    ...
    + (System_Data_SqlClient_SqlClientPermission *)new_withState:(int32_t)p1 allowBlankPassword:(BOOL)p2
    {
		...
		System_Data_SqlClient_SqlClientPermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.PermissionState,bool" withNumArgs:2, DB_VALUE(p1), DB_VALUE(p2)];
