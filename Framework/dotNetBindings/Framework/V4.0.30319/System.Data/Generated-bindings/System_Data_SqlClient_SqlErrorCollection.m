...
//++Dubrovnik.CodeGenerator System_Data_SqlClient_SqlErrorCollection.m
//
...
@implementation System_Data_SqlClient_SqlErrorCollection
...
#pragma mark Properties
    ...
    - (System_Data_SqlClient_SqlError *)item
    {
		...
		_item = [System_Data_SqlClient_SqlError bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (void)copyTo_withArraySDSSqlError:(DBSystem_Array *)p1 indexInt:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Data.SqlClient.SqlError[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
