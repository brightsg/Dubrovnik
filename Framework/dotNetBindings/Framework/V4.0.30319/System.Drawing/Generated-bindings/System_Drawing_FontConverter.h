//++Dubrovnik.CodeGenerator System_Drawing_FontConverter.h
//
// Managed class : FontConverter
//
@interface System_Drawing_FontConverter : System_ComponentModel_TypeConverter
