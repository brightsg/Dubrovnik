//++Dubrovnik.CodeGenerator System_Drawing_IconConverter.h
//
// Managed class : IconConverter
//
@interface System_Drawing_IconConverter : System_ComponentModel_ExpandableObjectConverter
