//++Dubrovnik.CodeGenerator System_Drawing_ImageConverter.h
//
// Managed class : ImageConverter
//
@interface System_Drawing_ImageConverter : System_ComponentModel_TypeConverter
