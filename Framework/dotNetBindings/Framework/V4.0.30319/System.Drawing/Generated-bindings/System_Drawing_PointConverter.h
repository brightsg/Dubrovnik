//++Dubrovnik.CodeGenerator System_Drawing_PointConverter.h
//
// Managed class : PointConverter
//
@interface System_Drawing_PointConverter : System_ComponentModel_TypeConverter
