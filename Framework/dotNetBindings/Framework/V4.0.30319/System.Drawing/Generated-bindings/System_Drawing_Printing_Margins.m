...
//++Dubrovnik.CodeGenerator System_Drawing_Printing_Margins.m
//
...
@implementation System_Drawing_Printing_Margins
...
#pragma mark Constructors
    ...
    + (System_Drawing_Printing_Margins *)new_withLeft:(int32_t)p1 right:(int32_t)p2 top:(int32_t)p3 bottom:(int32_t)p4
    {
		...
		System_Drawing_Printing_Margins * object = [[self alloc] initWithSignature:"int,int,int,int" withNumArgs:4, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4)];
...
#pragma mark Properties
    ...
    - (void)setBottom:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Bottom");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
    ...
    - (void)setTop:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Top");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
...
#pragma mark Methods
    ...
    + (BOOL)op_Equality_withM1:(System_Drawing_Printing_Margins *)p1 m2:(System_Drawing_Printing_Margins *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Drawing.Printing.Margins,System.Drawing.Printing.Margins)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withM1:(System_Drawing_Printing_Margins *)p1 m2:(System_Drawing_Printing_Margins *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Drawing.Printing.Margins,System.Drawing.Printing.Margins)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
