//++Dubrovnik.CodeGenerator System_Drawing_Printing_MarginsConverter.h
//
// Managed class : MarginsConverter
//
@interface System_Drawing_Printing_MarginsConverter : System_ComponentModel_ExpandableObjectConverter
