...
//++Dubrovnik.CodeGenerator System_Drawing_Printing_PrinterResolution.m
//
...
@implementation System_Drawing_Printing_PrinterResolution
...
#pragma mark Properties
    ...
    - (void)setKind:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Kind");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
