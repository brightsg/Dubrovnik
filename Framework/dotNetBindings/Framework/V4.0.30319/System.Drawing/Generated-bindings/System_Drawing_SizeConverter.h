//++Dubrovnik.CodeGenerator System_Drawing_SizeConverter.h
//
// Managed class : SizeConverter
//
@interface System_Drawing_SizeConverter : System_ComponentModel_TypeConverter
