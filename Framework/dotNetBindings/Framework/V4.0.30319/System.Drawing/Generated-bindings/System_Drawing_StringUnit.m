...
//++Dubrovnik.CodeGenerator System_Drawing_StringUnit.m
//
...
// C enumeration
@implementation System_Drawing_StringUnit
...
#pragma mark Setup
	...
	{
		return "System.Drawing.StringUnit";
	}
	// obligatory override
...
#pragma mark Fields
    ...
    + (int32_t)em
    {
		MonoObject *monoObject = [[self class] getMonoClassField:"Em"];
		m_em = DB_UNBOX_INT32(monoObject);
