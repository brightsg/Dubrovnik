#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaAttribute.m
//
...
@implementation System_Xml_Schema_XmlSchemaAttribute
...
#pragma mark Properties
    ...
    @synthesize attributeSchemaType = _attributeSchemaType;
    - (System_Xml_Schema_XmlSchemaSimpleType *)attributeSchemaType
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			...
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "AttributeSchemaType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_attributeSchemaType isEqualToMonoObject:monoObject]) return _attributeSchemaType;					
		_attributeSchemaType = [System_Xml_Schema_XmlSchemaSimpleType bestObjectWithMonoObject:monoObject];

		return _attributeSchemaType;
	}

	// Managed property name : AttributeType
	// Managed property type : System.Object
    @synthesize attributeType = _attributeType;
    - (System_Object *)attributeType
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_attributeType = [System_Object objectWithMonoObject:monoObject];
    ...
    - (System_Xml_Schema_XmlSchemaSimpleType *)schemaType
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_schemaType = [System_Xml_Schema_XmlSchemaSimpleType bestObjectWithMonoObject:monoObject];

		return _schemaType;
	}
    - (void)setSchemaType:(System_Xml_Schema_XmlSchemaSimpleType *)value
	{
		_schemaType = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
    ...
    - (int32_t)use
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "Use");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
    ...
    - (void)setUse:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Use");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
