#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaAttributeGroup.m
//
...
@implementation System_Xml_Schema_XmlSchemaAttributeGroup
...
#pragma mark Properties
    ...
    @synthesize redefinedAttributeGroup = _redefinedAttributeGroup;
    - (System_Xml_Schema_XmlSchemaAttributeGroup *)redefinedAttributeGroup
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "RedefinedAttributeGroup");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_redefinedAttributeGroup isEqualToMonoObject:monoObject]) return _redefinedAttributeGroup;					
		_redefinedAttributeGroup = [System_Xml_Schema_XmlSchemaAttributeGroup bestObjectWithMonoObject:monoObject];

		return _redefinedAttributeGroup;
	}
