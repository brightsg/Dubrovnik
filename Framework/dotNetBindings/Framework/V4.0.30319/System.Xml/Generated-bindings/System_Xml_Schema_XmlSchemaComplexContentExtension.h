//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaComplexContentExtension.h
//
// Managed class : XmlSchemaComplexContentExtension
//
@interface System_Xml_Schema_XmlSchemaComplexContentExtension : System_Xml_Schema_XmlSchemaContent
