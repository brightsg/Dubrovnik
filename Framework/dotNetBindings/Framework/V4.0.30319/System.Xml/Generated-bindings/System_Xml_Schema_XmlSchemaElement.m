#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaElement.m
//
...
@implementation System_Xml_Schema_XmlSchemaElement
...
#pragma mark Properties
    ...
    - (System_Xml_Schema_XmlSchemaObjectCollection *)constraints
    {
		...
		_constraints = [System_Xml_Schema_XmlSchemaObjectCollection bestObjectWithMonoObject:monoObject];
    ...
    - (NSString *)defaultValue
    {
		...
		_defaultValue = [NSString stringWithMonoString:DB_STRING(monoObject)];
    ...
    @synthesize elementSchemaType = _elementSchemaType;
    - (System_Xml_Schema_XmlSchemaType *)elementSchemaType
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "ElementSchemaType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_elementSchemaType isEqualToMonoObject:monoObject]) return _elementSchemaType;					
		_elementSchemaType = [System_Xml_Schema_XmlSchemaType bestObjectWithMonoObject:monoObject];

		return _elementSchemaType;
	}

	// Managed property name : ElementType
	// Managed property type : System.Object
    @synthesize elementType = _elementType;
    - (System_Object *)elementType
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_elementType = [System_Object objectWithMonoObject:monoObject];
	...
	// Managed property type : System.String
    @synthesize fixedValue = _fixedValue;
    - (NSString *)fixedValue
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "FixedValue");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_fixedValue isEqualToMonoObject:monoObject]) return _fixedValue;					
		_fixedValue = [NSString stringWithMonoString:DB_STRING(monoObject)];

		return _fixedValue;
	}
    - (void)setFixedValue:(NSString *)value
	{
		_fixedValue = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "FixedValue");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
	...
	// Managed property type : System.Boolean
    @synthesize isNillable = _isNillable;
    - (BOOL)isNillable
    {
		typedef BOOL (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "IsNillable");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		BOOL monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_isNillable = monoObject;

		return _isNillable;
	}
    - (void)setIsNillable:(BOOL)value
	{
		_isNillable = value;
		typedef void (*Thunk)(MonoObject *, BOOL, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "IsNillable");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
    ...
    - (void)setSchemaType:(System_Xml_Schema_XmlSchemaType *)value
	{
		_schemaType = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "SchemaType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
	...
	// Managed property type : System.Xml.XmlQualifiedName
    @synthesize schemaTypeName = _schemaTypeName;
    - (System_Xml_XmlQualifiedName *)schemaTypeName
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "SchemaTypeName");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_schemaTypeName isEqualToMonoObject:monoObject]) return _schemaTypeName;					
		_schemaTypeName = [System_Xml_XmlQualifiedName bestObjectWithMonoObject:monoObject];

		return _schemaTypeName;
	}
    - (void)setSchemaTypeName:(System_Xml_XmlQualifiedName *)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "SchemaTypeName");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
    ...
    - (System_Xml_XmlQualifiedName *)substitutionGroup
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "SubstitutionGroup");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_substitutionGroup isEqualToMonoObject:monoObject]) return _substitutionGroup;					
		_substitutionGroup = [System_Xml_XmlQualifiedName bestObjectWithMonoObject:monoObject];

		return _substitutionGroup;
	}
    - (void)setSubstitutionGroup:(System_Xml_XmlQualifiedName *)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "SubstitutionGroup");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
