#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaException.m
//
...
@implementation System_Xml_Schema_XmlSchemaException
...
#pragma mark Setup
	...
	{
		return "System.Xml.Schema.XmlSchemaException";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Xml_Schema_XmlSchemaException *)new_withMessage:(NSString *)p1
    {
		...
		System_Xml_Schema_XmlSchemaException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Schema_XmlSchemaException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Xml_Schema_XmlSchemaException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Xml_Schema_XmlSchemaException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2 lineNumber:(int32_t)p3 linePosition:(int32_t)p4
    {
		...
		System_Xml_Schema_XmlSchemaException * object = [[self alloc] initWithSignature:"string,System.Exception,int,int" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], DB_VALUE(p3), DB_VALUE(p4)];
...
#pragma mark Properties
    ...
    @synthesize sourceSchemaObject = _sourceSchemaObject;
    - (System_Xml_Schema_XmlSchemaObject *)sourceSchemaObject
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "SourceSchemaObject");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_sourceSchemaObject isEqualToMonoObject:monoObject]) return _sourceSchemaObject;					
		_sourceSchemaObject = [System_Xml_Schema_XmlSchemaObject bestObjectWithMonoObject:monoObject];

		return _sourceSchemaObject;
	}
