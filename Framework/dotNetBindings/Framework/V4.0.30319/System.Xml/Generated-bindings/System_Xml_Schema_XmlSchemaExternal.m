#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaExternal.m
//
...
@implementation System_Xml_Schema_XmlSchemaExternal
...
#pragma mark Setup
	...
	{
		return "System.Xml.Schema.XmlSchemaExternal";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    - (System_Xml_Schema_XmlSchema *)schema
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_schema = [System_Xml_Schema_XmlSchema bestObjectWithMonoObject:monoObject];

		return _schema;
	}
    - (void)setSchema:(System_Xml_Schema_XmlSchema *)value
	{
		_schema = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
	...
	// Managed property type : System.String
    @synthesize schemaLocation = _schemaLocation;
    - (NSString *)schemaLocation
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "SchemaLocation");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_schemaLocation isEqualToMonoObject:monoObject]) return _schemaLocation;					
		_schemaLocation = [NSString stringWithMonoString:DB_STRING(monoObject)];

		return _schemaLocation;
	}
    - (void)setSchemaLocation:(NSString *)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "SchemaLocation");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
