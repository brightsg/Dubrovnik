#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Schema_XmlSchemaObject.m
//
...
@implementation System_Xml_Schema_XmlSchemaObject
...
#pragma mark Properties
    ...
    - (void)setLineNumber:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "LineNumber");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
    ...
    - (void)setLinePosition:(int32_t)value
	{
		_linePosition = value;
		typedef void (*Thunk)(MonoObject *, int32_t, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "LinePosition");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
    ...
    - (System_Xml_Serialization_XmlSerializerNamespaces *)namespaces
    {
		...
		_namespaces = [System_Xml_Serialization_XmlSerializerNamespaces bestObjectWithMonoObject:monoObject];

		return _namespaces;
	}
    - (void)setNamespaces:(System_Xml_Serialization_XmlSerializerNamespaces *)value
	{
		_namespaces = value;
    ...
    - (System_Xml_Schema_XmlSchemaObject *)parent
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_parent = [System_Xml_Schema_XmlSchemaObject bestObjectWithMonoObject:monoObject];

		return _parent;
	}
    - (void)setParent:(System_Xml_Schema_XmlSchemaObject *)value
	{
		_parent = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Parent");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
    ...
    - (void)setSourceUri:(NSString *)value
	{
		_sourceUri = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
