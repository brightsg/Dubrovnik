#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Serialization_SoapSchemaMember.m
//
...
@implementation System_Xml_Serialization_SoapSchemaMember
...
#pragma mark Properties
    ...
    - (System_Xml_XmlQualifiedName *)memberType
    {
		typedef MonoObject * (*Thunk)(MonoObject *, MonoObject**);
		static Thunk thunk;
		static MonoClass *thunkClass;
		...
		_memberType = [System_Xml_XmlQualifiedName bestObjectWithMonoObject:monoObject];

		return _memberType;
	}
    - (void)setMemberType:(System_Xml_XmlQualifiedName *)value
	{
		_memberType = value;
		typedef void (*Thunk)(MonoObject *, MonoObject *, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "MemberType");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
