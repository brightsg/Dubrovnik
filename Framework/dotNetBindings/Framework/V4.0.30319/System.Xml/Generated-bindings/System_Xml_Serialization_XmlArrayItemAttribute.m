#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Serialization_XmlArrayItemAttribute.m
//
...
@implementation System_Xml_Serialization_XmlArrayItemAttribute
...
#pragma mark Constructors
    ...
    + (System_Xml_Serialization_XmlArrayItemAttribute *)new_withElementName:(NSString *)p1
    {
		...
		System_Xml_Serialization_XmlArrayItemAttribute * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlArrayItemAttribute *)new_withType:(System_Type *)p1
    {
		...
		System_Xml_Serialization_XmlArrayItemAttribute * object = [[self alloc] initWithSignature:"System.Type" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlArrayItemAttribute *)new_withElementName:(NSString *)p1 type:(System_Type *)p2
    {
		...
		System_Xml_Serialization_XmlArrayItemAttribute * object = [[self alloc] initWithSignature:"string,System.Type" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (int32_t)nestingLevel
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "NestingLevel");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		_nestingLevel = monoObject;

		return _nestingLevel;
	}
    - (void)setNestingLevel:(int32_t)value
	{
		_nestingLevel = value;
		typedef void (*Thunk)(MonoObject *, int32_t, MonoObject**);
		static Thunk thunk;
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "NestingLevel");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
