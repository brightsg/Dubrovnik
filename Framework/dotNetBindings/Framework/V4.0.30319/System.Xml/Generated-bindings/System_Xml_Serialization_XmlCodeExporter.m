#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Serialization_XmlCodeExporter.m
//
...
@implementation System_Xml_Serialization_XmlCodeExporter
...
#pragma mark Constructors
    ...
    + (System_Xml_Serialization_XmlCodeExporter *)new_withCodeNamespace:(System_CodeDom_CodeNamespace *)p1
    {
		...
		System_Xml_Serialization_XmlCodeExporter * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespace" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlCodeExporter *)new_withCodeNamespace:(System_CodeDom_CodeNamespace *)p1 codeCompileUnit:(System_CodeDom_CodeCompileUnit *)p2
    {
		...
		System_Xml_Serialization_XmlCodeExporter * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespace,System.CodeDom.CodeCompileUnit" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlCodeExporter *)new_withCodeNamespace:(System_CodeDom_CodeNamespace *)p1 codeCompileUnit:(System_CodeDom_CodeCompileUnit *)p2 options:(int32_t)p3
    {
		...
		System_Xml_Serialization_XmlCodeExporter * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespace,System.CodeDom.CodeCompileUnit,System.Xml.Serialization.CodeGenerationOptions" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], DB_VALUE(p3)];
    ...
    + (System_Xml_Serialization_XmlCodeExporter *)new_withCodeNamespace:(System_CodeDom_CodeNamespace *)p1 codeCompileUnit:(System_CodeDom_CodeCompileUnit *)p2 options:(int32_t)p3 mappings:(System_Collections_Hashtable *)p4
    {
		...
		System_Xml_Serialization_XmlCodeExporter * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespace,System.CodeDom.CodeCompileUnit,System.Xml.Serialization.CodeGenerationOptions,System.Collections.Hashtable" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], DB_VALUE(p3), [p4 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (void)addMappingMetadata_withMetadata:(System_CodeDom_CodeAttributeDeclarationCollection *)p1 mapping:(System_Xml_Serialization_XmlTypeMapping *)p2 ns:(NSString *)p3
    {
		...
		[self invokeMonoMethod:"AddMappingMetadata(System.CodeDom.CodeAttributeDeclarationCollection,System.Xml.Serialization.XmlTypeMapping,string)" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
    ...
    - (void)addMappingMetadata_withMetadata:(System_CodeDom_CodeAttributeDeclarationCollection *)p1 member:(System_Xml_Serialization_XmlMemberMapping *)p2 ns:(NSString *)p3 forceUseMemberName:(BOOL)p4
    {
		...
		[self invokeMonoMethod:"AddMappingMetadata(System.CodeDom.CodeAttributeDeclarationCollection,System.Xml.Serialization.XmlMemberMapping,string,bool)" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], DB_VALUE(p4)];
    ...
    - (void)addMappingMetadata_withMetadata:(System_CodeDom_CodeAttributeDeclarationCollection *)p1 member:(System_Xml_Serialization_XmlMemberMapping *)p2 ns:(NSString *)p3
    {
		...
		[self invokeMonoMethod:"AddMappingMetadata(System.CodeDom.CodeAttributeDeclarationCollection,System.Xml.Serialization.XmlMemberMapping,string)" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
