#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_Serialization_XmlElementAttribute.m
//
// Managed class : XmlElementAttribute
//
...
@implementation System_Xml_Serialization_XmlElementAttribute
...
#pragma mark Constructors
	...
	// Managed return type : System.Xml.Serialization.XmlElementAttribute
	// Managed param types : System.String
    + (System_Xml_Serialization_XmlElementAttribute *)new_withElementName:(NSString *)p1
    {
		
		System_Xml_Serialization_XmlElementAttribute * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlElementAttribute *)new_withType:(System_Type *)p1
    {
		
		System_Xml_Serialization_XmlElementAttribute * object = [[self alloc] initWithSignature:"System.Type" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Xml_Serialization_XmlElementAttribute *)new_withElementName:(NSString *)p1 type:(System_Type *)p2
    {
		
		System_Xml_Serialization_XmlElementAttribute * object = [[self alloc] initWithSignature:"string,System.Type" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (NSString *)elementName
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "ElementName");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject * monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
		if ([self object:_elementName isEqualToMonoObject:monoObject]) return _elementName;					
		_elementName = [NSString stringWithMonoString:DB_STRING(monoObject)];
    ...
    - (void)setElementName:(NSString *)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "ElementName");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, [value monoObject], &monoException);
    ...
    - (void)setForm:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Form");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
    ...
    - (int32_t)order
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "Order");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		int32_t monoObject = thunk(self.monoObject, &monoException);
		if (monoException != NULL) @throw(NSExceptionFromMonoException(monoException, @{}));
    ...
    - (void)setOrder:(int32_t)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "Order");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
		thunk(self.monoObject, value, &monoException);
