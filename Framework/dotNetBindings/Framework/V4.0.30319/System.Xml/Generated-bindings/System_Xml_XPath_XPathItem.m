#import "System_XML.h"
//++Dubrovnik.CodeGenerator System_Xml_XPath_XPathItem.m
//
// Managed class : XPathItem
//
...
@implementation System_Xml_XPath_XPathItem
...
#pragma mark Methods
    ...
    - (System_Object *)valueAs_withReturnType:(System_Type *)p1
    {
		
		MonoObject *monoObject = [self invokeMonoMethod:"ValueAs(System.Type)" withNumArgs:1, [p1 monoRTInvokeArg]];
