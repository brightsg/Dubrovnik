//++Dubrovnik.CodeGenerator System_Xml_XmlNotation.h
//
// Managed class : XmlNotation
//
@interface System_Xml_XmlNotation : System_Xml_XmlNode <System_ICloneable_, System_Collections_IEnumerable_, System_Xml_XPath_IXPathNavigable_>
