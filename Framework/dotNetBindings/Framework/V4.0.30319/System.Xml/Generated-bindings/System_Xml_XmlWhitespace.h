//++Dubrovnik.CodeGenerator System_Xml_XmlWhitespace.h
//
// Managed class : XmlWhitespace
//
@interface System_Xml_XmlWhitespace : System_Xml_XmlCharacterData <System_ICloneable_, System_Collections_IEnumerable_, System_Xml_XPath_IXPathNavigable_>
