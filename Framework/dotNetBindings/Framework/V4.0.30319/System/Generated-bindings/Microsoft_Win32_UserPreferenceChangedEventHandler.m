...
#pragma mark Constructors
    ...
    + (Microsoft_Win32_UserPreferenceChangedEventHandler *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		Microsoft_Win32_UserPreferenceChangedEventHandler * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withSender:(System_Object *)p1 e:(Microsoft_Win32_UserPreferenceChangedEventArgs *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(object,Microsoft.Win32.UserPreferenceChangedEventArgs,System.AsyncCallback,object)" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg]];
    ...
    - (void)invoke_withSender:(System_Object *)p1 e:(Microsoft_Win32_UserPreferenceChangedEventArgs *)p2
    {
		...
		[self invokeMonoMethod:"Invoke(object,Microsoft.Win32.UserPreferenceChangedEventArgs)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
