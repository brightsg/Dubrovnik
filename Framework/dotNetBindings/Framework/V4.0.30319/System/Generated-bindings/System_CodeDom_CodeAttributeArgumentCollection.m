...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeAttributeArgumentCollection *)new_withValueSCCodeAttributeArgumentCollection:(System_CodeDom_CodeAttributeArgumentCollection *)p1
    {
		...
		System_CodeDom_CodeAttributeArgumentCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeAttributeArgumentCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeAttributeArgumentCollection *)new_withValueSCCodeAttributeArgument:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeAttributeArgumentCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeAttributeArgument[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeAttributeArgument *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeAttributeArgument)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeAttributeArgument:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeAttributeArgument[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeAttributeArgumentCollection:(System_CodeDom_CodeAttributeArgumentCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeAttributeArgumentCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeAttributeArgument *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeAttributeArgument)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeAttributeArgument[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeAttributeArgument *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeAttributeArgument)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeAttributeArgument *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeAttributeArgument)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeAttributeArgument *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeAttributeArgument)" withNumArgs:1, [p1 monoRTInvokeArg]];
