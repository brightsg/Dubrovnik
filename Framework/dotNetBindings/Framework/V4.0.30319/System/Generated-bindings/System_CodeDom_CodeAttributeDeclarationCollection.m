...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeAttributeDeclarationCollection *)new_withValueSCCodeAttributeDeclarationCollection:(System_CodeDom_CodeAttributeDeclarationCollection *)p1
    {
		...
		System_CodeDom_CodeAttributeDeclarationCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeAttributeDeclarationCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeAttributeDeclarationCollection *)new_withValueSCCodeAttributeDeclaration:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeAttributeDeclarationCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeAttributeDeclaration[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeAttributeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeAttributeDeclaration)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeAttributeDeclaration:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeAttributeDeclaration[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeAttributeDeclarationCollection:(System_CodeDom_CodeAttributeDeclarationCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeAttributeDeclarationCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeAttributeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeAttributeDeclaration)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeAttributeDeclaration[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeAttributeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeAttributeDeclaration)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeAttributeDeclaration *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeAttributeDeclaration)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeAttributeDeclaration *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeAttributeDeclaration)" withNumArgs:1, [p1 monoRTInvokeArg]];
