...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeCatchClauseCollection *)new_withValueSCCodeCatchClauseCollection:(System_CodeDom_CodeCatchClauseCollection *)p1
    {
		...
		System_CodeDom_CodeCatchClauseCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeCatchClauseCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_CodeDom_CodeCatchClauseCollection *)new_withValueSCCodeCatchClause:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeCatchClauseCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeCatchClause[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeCatchClause *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeCatchClause)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)addRange_withValueSCCodeCatchClause:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeCatchClause[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeCatchClauseCollection:(System_CodeDom_CodeCatchClauseCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeCatchClauseCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeCatchClause *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeCatchClause)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeCatchClause[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeCatchClause *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeCatchClause)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeCatchClause *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeCatchClause)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_CodeDom_CodeCatchClause *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeCatchClause)" withNumArgs:1, [p1 monoValue]];;
