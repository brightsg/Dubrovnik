...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeDirectiveCollection *)new_withValueSCCodeDirectiveCollection:(System_CodeDom_CodeDirectiveCollection *)p1
    {
		...
		System_CodeDom_CodeDirectiveCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeDirectiveCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_CodeDom_CodeDirectiveCollection *)new_withValueSCCodeDirective:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeDirectiveCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeDirective[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeDirective *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeDirective)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)addRange_withValueSCCodeDirective:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeDirective[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeDirectiveCollection:(System_CodeDom_CodeDirectiveCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeDirectiveCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeDirective *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeDirective)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeDirective[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeDirective *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeDirective)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeDirective *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeDirective)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_CodeDom_CodeDirective *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeDirective)" withNumArgs:1, [p1 monoValue]];;
