...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeExpressionCollection *)new_withValueSCCodeExpressionCollection:(System_CodeDom_CodeExpressionCollection *)p1
    {
		...
		System_CodeDom_CodeExpressionCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeExpressionCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeExpressionCollection *)new_withValueSCCodeExpression:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeExpressionCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeExpression[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (void)addRange_withValueSCCodeExpression:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeExpression[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeExpressionCollection:(System_CodeDom_CodeExpressionCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeExpressionCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeExpression *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeExpression[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeExpression *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeExpression *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeExpression)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeExpression *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
