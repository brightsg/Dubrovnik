...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeNamespaceCollection *)new_withValueSCCodeNamespaceCollection:(System_CodeDom_CodeNamespaceCollection *)p1
    {
		...
		System_CodeDom_CodeNamespaceCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespaceCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeNamespaceCollection *)new_withValueSCCodeNamespace:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeNamespaceCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeNamespace[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeNamespace *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeNamespace)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeNamespace:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeNamespace[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeNamespaceCollection:(System_CodeDom_CodeNamespaceCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeNamespaceCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeNamespace *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeNamespace)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeNamespace[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeNamespace *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeNamespace)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeNamespace *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeNamespace)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeNamespace *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeNamespace)" withNumArgs:1, [p1 monoRTInvokeArg]];
