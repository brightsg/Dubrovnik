...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeParameterDeclarationExpression *)new_withTypeSCCodeTypeReference:(System_CodeDom_CodeTypeReference *)p1 nameString:(NSString *)p2
    {
		...
		System_CodeDom_CodeParameterDeclarationExpression * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeReference,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeParameterDeclarationExpression *)new_withTypeString:(NSString *)p1 nameString:(NSString *)p2
    {
		...
		System_CodeDom_CodeParameterDeclarationExpression * object = [[self alloc] initWithSignature:"string,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeParameterDeclarationExpression *)new_withTypeSType:(System_Type *)p1 nameString:(NSString *)p2
    {
		...
		System_CodeDom_CodeParameterDeclarationExpression * object = [[self alloc] initWithSignature:"System.Type,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (void)setCustomAttributes:(System_CodeDom_CodeAttributeDeclarationCollection *)value
	{
		...
		if (!thunk || thunkClass != self.monoClass) {
			thunkClass = self.monoClass;
			MonoMethod *monoMethod = GetPropertySetMethod(thunkClass, "CustomAttributes");
			thunk = (Thunk)mono_method_get_unmanaged_thunk(monoMethod);
		}
		MonoObject *monoException = NULL;
