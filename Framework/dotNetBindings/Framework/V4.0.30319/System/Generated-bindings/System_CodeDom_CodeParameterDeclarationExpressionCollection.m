...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeParameterDeclarationExpressionCollection *)new_withValueSCCodeParameterDeclarationExpressionCollection:(System_CodeDom_CodeParameterDeclarationExpressionCollection *)p1
    {
		...
		System_CodeDom_CodeParameterDeclarationExpressionCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeParameterDeclarationExpressionCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeParameterDeclarationExpressionCollection *)new_withValueSCCodeParameterDeclarationExpression:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeParameterDeclarationExpressionCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeParameterDeclarationExpression[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeParameterDeclarationExpression *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeParameterDeclarationExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeParameterDeclarationExpression:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeParameterDeclarationExpression[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeParameterDeclarationExpressionCollection:(System_CodeDom_CodeParameterDeclarationExpressionCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeParameterDeclarationExpressionCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeParameterDeclarationExpression *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeParameterDeclarationExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeParameterDeclarationExpression[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeParameterDeclarationExpression *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeParameterDeclarationExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeParameterDeclarationExpression *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeParameterDeclarationExpression)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeParameterDeclarationExpression *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeParameterDeclarationExpression)" withNumArgs:1, [p1 monoRTInvokeArg]];
