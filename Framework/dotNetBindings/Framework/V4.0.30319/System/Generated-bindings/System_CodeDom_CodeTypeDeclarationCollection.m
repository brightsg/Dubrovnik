...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeTypeDeclarationCollection *)new_withValueSCCodeTypeDeclarationCollection:(System_CodeDom_CodeTypeDeclarationCollection *)p1
    {
		...
		System_CodeDom_CodeTypeDeclarationCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeDeclarationCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_CodeDom_CodeTypeDeclarationCollection *)new_withValueSCCodeTypeDeclaration:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeTypeDeclarationCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeDeclaration[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeTypeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeTypeDeclaration)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)addRange_withValueSCCodeTypeDeclaration:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeDeclaration[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeTypeDeclarationCollection:(System_CodeDom_CodeTypeDeclarationCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeDeclarationCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeTypeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeTypeDeclaration)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeTypeDeclaration[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeTypeDeclaration *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeTypeDeclaration)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeTypeDeclaration *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeTypeDeclaration)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_CodeDom_CodeTypeDeclaration *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeTypeDeclaration)" withNumArgs:1, [p1 monoValue]];;
