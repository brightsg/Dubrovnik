...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeTypeMemberCollection *)new_withValueSCCodeTypeMemberCollection:(System_CodeDom_CodeTypeMemberCollection *)p1
    {
		...
		System_CodeDom_CodeTypeMemberCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeMemberCollection" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_CodeDom_CodeTypeMemberCollection *)new_withValueSCCodeTypeMember:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeTypeMemberCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeMember[]" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_CodeDom_CodeTypeMember *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeTypeMember)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeTypeMember:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeMember[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSCCodeTypeMemberCollection:(System_CodeDom_CodeTypeMemberCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeMemberCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeTypeMember *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeTypeMember)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeTypeMember[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeTypeMember *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeTypeMember)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeTypeMember *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeTypeMember)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_CodeDom_CodeTypeMember *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeTypeMember)" withNumArgs:1, [p1 monoRTInvokeArg]];
