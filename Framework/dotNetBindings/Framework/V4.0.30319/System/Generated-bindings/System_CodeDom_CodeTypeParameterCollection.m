...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeTypeParameterCollection *)new_withValueSCCodeTypeParameterCollection:(System_CodeDom_CodeTypeParameterCollection *)p1
    {
		...
		System_CodeDom_CodeTypeParameterCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeParameterCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_CodeDom_CodeTypeParameterCollection *)new_withValueSCCodeTypeParameter:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeTypeParameterCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeParameter[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValueSCCodeTypeParameter:(System_CodeDom_CodeTypeParameter *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeTypeParameter)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)addRange_withValueSCCodeTypeParameter:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeParameter[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeTypeParameterCollection:(System_CodeDom_CodeTypeParameterCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeParameterCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeTypeParameter *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeTypeParameter)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeTypeParameter[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeTypeParameter *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeTypeParameter)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeTypeParameter *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeTypeParameter)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_CodeDom_CodeTypeParameter *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeTypeParameter)" withNumArgs:1, [p1 monoValue]];;
