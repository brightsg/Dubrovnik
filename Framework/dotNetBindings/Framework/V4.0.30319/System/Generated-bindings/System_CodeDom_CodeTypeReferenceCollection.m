...
#pragma mark Constructors
    ...
    + (System_CodeDom_CodeTypeReferenceCollection *)new_withValueSCCodeTypeReferenceCollection:(System_CodeDom_CodeTypeReferenceCollection *)p1
    {
		...
		System_CodeDom_CodeTypeReferenceCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeReferenceCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_CodeDom_CodeTypeReferenceCollection *)new_withValueSCCodeTypeReference:(DBSystem_Array *)p1
    {
		...
		System_CodeDom_CodeTypeReferenceCollection * object = [[self alloc] initWithSignature:"System.CodeDom.CodeTypeReference[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValueSCCodeTypeReference:(System_CodeDom_CodeTypeReference *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.CodeDom.CodeTypeReference)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)add_withValueSType:(System_Type *)p1
    {
		...
		[self invokeMonoMethod:"Add(System.Type)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeTypeReference:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeReference[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSCCodeTypeReferenceCollection:(System_CodeDom_CodeTypeReferenceCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.CodeDom.CodeTypeReferenceCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_CodeDom_CodeTypeReference *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.CodeDom.CodeTypeReference)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.CodeDom.CodeTypeReference[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_CodeDom_CodeTypeReference *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.CodeDom.CodeTypeReference)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_CodeDom_CodeTypeReference *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.CodeDom.CodeTypeReference)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_CodeDom_CodeTypeReference *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.CodeDom.CodeTypeReference)" withNumArgs:1, [p1 monoValue]];;
