//++Dubrovnik.CodeGenerator System_CodeDom_CodeTypeReferenceExpression.h
//
// Managed class : CodeTypeReferenceExpression
//
@interface System_CodeDom_CodeTypeReferenceExpression : System_CodeDom_CodeExpression
