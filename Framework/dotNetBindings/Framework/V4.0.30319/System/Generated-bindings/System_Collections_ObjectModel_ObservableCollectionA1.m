...
#pragma mark Setup
	...
	{
		return "System.Collections.ObjectModel.ObservableCollection`1<System.Collections.ObjectModel.ObservableCollection`1+T>";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Collections_ObjectModel_ObservableCollectionA1 *)new_withList:(DBSystem_Collections_Generic_ListA1 *)p1
    {
		...
		System_Collections_ObjectModel_ObservableCollectionA1 * object = [[self alloc] initWithSignature:"System.Collections.Generic.List`1<System.Collections.ObjectModel.ObservableCollection`1+T>" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Collections_ObjectModel_ObservableCollectionA1 *)new_withCollection:(id <System_Collections_Generic_IEnumerableA1_>)p1
    {
		...
		System_Collections_ObjectModel_ObservableCollectionA1 * object = [[self alloc] initWithSignature:"System.Collections.Generic.IEnumerable`1<System.Collections.ObjectModel.ObservableCollection`1+T>" withNumArgs:1, [p1 monoValue]];;
