//++Dubrovnik.CodeGenerator System_ComponentModel_BaseNumberConverter.h
//
// Managed class : BaseNumberConverter
//
@interface System_ComponentModel_BaseNumberConverter : System_ComponentModel_TypeConverter
