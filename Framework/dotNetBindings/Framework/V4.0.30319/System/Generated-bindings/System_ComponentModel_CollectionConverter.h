//++Dubrovnik.CodeGenerator System_ComponentModel_CollectionConverter.h
//
// Managed class : CollectionConverter
//
@interface System_ComponentModel_CollectionConverter : System_ComponentModel_TypeConverter
