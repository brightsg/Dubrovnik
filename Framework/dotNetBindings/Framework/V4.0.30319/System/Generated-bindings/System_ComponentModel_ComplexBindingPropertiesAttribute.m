...
#pragma mark Constructors
    ...
    + (System_ComponentModel_ComplexBindingPropertiesAttribute *)new_withDataSource:(NSString *)p1
    {
		...
		System_ComponentModel_ComplexBindingPropertiesAttribute * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_ComponentModel_ComplexBindingPropertiesAttribute *)new_withDataSource:(NSString *)p1 dataMember:(NSString *)p2
    {
		...
		System_ComponentModel_ComplexBindingPropertiesAttribute * object = [[self alloc] initWithSignature:"string,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (NSString *)dataMember
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			...
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "DataMember");
