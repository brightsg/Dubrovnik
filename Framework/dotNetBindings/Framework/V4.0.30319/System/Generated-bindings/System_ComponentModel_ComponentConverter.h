//++Dubrovnik.CodeGenerator System_ComponentModel_ComponentConverter.h
//
// Managed class : ComponentConverter
//
@interface System_ComponentModel_ComponentConverter : System_ComponentModel_ReferenceConverter
