//++Dubrovnik.CodeGenerator System_ComponentModel_CultureInfoConverter.h
//
// Managed class : CultureInfoConverter
//
@interface System_ComponentModel_CultureInfoConverter : System_ComponentModel_TypeConverter
