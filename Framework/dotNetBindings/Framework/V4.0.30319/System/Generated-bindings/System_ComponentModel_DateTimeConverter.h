//++Dubrovnik.CodeGenerator System_ComponentModel_DateTimeConverter.h
//
// Managed class : DateTimeConverter
//
@interface System_ComponentModel_DateTimeConverter : System_ComponentModel_TypeConverter
