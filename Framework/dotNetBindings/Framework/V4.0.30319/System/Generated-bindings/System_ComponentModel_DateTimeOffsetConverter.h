//++Dubrovnik.CodeGenerator System_ComponentModel_DateTimeOffsetConverter.h
//
// Managed class : DateTimeOffsetConverter
//
@interface System_ComponentModel_DateTimeOffsetConverter : System_ComponentModel_TypeConverter
