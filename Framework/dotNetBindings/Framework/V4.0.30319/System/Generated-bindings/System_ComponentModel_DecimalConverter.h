//++Dubrovnik.CodeGenerator System_ComponentModel_DecimalConverter.h
//
// Managed class : DecimalConverter
//
@interface System_ComponentModel_DecimalConverter : System_ComponentModel_BaseNumberConverter
