//++Dubrovnik.CodeGenerator System_ComponentModel_DefaultValueAttribute.h
//
// Managed class : DefaultValueAttribute
//
@interface System_ComponentModel_DefaultValueAttribute : System_Attribute <System_Runtime_InteropServices__Attribute_>
