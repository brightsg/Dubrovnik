...
#pragma mark Constructors
    ...
    + (System_ComponentModel_DefaultValueAttribute *)new_withType:(System_Type *)p1 value:(NSString *)p2
    {
		...
		System_ComponentModel_DefaultValueAttribute * object = [[self alloc] initWithSignature:"System.Type,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_ComponentModel_DefaultValueAttribute *)new_withValueString:(NSString *)p1
    {
		...
		System_ComponentModel_DefaultValueAttribute * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_ComponentModel_DefaultValueAttribute *)new_withValueObject:(System_Object *)p1
    {
		...
		System_ComponentModel_DefaultValueAttribute * object = [[self alloc] initWithSignature:"object" withNumArgs:1, [p1 monoRTInvokeArg]];
