...
#pragma mark Constructors
    ...
    + (System_ComponentModel_Design_CheckoutException *)new_withMessage:(NSString *)p1
    {
		...
		System_ComponentModel_Design_CheckoutException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_ComponentModel_Design_CheckoutException *)new_withMessage:(NSString *)p1 errorCode:(int32_t)p2
    {
		...
		System_ComponentModel_Design_CheckoutException * object = [[self alloc] initWithSignature:"string,int" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    + (System_ComponentModel_Design_CheckoutException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_ComponentModel_Design_CheckoutException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
