...
#pragma mark Constructors
    ...
    + (System_ComponentModel_Design_ComponentEventHandler *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		System_ComponentModel_Design_ComponentEventHandler * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withSender:(System_Object *)p1 e:(System_ComponentModel_Design_ComponentEventArgs *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(object,System.ComponentModel.Design.ComponentEventArgs,System.AsyncCallback,object)" withNumArgs:4, [p1 monoValue], [p2 monoValue], [p3 monoValue], [p4 monoValue]];
    ...
    - (void)invoke_withSender:(System_Object *)p1 e:(System_ComponentModel_Design_ComponentEventArgs *)p2
    {
		...
		[self invokeMonoMethod:"Invoke(object,System.ComponentModel.Design.ComponentEventArgs)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
