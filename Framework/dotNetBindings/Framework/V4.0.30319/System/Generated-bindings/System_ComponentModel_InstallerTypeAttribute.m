...
#pragma mark Constructors
    ...
    + (System_ComponentModel_InstallerTypeAttribute *)new_withInstallerType:(System_Type *)p1
    {
		...
		System_ComponentModel_InstallerTypeAttribute * object = [[self alloc] initWithSignature:"System.Type" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_ComponentModel_InstallerTypeAttribute *)new_withTypeName:(NSString *)p1
    {
		...
		System_ComponentModel_InstallerTypeAttribute * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
...
#pragma mark Properties
    ...
    - (System_Type *)installerType
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			...
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "InstallerType");
