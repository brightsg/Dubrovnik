//++Dubrovnik.CodeGenerator System_ComponentModel_LicFileLicenseProvider.h
//
// Managed class : LicFileLicenseProvider
//
@interface System_ComponentModel_LicFileLicenseProvider : System_ComponentModel_LicenseProvider
