//++Dubrovnik.CodeGenerator System_ComponentModel_MultilineStringConverter.h
//
// Managed class : MultilineStringConverter
//
@interface System_ComponentModel_MultilineStringConverter : System_ComponentModel_TypeConverter
