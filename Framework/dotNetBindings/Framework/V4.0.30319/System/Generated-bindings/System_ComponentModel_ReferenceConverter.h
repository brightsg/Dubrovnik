//++Dubrovnik.CodeGenerator System_ComponentModel_ReferenceConverter.h
//
// Managed class : ReferenceConverter
//
@interface System_ComponentModel_ReferenceConverter : System_ComponentModel_TypeConverter
