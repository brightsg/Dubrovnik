//++Dubrovnik.CodeGenerator System_ComponentModel_TimeSpanConverter.h
//
// Managed class : TimeSpanConverter
//
@interface System_ComponentModel_TimeSpanConverter : System_ComponentModel_TypeConverter
