//++Dubrovnik.CodeGenerator System_ComponentModel_TypeListConverter.h
//
// Managed class : TypeListConverter
//
@interface System_ComponentModel_TypeListConverter : System_ComponentModel_TypeConverter
