...
#pragma mark Methods
    ...
    - (System_Object *)create_withParent:(System_Object *)p1 configContext:(System_Object *)p2 section:(System_Xml_XmlNode *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Configuration.IConfigurationSectionHandler.Create(object,object,System.Xml.XmlNode)" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
