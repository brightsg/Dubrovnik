//++Dubrovnik.CodeGenerator System_Configuration_NameValueSectionHandler.h
//
// Managed class : NameValueSectionHandler
//
@interface System_Configuration_NameValueSectionHandler : System_Object <System_Configuration_IConfigurationSectionHandler_>
