...
#pragma mark Constructors
    ...
    + (System_Configuration_SettingsPropertyWrongTypeException *)new_withMessage:(NSString *)p1
    {
		...
		System_Configuration_SettingsPropertyWrongTypeException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Configuration_SettingsPropertyWrongTypeException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Configuration_SettingsPropertyWrongTypeException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
