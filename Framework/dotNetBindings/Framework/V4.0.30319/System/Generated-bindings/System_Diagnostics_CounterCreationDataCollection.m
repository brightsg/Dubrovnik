...
#pragma mark Constructors
    ...
    + (System_Diagnostics_CounterCreationDataCollection *)new_withValueSDCounterCreationDataCollection:(System_Diagnostics_CounterCreationDataCollection *)p1
    {
		...
		System_Diagnostics_CounterCreationDataCollection * object = [[self alloc] initWithSignature:"System.Diagnostics.CounterCreationDataCollection" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Diagnostics_CounterCreationDataCollection *)new_withValueSDCounterCreationData:(DBSystem_Array *)p1
    {
		...
		System_Diagnostics_CounterCreationDataCollection * object = [[self alloc] initWithSignature:"System.Diagnostics.CounterCreationData[]" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_Diagnostics_CounterCreationData *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.Diagnostics.CounterCreationData)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)addRange_withValueSDCounterCreationData:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.Diagnostics.CounterCreationData[])" withNumArgs:1, [p1 monoValue]];;
    ...
    - (void)addRange_withValueSDCounterCreationDataCollection:(System_Diagnostics_CounterCreationDataCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.Diagnostics.CounterCreationDataCollection)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withValue:(System_Diagnostics_CounterCreationData *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.Diagnostics.CounterCreationData)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Diagnostics.CounterCreationData[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (int32_t)indexOf_withValue:(System_Diagnostics_CounterCreationData *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.Diagnostics.CounterCreationData)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_Diagnostics_CounterCreationData *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.Diagnostics.CounterCreationData)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];;
    ...
    - (void)remove_withValue:(System_Diagnostics_CounterCreationData *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.Diagnostics.CounterCreationData)" withNumArgs:1, [p1 monoValue]];;
