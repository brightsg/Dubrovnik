...
#pragma mark Methods
    ...
    - (int32_t)add_withValue:(System_Diagnostics_EventLogPermissionEntry *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.Diagnostics.EventLogPermissionEntry)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSDEventLogPermissionEntry:(DBSystem_Array *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.Diagnostics.EventLogPermissionEntry[])" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addRange_withValueSDEventLogPermissionEntryCollection:(System_Diagnostics_EventLogPermissionEntryCollection *)p1
    {
		...
		[self invokeMonoMethod:"AddRange(System.Diagnostics.EventLogPermissionEntryCollection)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withValue:(System_Diagnostics_EventLogPermissionEntry *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.Diagnostics.EventLogPermissionEntry)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Diagnostics.EventLogPermissionEntry[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)indexOf_withValue:(System_Diagnostics_EventLogPermissionEntry *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"IndexOf(System.Diagnostics.EventLogPermissionEntry)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)insert_withIndex:(int32_t)p1 value:(System_Diagnostics_EventLogPermissionEntry *)p2
    {
		...
		[self invokeMonoMethod:"Insert(int,System.Diagnostics.EventLogPermissionEntry)" withNumArgs:2, DB_VALUE(p1), [p2 monoRTInvokeArg]];
    ...
    - (void)remove_withValue:(System_Diagnostics_EventLogPermissionEntry *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.Diagnostics.EventLogPermissionEntry)" withNumArgs:1, [p1 monoRTInvokeArg]];
