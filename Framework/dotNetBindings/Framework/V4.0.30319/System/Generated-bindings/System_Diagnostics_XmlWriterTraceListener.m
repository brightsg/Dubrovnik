...
#pragma mark Constructors
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withStream:(System_IO_Stream *)p1
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"System.IO.Stream" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withStream:(System_IO_Stream *)p1 name:(NSString *)p2
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"System.IO.Stream,string" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withWriter:(System_IO_TextWriter *)p1
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"System.IO.TextWriter" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withWriter:(System_IO_TextWriter *)p1 name:(NSString *)p2
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"System.IO.TextWriter,string" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withFilename:(NSString *)p1
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Diagnostics_XmlWriterTraceListener *)new_withFilename:(NSString *)p1 name:(NSString *)p2
    {
		...
		System_Diagnostics_XmlWriterTraceListener * object = [[self alloc] initWithSignature:"string,string" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
