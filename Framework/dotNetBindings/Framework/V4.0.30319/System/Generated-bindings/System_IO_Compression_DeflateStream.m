#import "System.h"
//++Dubrovnik.CodeGenerator System_IO_Compression_DeflateStream.m
//
// Managed class : DeflateStream
//
...
@implementation System_IO_Compression_DeflateStream
...
#pragma mark Constructors
	...
	// Managed return type : System.IO.Compression.DeflateStream
	// Managed param types : System.IO.Stream, System.IO.Compression.CompressionMode
    + (System_IO_Compression_DeflateStream *)new_withStream:(System_IO_Stream *)p1 mode:(System_IO_Compression_CompressionMode)p2
    {
		
		System_IO_Compression_DeflateStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionMode" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    + (System_IO_Compression_DeflateStream *)new_withStream:(System_IO_Stream *)p1 mode:(System_IO_Compression_CompressionMode)p2 leaveOpen:(BOOL)p3
    {
		
		System_IO_Compression_DeflateStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionMode,bool" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];;
    ...
    + (System_IO_Compression_DeflateStream *)new_withStream:(System_IO_Stream *)p1 compressionLevel:(System_IO_Compression_CompressionLevel)p2
    {
		
		System_IO_Compression_DeflateStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionLevel" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    + (System_IO_Compression_DeflateStream *)new_withStream:(System_IO_Stream *)p1 compressionLevel:(System_IO_Compression_CompressionLevel)p2 leaveOpen:(BOOL)p3
    {
		
		System_IO_Compression_DeflateStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionLevel,bool" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];;
