...
#pragma mark Constructors
    ...
    + (System_IO_Compression_GZipStream *)new_withStream:(System_IO_Stream *)p1 mode:(int32_t)p2
    {
		...
		System_IO_Compression_GZipStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionMode" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    + (System_IO_Compression_GZipStream *)new_withStream:(System_IO_Stream *)p1 mode:(int32_t)p2 leaveOpen:(BOOL)p3
    {
		...
		System_IO_Compression_GZipStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionMode,bool" withNumArgs:3, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3)];
    ...
    + (System_IO_Compression_GZipStream *)new_withStream:(System_IO_Stream *)p1 compressionLevel:(int32_t)p2
    {
		...
		System_IO_Compression_GZipStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionLevel" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    + (System_IO_Compression_GZipStream *)new_withStream:(System_IO_Stream *)p1 compressionLevel:(int32_t)p2 leaveOpen:(BOOL)p3
    {
		...
		System_IO_Compression_GZipStream * object = [[self alloc] initWithSignature:"System.IO.Stream,System.IO.Compression.CompressionLevel,bool" withNumArgs:3, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3)];
