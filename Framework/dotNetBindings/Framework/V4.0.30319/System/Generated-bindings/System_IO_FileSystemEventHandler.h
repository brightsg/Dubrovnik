//++Dubrovnik.CodeGenerator System_IO_FileSystemEventHandler.h
//
// Managed class : FileSystemEventHandler
//
@interface System_IO_FileSystemEventHandler : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
