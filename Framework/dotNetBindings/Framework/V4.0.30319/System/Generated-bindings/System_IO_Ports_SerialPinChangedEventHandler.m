...
#pragma mark Constructors
    ...
    + (System_IO_Ports_SerialPinChangedEventHandler *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		System_IO_Ports_SerialPinChangedEventHandler * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withSender:(System_Object *)p1 e:(System_IO_Ports_SerialPinChangedEventArgs *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(object,System.IO.Ports.SerialPinChangedEventArgs,System.AsyncCallback,object)" withNumArgs:4, [p1 monoValue], [p2 monoValue], [p3 monoValue], [p4 monoValue]];
    ...
    - (void)invoke_withSender:(System_Object *)p1 e:(System_IO_Ports_SerialPinChangedEventArgs *)p2
    {
		...
		[self invokeMonoMethod:"Invoke(object,System.IO.Ports.SerialPinChangedEventArgs)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
