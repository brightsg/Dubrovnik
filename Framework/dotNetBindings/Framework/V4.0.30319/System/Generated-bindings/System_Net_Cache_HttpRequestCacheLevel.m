#import "System.h"
//++Dubrovnik.CodeGenerator System_Net_Cache_HttpRequestCacheLevel.m
//
...
// C enumeration
@implementation System_Net_Cache_HttpRequestCacheLevel
...
#pragma mark Fields
	...
	// Managed field type : System.Net.Cache.HttpRequestCacheLevel
    static int32_t m_cacheOrNextCacheOnly;
    + (int32_t)cacheOrNextCacheOnly
    {
		MonoObject *monoObject = [[self class] getMonoClassField:"CacheOrNextCacheOnly"];
		m_cacheOrNextCacheOnly = DB_UNBOX_INT32(monoObject);

		return m_cacheOrNextCacheOnly;
	}
