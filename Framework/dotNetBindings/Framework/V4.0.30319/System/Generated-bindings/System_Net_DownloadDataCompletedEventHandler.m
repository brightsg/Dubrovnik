...
#pragma mark Constructors
    ...
    + (System_Net_DownloadDataCompletedEventHandler *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		System_Net_DownloadDataCompletedEventHandler * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withSender:(System_Object *)p1 e:(System_Net_DownloadDataCompletedEventArgs *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(object,System.Net.DownloadDataCompletedEventArgs,System.AsyncCallback,object)" withNumArgs:4, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg]];
    ...
    - (void)invoke_withSender:(System_Object *)p1 e:(System_Net_DownloadDataCompletedEventArgs *)p2
    {
		...
		[self invokeMonoMethod:"Invoke(object,System.Net.DownloadDataCompletedEventArgs)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
