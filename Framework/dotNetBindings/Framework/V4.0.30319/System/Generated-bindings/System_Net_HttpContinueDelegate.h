//++Dubrovnik.CodeGenerator System_Net_HttpContinueDelegate.h
//
// Managed class : HttpContinueDelegate
//
@interface System_Net_HttpContinueDelegate : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
