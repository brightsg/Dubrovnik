...
#pragma mark Methods
    ...
    - (void)add_withAddress:(System_Net_NetworkInformation_GatewayIPAddressInformation *)p1
    {
		...
		[self invokeMonoMethod:"Add(System.Net.NetworkInformation.GatewayIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withAddress:(System_Net_NetworkInformation_GatewayIPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.Net.NetworkInformation.GatewayIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 offset:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Net.NetworkInformation.GatewayIPAddressInformation[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (BOOL)remove_withAddress:(System_Net_NetworkInformation_GatewayIPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Remove(System.Net.NetworkInformation.GatewayIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
