...
#pragma mark Methods
    ...
    - (void)add_withAddress:(System_Net_NetworkInformation_IPAddressInformation *)p1
    {
		...
		[self invokeMonoMethod:"Add(System.Net.NetworkInformation.IPAddressInformation)" withNumArgs:1, [p1 monoValue]];;
    ...
    - (BOOL)contains_withAddress:(System_Net_NetworkInformation_IPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.Net.NetworkInformation.IPAddressInformation)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 offset:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Net.NetworkInformation.IPAddressInformation[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (BOOL)remove_withAddress:(System_Net_NetworkInformation_IPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Remove(System.Net.NetworkInformation.IPAddressInformation)" withNumArgs:1, [p1 monoValue]];
