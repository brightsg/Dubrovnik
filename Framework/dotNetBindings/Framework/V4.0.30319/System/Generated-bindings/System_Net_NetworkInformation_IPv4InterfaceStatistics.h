//++Dubrovnik.CodeGenerator System_Net_NetworkInformation_IPv4InterfaceStatistics.h
//
// Managed class : IPv4InterfaceStatistics
//
@interface System_Net_NetworkInformation_IPv4InterfaceStatistics : System_Object
