#import "System.h"
//++Dubrovnik.CodeGenerator System_Net_NetworkInformation_UnicastIPAddressInformationCollection.m
//
...
@implementation System_Net_NetworkInformation_UnicastIPAddressInformationCollection
...
#pragma mark Properties
    ...
    - (System_Net_NetworkInformation_UnicastIPAddressInformation *)item
    {
		...
		_item = [System_Net_NetworkInformation_UnicastIPAddressInformation bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (void)add_withAddress:(System_Net_NetworkInformation_UnicastIPAddressInformation *)p1
    {
		...
		[self invokeMonoMethod:"Add(System.Net.NetworkInformation.UnicastIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)contains_withAddress:(System_Net_NetworkInformation_UnicastIPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Contains(System.Net.NetworkInformation.UnicastIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 offset:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Net.NetworkInformation.UnicastIPAddressInformation[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (BOOL)remove_withAddress:(System_Net_NetworkInformation_UnicastIPAddressInformation *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Remove(System.Net.NetworkInformation.UnicastIPAddressInformation)" withNumArgs:1, [p1 monoRTInvokeArg]];
