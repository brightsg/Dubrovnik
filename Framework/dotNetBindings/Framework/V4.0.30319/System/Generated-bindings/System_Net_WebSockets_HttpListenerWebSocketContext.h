//++Dubrovnik.CodeGenerator System_Net_WebSockets_HttpListenerWebSocketContext.h
//
// Managed class : HttpListenerWebSocketContext
//
@interface System_Net_WebSockets_HttpListenerWebSocketContext : System_Net_WebSockets_WebSocketContext
