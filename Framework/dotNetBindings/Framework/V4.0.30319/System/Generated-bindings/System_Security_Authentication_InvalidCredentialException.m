...
#pragma mark Constructors
    ...
    + (System_Security_Authentication_InvalidCredentialException *)new_withMessage:(NSString *)p1
    {
		...
		System_Security_Authentication_InvalidCredentialException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoValue]];;
    ...
    + (System_Security_Authentication_InvalidCredentialException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Security_Authentication_InvalidCredentialException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
