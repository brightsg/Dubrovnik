...
#pragma mark Constructors
    ...
    + (System_Security_Cryptography_AsnEncodedDataCollection *)new_withAsnEncodedData:(System_Security_Cryptography_AsnEncodedData *)p1
    {
		...
		System_Security_Cryptography_AsnEncodedDataCollection * object = [[self alloc] initWithSignature:"System.Security.Cryptography.AsnEncodedData" withNumArgs:1, [p1 monoValue]];;
...
#pragma mark Methods
    ...
    - (int32_t)add_withAsnEncodedData:(System_Security_Cryptography_AsnEncodedData *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.Security.Cryptography.AsnEncodedData)" withNumArgs:1, [p1 monoValue]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Security.Cryptography.AsnEncodedData[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (void)remove_withAsnEncodedData:(System_Security_Cryptography_AsnEncodedData *)p1
    {
		...
		[self invokeMonoMethod:"Remove(System.Security.Cryptography.AsnEncodedData)" withNumArgs:1, [p1 monoValue]];;
