#import "System.h"
//++Dubrovnik.CodeGenerator System_Security_Cryptography_X509Certificates_X509ChainElementCollection.m
//
...
@implementation System_Security_Cryptography_X509Certificates_X509ChainElementCollection
...
#pragma mark Setup
	...
	{
		return "System.Security.Cryptography.X509Certificates.X509ChainElementCollection";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    - (System_Security_Cryptography_X509Certificates_X509ChainElement *)item
    {
		MonoObject *monoObject = [self getMonoProperty:"Item"];
		if ([self object:_item isEqualToMonoObject:monoObject]) return _item;					
		_item = [System_Security_Cryptography_X509Certificates_X509ChainElement bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Security.Cryptography.X509Certificates.X509ChainElement[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
    ...
    - (System_Security_Cryptography_X509Certificates_X509ChainElementEnumerator *)getEnumerator
    {
		...
		return [System_Security_Cryptography_X509Certificates_X509ChainElementEnumerator bestObjectWithMonoObject:monoObject];
    }
