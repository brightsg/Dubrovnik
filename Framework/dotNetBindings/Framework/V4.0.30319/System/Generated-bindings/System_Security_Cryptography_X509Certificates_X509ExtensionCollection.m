...
#pragma mark Methods
    ...
    - (int32_t)add_withExtension:(System_Security_Cryptography_X509Certificates_X509Extension *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Add(System.Security.Cryptography.X509Certificates.X509Extension)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)copyTo_withArray:(DBSystem_Array *)p1 index:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"CopyTo(System.Security.Cryptography.X509Certificates.X509Extension[],int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
