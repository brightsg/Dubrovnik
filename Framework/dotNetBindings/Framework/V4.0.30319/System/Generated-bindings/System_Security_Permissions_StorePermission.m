#import "System.h"
//++Dubrovnik.CodeGenerator System_Security_Permissions_StorePermission.m
//
// Managed class : StorePermission
//
...
@implementation System_Security_Permissions_StorePermission
...
#pragma mark Setup
	...
	{
		return "System.Security.Permissions.StorePermission";
	}
	// obligatory override
...
#pragma mark Constructors
	...
	// Managed return type : System.Security.Permissions.StorePermission
	// Managed param types : System.Security.Permissions.PermissionState
    + (System_Security_Permissions_StorePermission *)new_withState:(System_Security_Permissions_PermissionState)p1
    {
		
		System_Security_Permissions_StorePermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.PermissionState" withNumArgs:1, DB_VALUE(p1)];;
	...
	// Managed method name : .ctor
	// Managed return type : System.Security.Permissions.StorePermission
	// Managed param types : System.Security.Permissions.StorePermissionFlags
    + (System_Security_Permissions_StorePermission *)new_withFlag:(System_Security_Permissions_StorePermissionFlags)p1
    {
		
		System_Security_Permissions_StorePermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.StorePermissionFlags" withNumArgs:1, DB_VALUE(p1)];;
