...
#pragma mark Constructors
    ...
    + (System_Threading_ThreadExceptionEventHandler *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		System_Threading_ThreadExceptionEventHandler * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];;
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withSender:(System_Object *)p1 e:(System_Threading_ThreadExceptionEventArgs *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(object,System.Threading.ThreadExceptionEventArgs,System.AsyncCallback,object)" withNumArgs:4, [p1 monoValue], [p2 monoValue], [p3 monoValue], [p4 monoValue]];
    ...
    - (void)invoke_withSender:(System_Object *)p1 e:(System_Threading_ThreadExceptionEventArgs *)p2
    {
		...
		[self invokeMonoMethod:"Invoke(object,System.Threading.ThreadExceptionEventArgs)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
