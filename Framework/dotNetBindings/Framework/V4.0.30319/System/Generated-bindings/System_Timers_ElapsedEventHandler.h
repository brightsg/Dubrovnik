//++Dubrovnik.CodeGenerator System_Timers_ElapsedEventHandler.h
//
// Managed class : ElapsedEventHandler
//
@interface System_Timers_ElapsedEventHandler : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
