#import "mscorlib.h"
//++Dubrovnik.CodeGenerator Microsoft_Win32_Registry.m
//
...
#pragma mark Methods
    ...
    + (System_Object *)getValue_withKeyName:(NSString *)p1 valueName:(NSString *)p2 defaultValue:(System_Object *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"GetValue(string,string,object)" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
