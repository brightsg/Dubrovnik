...
#pragma mark Methods
    ...
    + (uint8_t)parse_withS:(NSString *)p1 style:(int32_t)p2
    {
    ...
    + (uint8_t)parse_withS:(NSString *)p1 style:(int32_t)p2 provider:(id <System_IFormatProvider_>)p3
    {
    ...
    + (BOOL)tryParse_withS:(NSString *)p1 style:(int32_t)p2 provider:(id <System_IFormatProvider_>)p3 resultRef:(uint8_t*)p4
    {
		
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryParse(string,System.Globalization.NumberStyles,System.IFormatProvider,byte&)" withNumArgs:4, [p1 monoRTInvokeArg], DB_VALUE(p2), [p3 monoRTInvokeArg], p4];
