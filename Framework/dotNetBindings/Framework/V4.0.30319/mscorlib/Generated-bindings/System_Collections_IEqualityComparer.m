...
#pragma mark Methods
    ...
    - (BOOL)equals_withX:(System_Object *)p1 y:(System_Object *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Collections.IEqualityComparer.Equals(object,object)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    ...
    - (int32_t)getHashCode_withObj:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Collections.IEqualityComparer.GetHashCode(object)" withNumArgs:1, [p1 monoValue]];
