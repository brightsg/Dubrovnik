...
#pragma mark Setup
	...
	{
		return "System.Comparison`1<System.Comparison`1+T>";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    - (System_IAsyncResult *)beginInvoke_withX:(System_Object *)p1 y:(System_Object *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(<_T_0>,<_T_0>,System.AsyncCallback,object)" withNumArgs:4, [p1 monoValue], [p2 monoValue], [p3 monoValue], [p4 monoValue]];
    ...
    - (int32_t)invoke_withX:(System_Object *)p1 y:(System_Object *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke(<_T_0>,<_T_0>)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
