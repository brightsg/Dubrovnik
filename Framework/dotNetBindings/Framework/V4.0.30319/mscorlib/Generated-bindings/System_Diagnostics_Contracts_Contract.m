...
#pragma mark Methods
    ...
    + (BOOL)exists_withFromInclusive:(int32_t)p1 toExclusive:(int32_t)p2 predicate:(System_PredicateA1 *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Exists(int,int,System.Predicate`1<int>)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), [p3 monoRTInvokeArg]];
    ...
    + (BOOL)forAll_withFromInclusive:(int32_t)p1 toExclusive:(int32_t)p2 predicate:(System_PredicateA1 *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"ForAll(int,int,System.Predicate`1<int>)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), [p3 monoRTInvokeArg]];
    ...
    + (System_Object *)valueAtReturn_withValueRef:(System_Diagnostics_Contracts_Contract__T **)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"ValueAtReturn(System.Diagnostics.Contracts.Contract+T&)" withNumArgs:1, &refPtr1];
