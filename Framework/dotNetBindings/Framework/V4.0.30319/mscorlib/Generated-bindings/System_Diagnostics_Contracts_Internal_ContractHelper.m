#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Diagnostics_Contracts_Internal_ContractHelper.m
//
...
@implementation System_Diagnostics_Contracts_Internal_ContractHelper
...
#pragma mark Setup
	...
	{
		return "System.Diagnostics.Contracts.Internal.ContractHelper";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    + (NSString *)raiseContractFailedEvent_withFailureKind:(int32_t)p1 userMessage:(NSString *)p2 conditionText:(NSString *)p3 innerException:(System_Exception *)p4
    {
    ...
    + (void)triggerFailure_withKind:(int32_t)p1 displayMessage:(NSString *)p2 userMessage:(NSString *)p3 conditionText:(NSString *)p4 innerException:(System_Exception *)p5
    {
