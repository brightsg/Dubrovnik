//++Dubrovnik.CodeGenerator System_Diagnostics_DebuggerTypeProxyAttribute.h
//
// Managed class : DebuggerTypeProxyAttribute
//
@interface System_Diagnostics_DebuggerTypeProxyAttribute : System_Attribute <System_Runtime_InteropServices__Attribute_>
