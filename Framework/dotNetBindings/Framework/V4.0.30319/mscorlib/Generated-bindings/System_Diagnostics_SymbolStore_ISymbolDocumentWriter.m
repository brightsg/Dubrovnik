...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolDocumentWriter.SetCheckSum(System.Guid,byte[])" withNumArgs:2, [p1 monoValue], [p2 monoValue]];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolDocumentWriter.SetSource(byte[])" withNumArgs:1, [p1 monoValue]];;
    }
