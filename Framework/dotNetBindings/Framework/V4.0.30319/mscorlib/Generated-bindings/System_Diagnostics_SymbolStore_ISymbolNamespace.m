...
#pragma mark Properties
    ...
    - (NSString *)name
    {
		...
		if (!thunk || thunkClass != self.monoClass) {
			...
			MonoMethod *monoMethod = GetPropertyGetMethod(thunkClass, "System.Diagnostics.SymbolStore.ISymbolNamespace.Name");
...
#pragma mark Methods
    ...
    - (DBSystem_Array *)getNamespaces
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolNamespace.GetNamespaces()" withNumArgs:0];
    ...
    - (DBSystem_Array *)getVariables
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolNamespace.GetVariables()" withNumArgs:0];
