...
//
@protocol System_Diagnostics_SymbolStore_ISymbolVariable <NSObject>
...
#ifdef  DEF_P_AND_M_System_Diagnostics_SymbolStore_ISymbolVariable
...
@protocol db_aux_System_Diagnostics_SymbolStore_ISymbolVariable <NSObject>
