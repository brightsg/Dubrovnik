...
#pragma mark Methods
    ...
    - (void)close
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.Close()" withNumArgs:0];
    ...
    - (void)closeMethod
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.CloseMethod()" withNumArgs:0];
    ...
    - (void)closeNamespace
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.CloseNamespace()" withNumArgs:0];
    ...
    - (void)closeScope_withEndOffset:(int32_t)p1
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.CloseScope(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (int32_t)openScope_withStartOffset:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.OpenScope(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (void)setScopeRange_withScopeID:(int32_t)p1 startOffset:(int32_t)p2 endOffset:(int32_t)p3
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.SetScopeRange(int,int,int)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];
    ...
    - (void)setUnderlyingWriter_withUnderlyingWriter:(void *)p1
    {
		...
		[self invokeMonoMethod:"System.Diagnostics.SymbolStore.ISymbolWriter.SetUnderlyingWriter(intptr)" withNumArgs:1, DB_VALUE(p1)];
