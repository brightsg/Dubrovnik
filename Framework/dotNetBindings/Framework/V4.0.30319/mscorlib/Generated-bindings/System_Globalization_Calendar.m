#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Globalization_Calendar.m
//
...
#pragma mark Methods
    ...
    - (NSDate *)addDays_withTime:(NSDate *)p1 days:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddDays(System.DateTime,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (NSDate *)addHours_withTime:(NSDate *)p1 hours:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddHours(System.DateTime,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (NSDate *)addMilliseconds_withTime:(NSDate *)p1 milliseconds:(double)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddMilliseconds(System.DateTime,double)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (NSDate *)addMinutes_withTime:(NSDate *)p1 minutes:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddMinutes(System.DateTime,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (NSDate *)addSeconds_withTime:(NSDate *)p1 seconds:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddSeconds(System.DateTime,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (NSDate *)addWeeks_withTime:(NSDate *)p1 weeks:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"AddWeeks(System.DateTime,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (int32_t)getHour_withTime:(NSDate *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetHour(System.DateTime)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (double)getMilliseconds_withTime:(NSDate *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetMilliseconds(System.DateTime)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int32_t)getMinute_withTime:(NSDate *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetMinute(System.DateTime)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int32_t)getSecond_withTime:(NSDate *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetSecond(System.DateTime)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Globalization_Calendar *)readOnly_withCalendar:(System_Globalization_Calendar *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"ReadOnly(System.Globalization.Calendar)" withNumArgs:1, [p1 monoRTInvokeArg]];
		
		return [System_Globalization_Calendar bestObjectWithMonoObject:monoObject];
    }
