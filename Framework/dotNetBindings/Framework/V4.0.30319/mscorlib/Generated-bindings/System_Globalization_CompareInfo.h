//++Dubrovnik.CodeGenerator System_Globalization_CompareInfo.h
//
// Managed class : CompareInfo
//
@interface System_Globalization_CompareInfo : System_Object <System_Runtime_Serialization_IDeserializationCallback_>
