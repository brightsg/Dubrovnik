#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Globalization_EastAsianLunisolarCalendar.m
//
...
@implementation System_Globalization_EastAsianLunisolarCalendar
...
#pragma mark Setup
	...
	{
		return "System.Globalization.EastAsianLunisolarCalendar";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    - (int32_t)getCelestialStem_withSexagenaryYear:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetCelestialStem(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (int32_t)getSexagenaryYear_withTime:(NSDate *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetSexagenaryYear(System.DateTime)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int32_t)getTerrestrialBranch_withSexagenaryYear:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"GetTerrestrialBranch(int)" withNumArgs:1, DB_VALUE(p1)];
