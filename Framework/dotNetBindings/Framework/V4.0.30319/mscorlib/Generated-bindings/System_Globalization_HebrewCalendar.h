//++Dubrovnik.CodeGenerator System_Globalization_HebrewCalendar.h
//
// Managed class : HebrewCalendar
//
@interface System_Globalization_HebrewCalendar : System_Globalization_Calendar <System_ICloneable_>
