//++Dubrovnik.CodeGenerator System_Globalization_JulianCalendar.h
//
// Managed class : JulianCalendar
//
@interface System_Globalization_JulianCalendar : System_Globalization_Calendar <System_ICloneable_>
