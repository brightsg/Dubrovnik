#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Globalization_KoreanCalendar.m
//
...
@implementation System_Globalization_KoreanCalendar
...
#pragma mark Fields
    ...
    static int32_t m_koreanEra;
    + (int32_t)koreanEra
    {
		MonoObject *monoObject = [[self class] getMonoClassField:"KoreanEra"];
		m_koreanEra = DB_UNBOX_INT32(monoObject);
