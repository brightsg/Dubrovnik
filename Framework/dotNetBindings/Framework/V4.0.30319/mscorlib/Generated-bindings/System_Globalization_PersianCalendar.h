//++Dubrovnik.CodeGenerator System_Globalization_PersianCalendar.h
//
// Managed class : PersianCalendar
//
@interface System_Globalization_PersianCalendar : System_Globalization_Calendar <System_ICloneable_>
