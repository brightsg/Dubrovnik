//++Dubrovnik.CodeGenerator System_Globalization_TaiwanCalendar.h
//
// Managed class : TaiwanCalendar
//
@interface System_Globalization_TaiwanCalendar : System_Globalization_Calendar <System_ICloneable_>
