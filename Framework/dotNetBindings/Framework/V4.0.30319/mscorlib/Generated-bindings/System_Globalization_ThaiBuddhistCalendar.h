//++Dubrovnik.CodeGenerator System_Globalization_ThaiBuddhistCalendar.h
//
// Managed class : ThaiBuddhistCalendar
//
@interface System_Globalization_ThaiBuddhistCalendar : System_Globalization_Calendar <System_ICloneable_>
