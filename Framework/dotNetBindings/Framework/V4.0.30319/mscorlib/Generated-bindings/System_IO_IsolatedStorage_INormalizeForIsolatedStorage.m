#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_IO_IsolatedStorage_INormalizeForIsolatedStorage.m
//
...
#pragma mark Methods
    ...
    - (System_Object *)normalize
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.IO.IsolatedStorage.INormalizeForIsolatedStorage.Normalize()" withNumArgs:0];
