...
#pragma mark Constructors
    ...
    + (System_IO_UnmanagedMemoryStream *)new_withBuffer:(System_Runtime_InteropServices_SafeBuffer *)p1 offset:(int64_t)p2 length:(int64_t)p3
    {
		...
		System_IO_UnmanagedMemoryStream * object = [[self alloc] initWithSignature:"System.Runtime.InteropServices.SafeBuffer,long,long" withNumArgs:3, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3)];
    ...
    + (System_IO_UnmanagedMemoryStream *)new_withBuffer:(System_Runtime_InteropServices_SafeBuffer *)p1 offset:(int64_t)p2 length:(int64_t)p3 access:(int32_t)p4
    {
		...
		System_IO_UnmanagedMemoryStream * object = [[self alloc] initWithSignature:"System.Runtime.InteropServices.SafeBuffer,long,long,System.IO.FileAccess" withNumArgs:4, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4)];
