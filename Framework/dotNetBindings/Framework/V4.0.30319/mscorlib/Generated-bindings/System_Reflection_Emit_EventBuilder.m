...
#pragma mark Methods
    ...
    - (System_Reflection_Emit_EventToken *)getEventToken
    {
		...
		return [System_Reflection_Emit_EventToken bestObjectWithMonoObject:monoObject];
    }
    ...
    - (void)setAddOnMethod_withMdBuilder:(System_Reflection_Emit_MethodBuilder *)p1
    {
		...
		[self invokeMonoMethod:"SetAddOnMethod(System.Reflection.Emit.MethodBuilder)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)setRaiseMethod_withMdBuilder:(System_Reflection_Emit_MethodBuilder *)p1
    {
		...
		[self invokeMonoMethod:"SetRaiseMethod(System.Reflection.Emit.MethodBuilder)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)setRemoveOnMethod_withMdBuilder:(System_Reflection_Emit_MethodBuilder *)p1
    {
		...
		[self invokeMonoMethod:"SetRemoveOnMethod(System.Reflection.Emit.MethodBuilder)" withNumArgs:1, [p1 monoRTInvokeArg]];
