...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSREEventToken:(System_Reflection_Emit_EventToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.EventToken)" withNumArgs:1, [p1 monoValue]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_EventToken *)p1 b:(System_Reflection_Emit_EventToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.EventToken,System.Reflection.Emit.EventToken)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_EventToken *)p1 b:(System_Reflection_Emit_EventToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.EventToken,System.Reflection.Emit.EventToken)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
