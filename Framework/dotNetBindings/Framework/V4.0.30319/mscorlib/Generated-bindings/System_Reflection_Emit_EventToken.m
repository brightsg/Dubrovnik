#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Reflection_Emit_EventToken.m
//
...
@implementation System_Reflection_Emit_EventToken
...
#pragma mark Fields
    ...
    static System_Reflection_Emit_EventToken * m_empty;
    + (System_Reflection_Emit_EventToken *)empty
    {
		...
		m_empty = [System_Reflection_Emit_EventToken bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSREEventToken:(System_Reflection_Emit_EventToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.EventToken)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_EventToken *)p1 b:(System_Reflection_Emit_EventToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.EventToken,System.Reflection.Emit.EventToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_EventToken *)p1 b:(System_Reflection_Emit_EventToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.EventToken,System.Reflection.Emit.EventToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
