...
#pragma mark Fields
    ...
    + (System_Reflection_Emit_FieldToken *)empty
    {
		...
		m_empty = [System_Reflection_Emit_FieldToken bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSREFieldToken:(System_Reflection_Emit_FieldToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.FieldToken)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_FieldToken *)p1 b:(System_Reflection_Emit_FieldToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.FieldToken,System.Reflection.Emit.FieldToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_FieldToken *)p1 b:(System_Reflection_Emit_FieldToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.FieldToken,System.Reflection.Emit.FieldToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
