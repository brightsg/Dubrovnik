#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Reflection_Emit_MethodToken.m
//
...
#pragma mark Fields
    ...
    static System_Reflection_Emit_MethodToken * m_empty;
    + (System_Reflection_Emit_MethodToken *)empty
    {
		...
		m_empty = [System_Reflection_Emit_MethodToken bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSREMethodToken:(System_Reflection_Emit_MethodToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.MethodToken)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_MethodToken *)p1 b:(System_Reflection_Emit_MethodToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.MethodToken,System.Reflection.Emit.MethodToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_MethodToken *)p1 b:(System_Reflection_Emit_MethodToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.MethodToken,System.Reflection.Emit.MethodToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
