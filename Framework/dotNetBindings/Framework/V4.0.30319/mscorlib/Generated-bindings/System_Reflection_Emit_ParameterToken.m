#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Reflection_Emit_ParameterToken.m
//
...
#pragma mark Fields
    ...
    + (System_Reflection_Emit_ParameterToken *)empty
    {
		...
		m_empty = [System_Reflection_Emit_ParameterToken bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSREParameterToken:(System_Reflection_Emit_ParameterToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.ParameterToken)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_ParameterToken *)p1 b:(System_Reflection_Emit_ParameterToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.ParameterToken,System.Reflection.Emit.ParameterToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_ParameterToken *)p1 b:(System_Reflection_Emit_ParameterToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.ParameterToken,System.Reflection.Emit.ParameterToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
