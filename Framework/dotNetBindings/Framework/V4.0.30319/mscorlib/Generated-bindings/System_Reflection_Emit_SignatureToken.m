#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Reflection_Emit_SignatureToken.m
//
...
#pragma mark Fields
    ...
    + (System_Reflection_Emit_SignatureToken *)empty
    {
		...
		m_empty = [System_Reflection_Emit_SignatureToken bestObjectWithMonoObject:monoObject];
...
#pragma mark Methods
    ...
    - (BOOL)equals_withObjSRESignatureToken:(System_Reflection_Emit_SignatureToken *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.Reflection.Emit.SignatureToken)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)op_Equality_withA:(System_Reflection_Emit_SignatureToken *)p1 b:(System_Reflection_Emit_SignatureToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(System.Reflection.Emit.SignatureToken,System.Reflection.Emit.SignatureToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)op_Inequality_withA:(System_Reflection_Emit_SignatureToken *)p1 b:(System_Reflection_Emit_SignatureToken *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(System.Reflection.Emit.SignatureToken,System.Reflection.Emit.SignatureToken)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
