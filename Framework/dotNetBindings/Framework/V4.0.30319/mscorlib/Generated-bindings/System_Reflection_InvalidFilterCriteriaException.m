#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Reflection_InvalidFilterCriteriaException.m
//
...
#pragma mark Constructors
    ...
    + (System_Reflection_InvalidFilterCriteriaException *)new_withMessage:(NSString *)p1
    {
		...
		System_Reflection_InvalidFilterCriteriaException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Reflection_InvalidFilterCriteriaException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_Reflection_InvalidFilterCriteriaException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
