//++Dubrovnik.CodeGenerator System_Reflection_ObfuscationAttribute.h
//
// Managed class : ObfuscationAttribute
//
@interface System_Reflection_ObfuscationAttribute : System_Attribute <System_Runtime_InteropServices__Attribute_>
