...
//
@interface System_Runtime_CompilerServices_ConditionalWeakTableA2__CreateValueCallback : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withKey:(System_Object *)p1 callback:(System_AsyncCallback *)p2 object:(System_Object *)p3;
