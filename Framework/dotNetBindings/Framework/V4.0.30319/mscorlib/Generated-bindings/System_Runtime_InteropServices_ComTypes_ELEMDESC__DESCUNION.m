...
#pragma mark Fields
    ...
    - (System_Runtime_InteropServices_ComTypes_IDLDESC *)idldesc
    {
		...
		_idldesc = [System_Runtime_InteropServices_ComTypes_IDLDESC bestObjectWithMonoObject:monoObject];
    ...
    - (System_Runtime_InteropServices_ComTypes_PARAMDESC *)paramdesc
    {
		...
		_paramdesc = [System_Runtime_InteropServices_ComTypes_PARAMDESC bestObjectWithMonoObject:monoObject];
