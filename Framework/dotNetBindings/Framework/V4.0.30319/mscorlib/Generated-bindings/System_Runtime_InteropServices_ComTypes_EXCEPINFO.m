#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_EXCEPINFO.m
//
...
@implementation System_Runtime_InteropServices_ComTypes_EXCEPINFO
...
#pragma mark Setup
	...
	{
		return "System.Runtime.InteropServices.ComTypes.EXCEPINFO";
	}
	// obligatory override
...
#pragma mark Fields
    ...
    - (void)setScode:(int32_t)value
	{
		_scode = value;
		MonoObject *monoObject = DB_VALUE(value);
		[self setMonoField:"scode" valueObject:monoObject];          
	}
