#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IEnumConnections.m
//
...
@implementation System_Runtime_InteropServices_ComTypes_IEnumConnections
...
;
    ...
    - (int32_t)next_withCelt:(int32_t)p1 rgelt:(DBSystem_Array *)p2 pceltFetched:(void *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IEnumConnections.Next(int,System.Array[],intptr)" withNumArgs:3, DB_VALUE(p1), [p2 monoValue], DB_VALUE(p3)];
    ...
    - (int32_t)skip_withCelt:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IEnumConnections.Skip(int)" withNumArgs:1, DB_VALUE(p1)];
