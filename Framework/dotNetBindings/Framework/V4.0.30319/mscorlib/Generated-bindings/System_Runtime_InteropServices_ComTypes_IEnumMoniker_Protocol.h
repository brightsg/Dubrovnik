...
//
@protocol System_Runtime_InteropServices_ComTypes_IEnumMoniker <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices_ComTypes_IEnumMoniker
...
@protocol db_aux_System_Runtime_InteropServices_ComTypes_IEnumMoniker <NSObject>
