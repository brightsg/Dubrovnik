...
//
@protocol System_Runtime_InteropServices_ComTypes_IEnumString <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices_ComTypes_IEnumString
...
@protocol db_aux_System_Runtime_InteropServices_ComTypes_IEnumString <NSObject>
