#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IEnumVARIANT.m
//
...
#pragma mark Methods
    ...
    - (int32_t)next_withCelt:(int32_t)p1 rgVar:(DBSystem_Array *)p2 pceltFetched:(void *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IEnumVARIANT.Next(int,object[],intptr)" withNumArgs:3, DB_VALUE(p1), [p2 monoRTInvokeArg], DB_VALUE(p3)];
    ...
    - (int32_t)reset
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IEnumVARIANT.Reset()" withNumArgs:0];
    ...
    - (int32_t)skip_withCelt:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IEnumVARIANT.Skip(int)" withNumArgs:1, DB_VALUE(p1)];
