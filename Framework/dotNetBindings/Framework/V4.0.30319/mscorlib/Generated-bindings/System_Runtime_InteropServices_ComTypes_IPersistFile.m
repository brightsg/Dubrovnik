...
#pragma mark Methods
    ...
    - (void)load_withPszFileName:(NSString *)p1 dwMode:(int32_t)p2
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IPersistFile.Load(string,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (void)save_withPszFileName:(NSString *)p1 fRemember:(BOOL)p2
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IPersistFile.Save(string,bool)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    - (void)saveCompleted_withPszFileName:(NSString *)p1
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IPersistFile.SaveCompleted(string)" withNumArgs:1, [p1 monoRTInvokeArg]];
