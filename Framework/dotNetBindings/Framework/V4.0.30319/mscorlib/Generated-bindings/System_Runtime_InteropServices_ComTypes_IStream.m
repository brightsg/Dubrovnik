...
;
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IStream.CopyTo(System.Runtime.InteropServices.ComTypes.IStream,long,intptr,intptr)" withNumArgs:4, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4)];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IStream.Read(byte[],int,intptr)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices.ComTypes.IStream.Write(byte[],int,intptr)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];;
    }
