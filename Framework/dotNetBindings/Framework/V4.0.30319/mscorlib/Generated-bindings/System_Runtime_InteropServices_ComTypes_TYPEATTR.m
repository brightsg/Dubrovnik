...
#pragma mark Fields
    ...
    - (System_Runtime_InteropServices_ComTypes_IDLDESC *)idldescType
    {
		...
		_idldescType = [System_Runtime_InteropServices_ComTypes_IDLDESC bestObjectWithMonoObject:monoObject];
    ...
    - (System_Runtime_InteropServices_ComTypes_TYPEDESC *)tdescAlias
    {
		...
		_tdescAlias = [System_Runtime_InteropServices_ComTypes_TYPEDESC bestObjectWithMonoObject:monoObject];
