...
#pragma mark Methods
    ...
    - (System_Object *)convertAssemblyToTypeLib_withAssembly:(System_Reflection_Assembly *)p1 typeLibName:(NSString *)p2 flags:(System_Runtime_InteropServices_TypeLibExporterFlags)p3 notifySink:(System_Runtime_InteropServices_ITypeLibExporterNotifySink *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ITypeLibConverter.ConvertAssemblyToTypeLib(System.Reflection.Assembly,string,System.Runtime.InteropServices.TypeLibExporterFlags,System.Runtime.InteropServices.ITypeLibExporterNotifySink)" withNumArgs:4, [p1 monoValue], [p2 monoValue], DB_VALUE(p3), [p4 monoValue]];
...
void *refPtr6 = [*p6 monoValue];
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.ITypeLibConverter.GetPrimaryInteropAssembly(System.Guid,int,int,int,string&,string&)" withNumArgs:6, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4), &refPtr5, &refPtr6];
