#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_MarshalDirectiveException.m
//
...
#pragma mark Constructors
    ...
    + (System_Runtime_InteropServices_MarshalDirectiveException *)new_withMessage:(NSString *)p1
    {
		...
		System_Runtime_InteropServices_MarshalDirectiveException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Runtime_InteropServices_MarshalDirectiveException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_Runtime_InteropServices_MarshalDirectiveException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
