//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_STATSTG.h
//
// Managed struct : STATSTG
//
@interface System_Runtime_InteropServices_STATSTG : DBManagedObject
...
#pragma mark Fields
    ...
    @property (nonatomic, strong) System_Runtime_InteropServices_FILETIME * atime;
	...
	// Managed field type : System.Runtime.InteropServices.FILETIME
    @property (nonatomic, strong) System_Runtime_InteropServices_FILETIME * ctime;
	...
	// Managed field type : System.Runtime.InteropServices.FILETIME
    @property (nonatomic, strong) System_Runtime_InteropServices_FILETIME * mtime;
