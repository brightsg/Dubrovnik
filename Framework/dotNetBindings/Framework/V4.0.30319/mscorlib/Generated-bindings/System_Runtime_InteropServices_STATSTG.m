...
#pragma mark Fields
    ...
    - (System_Runtime_InteropServices_FILETIME *)atime
    {
		...
		_atime = [System_Runtime_InteropServices_FILETIME bestObjectWithMonoObject:monoObject];
    ...
    - (System_Runtime_InteropServices_FILETIME *)ctime
    {
		...
		_ctime = [System_Runtime_InteropServices_FILETIME bestObjectWithMonoObject:monoObject];
    ...
    - (System_Runtime_InteropServices_FILETIME *)mtime
    {
		...
		_mtime = [System_Runtime_InteropServices_FILETIME bestObjectWithMonoObject:monoObject];
