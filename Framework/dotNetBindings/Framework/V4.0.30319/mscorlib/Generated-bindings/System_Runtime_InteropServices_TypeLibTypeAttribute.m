...
#pragma mark Constructors
    ...
    + (System_Runtime_InteropServices_TypeLibTypeAttribute *)new_withFlagsSRITypeLibTypeFlags:(int32_t)p1
    {
		...
		System_Runtime_InteropServices_TypeLibTypeAttribute * object = [[self alloc] initWithSignature:"System.Runtime.InteropServices.TypeLibTypeFlags" withNumArgs:1, DB_VALUE(p1)];
    ...
    + (System_Runtime_InteropServices_TypeLibTypeAttribute *)new_withFlagsInt16:(int16_t)p1
    {
		...
		System_Runtime_InteropServices_TypeLibTypeAttribute * object = [[self alloc] initWithSignature:"int16" withNumArgs:1, DB_VALUE(p1)];
