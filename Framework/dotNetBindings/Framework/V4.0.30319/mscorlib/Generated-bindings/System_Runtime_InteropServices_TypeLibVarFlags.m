#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_TypeLibVarFlags.m
//
...
// C enumeration
@implementation System_Runtime_InteropServices_TypeLibVarFlags
...
#pragma mark Fields
	...
	// Managed field type : System.Runtime.InteropServices.TypeLibVarFlags
    static int32_t m_fReadOnly;
    + (int32_t)fReadOnly
    {
		MonoObject *monoObject = [[self class] getMonoClassField:"FReadOnly"];
		m_fReadOnly = DB_UNBOX_INT32(monoObject);
