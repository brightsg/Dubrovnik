...
//
@protocol System_Runtime_InteropServices_UCOMIEnumString <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices_UCOMIEnumString
...
@protocol db_aux_System_Runtime_InteropServices_UCOMIEnumString <NSObject>
