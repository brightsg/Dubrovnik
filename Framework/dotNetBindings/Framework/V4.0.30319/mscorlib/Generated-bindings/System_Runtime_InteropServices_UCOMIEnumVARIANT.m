...
#pragma mark Methods
    ...
    - (int32_t)next_withCelt:(int32_t)p1 rgvar:(int32_t)p2 pceltFetched:(int32_t)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.UCOMIEnumVARIANT.Next(int,int,int)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];
    ...
    - (int32_t)reset
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.UCOMIEnumVARIANT.Reset()" withNumArgs:0];
    ...
    - (int32_t)skip_withCelt:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices.UCOMIEnumVARIANT.Skip(int)" withNumArgs:1, DB_VALUE(p1)];
