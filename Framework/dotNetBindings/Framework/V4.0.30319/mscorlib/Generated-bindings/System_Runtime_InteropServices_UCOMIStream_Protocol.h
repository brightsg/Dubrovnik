...
//
@protocol System_Runtime_InteropServices_UCOMIStream <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices_UCOMIStream
...
@protocol db_aux_System_Runtime_InteropServices_UCOMIStream <NSObject>
