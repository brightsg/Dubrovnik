...
//
@protocol System_Runtime_InteropServices_UCOMITypeLib <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices_UCOMITypeLib
...
@protocol db_aux_System_Runtime_InteropServices_UCOMITypeLib <NSObject>
