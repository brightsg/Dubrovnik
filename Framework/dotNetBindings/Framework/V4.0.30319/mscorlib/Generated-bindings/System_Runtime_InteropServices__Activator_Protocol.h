...
//
@protocol System_Runtime_InteropServices__Activator <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__Activator
...
@protocol db_aux_System_Runtime_InteropServices__Activator <NSObject>
