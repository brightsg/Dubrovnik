...
//
@protocol System_Runtime_InteropServices__AssemblyBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__AssemblyBuilder
...
@protocol db_aux_System_Runtime_InteropServices__AssemblyBuilder <NSObject>
