...
//
@protocol System_Runtime_InteropServices__AssemblyName <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__AssemblyName
...
@protocol db_aux_System_Runtime_InteropServices__AssemblyName <NSObject>
