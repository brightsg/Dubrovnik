...
//
@protocol System_Runtime_InteropServices__Assembly <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__Assembly
...
@protocol db_aux_System_Runtime_InteropServices__Assembly <NSObject>
