...
//
@protocol System_Runtime_InteropServices__Attribute <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__Attribute
...
@protocol db_aux_System_Runtime_InteropServices__Attribute <NSObject>
