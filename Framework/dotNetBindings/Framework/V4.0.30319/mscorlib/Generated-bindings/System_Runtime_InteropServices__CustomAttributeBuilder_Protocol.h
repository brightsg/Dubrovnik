...
//
@protocol System_Runtime_InteropServices__CustomAttributeBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__CustomAttributeBuilder
...
@protocol db_aux_System_Runtime_InteropServices__CustomAttributeBuilder <NSObject>
