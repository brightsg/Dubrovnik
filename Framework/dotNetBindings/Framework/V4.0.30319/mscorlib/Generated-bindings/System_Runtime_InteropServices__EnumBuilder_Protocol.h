...
//
@protocol System_Runtime_InteropServices__EnumBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__EnumBuilder
...
@protocol db_aux_System_Runtime_InteropServices__EnumBuilder <NSObject>
