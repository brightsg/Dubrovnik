...
//
@protocol System_Runtime_InteropServices__EventBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__EventBuilder
...
@protocol db_aux_System_Runtime_InteropServices__EventBuilder <NSObject>
