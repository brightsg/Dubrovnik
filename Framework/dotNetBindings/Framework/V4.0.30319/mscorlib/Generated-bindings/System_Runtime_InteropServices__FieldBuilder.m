#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__FieldBuilder.m
//
...
@implementation System_Runtime_InteropServices__FieldBuilder
...
#pragma mark Setup
	...
	{
		return "System.Runtime.InteropServices._FieldBuilder";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldBuilder.GetIDsOfNames(System.Guid&,intptr,uint,uint,intptr)" withNumArgs:5, &refPtr1, DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5)];
;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldBuilder.GetTypeInfo(uint,uint,intptr)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldBuilder.GetTypeInfoCount(uint&)" withNumArgs:1, p1];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldBuilder.Invoke(uint,System.Guid&,uint,int16,intptr,intptr,intptr,intptr)" withNumArgs:8, DB_VALUE(p1), &refPtr2, DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5), DB_VALUE(p6), DB_VALUE(p7), DB_VALUE(p8)];
;
    }
