...
//
@protocol System_Runtime_InteropServices__FieldBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__FieldBuilder
...
@protocol db_aux_System_Runtime_InteropServices__FieldBuilder <NSObject>
