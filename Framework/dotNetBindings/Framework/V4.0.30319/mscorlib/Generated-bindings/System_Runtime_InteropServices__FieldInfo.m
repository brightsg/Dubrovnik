...
#pragma mark Properties
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.Attributes"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.DeclaringType"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.FieldHandle"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.FieldType"];
    ...
    - (BOOL)isAssembly
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsAssembly"];
    ...
    - (BOOL)isFamily
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsFamily"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsFamilyAndAssembly"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsFamilyOrAssembly"];
    ...
    - (BOOL)isInitOnly
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsInitOnly"];
    ...
    - (BOOL)isLiteral
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsLiteral"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsNotSerialized"];
    ...
    - (BOOL)isPinvokeImpl
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsPinvokeImpl"];
    ...
    - (BOOL)isPrivate
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsPrivate"];
    ...
    - (BOOL)isPublic
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsPublic"];
    ...
    - (BOOL)isSpecialName
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsSpecialName"];
    ...
    - (BOOL)isStatic
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.IsStatic"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.MemberType"];
    ...
    - (NSString *)name
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.Name"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.InteropServices._FieldInfo.ReflectedType"];
...
#pragma mark Methods
    ...
    - (DBSystem_Array *)getCustomAttributes_withInherit:(BOOL)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetCustomAttributes(bool)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (int32_t)getHashCode
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetHashCode()" withNumArgs:0];
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetIDsOfNames(System.Guid&,intptr,uint,uint,intptr)" withNumArgs:5, &refPtr1, DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5)];
;
    }
    ...
    - (System_Type *)getType
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetType()" withNumArgs:0];
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetTypeInfo(uint,uint,intptr)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.GetTypeInfoCount(uint&)" withNumArgs:1, p1];;
    }
    ...
    {
		[self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.Invoke(uint,System.Guid&,uint,int16,intptr,intptr,intptr,intptr)" withNumArgs:8, DB_VALUE(p1), &refPtr2, DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5), DB_VALUE(p6), DB_VALUE(p7), DB_VALUE(p8)];
;
    }
    ...
    - (NSString *)toString
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._FieldInfo.ToString()" withNumArgs:0];
