...
//
@protocol System_Runtime_InteropServices__FieldInfo <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__FieldInfo
...
@protocol db_aux_System_Runtime_InteropServices__FieldInfo <NSObject>
