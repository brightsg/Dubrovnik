#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ILGenerator.m
//
...
@implementation System_Runtime_InteropServices__ILGenerator
...
#pragma mark Setup
	...
	{
		return "System.Runtime.InteropServices._ILGenerator";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    - (void)getIDsOfNames_withRiidRef:(System_Guid **)p1 rgszNames:(void *)p2 cNames:(uint32_t)p3 lcid:(uint32_t)p4 rgDispId:(void *)p5
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices._ILGenerator.GetIDsOfNames(System.Guid&,intptr,uint,uint,intptr)" withNumArgs:5, &refPtr1, DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5)];
    ...
    - (void)getTypeInfo_withITInfo:(uint32_t)p1 lcid:(uint32_t)p2 ppTInfo:(void *)p3
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices._ILGenerator.GetTypeInfo(uint,uint,intptr)" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];
    ...
    - (void)getTypeInfoCount_withPcTInfoRef:(uint32_t*)p1
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices._ILGenerator.GetTypeInfoCount(uint&)" withNumArgs:1, p1];
    ...
    - (void)invoke_withDispIdMember:(uint32_t)p1 riidRef:(System_Guid **)p2 lcid:(uint32_t)p3 wFlags:(int16_t)p4 pDispParams:(void *)p5 pVarResult:(void *)p6 pExcepInfo:(void *)p7 puArgErr:(void *)p8
    {
		...
		[self invokeMonoMethod:"System.Runtime.InteropServices._ILGenerator.Invoke(uint,System.Guid&,uint,int16,intptr,intptr,intptr,intptr)" withNumArgs:8, DB_VALUE(p1), &refPtr2, DB_VALUE(p3), DB_VALUE(p4), DB_VALUE(p5), DB_VALUE(p6), DB_VALUE(p7), DB_VALUE(p8)];
