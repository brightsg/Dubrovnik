...
//
@protocol System_Runtime_InteropServices__ILGenerator <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__ILGenerator
...
@protocol db_aux_System_Runtime_InteropServices__ILGenerator <NSObject>
