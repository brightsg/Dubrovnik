...
//
@protocol System_Runtime_InteropServices__LocalBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__LocalBuilder
...
@protocol db_aux_System_Runtime_InteropServices__LocalBuilder <NSObject>
