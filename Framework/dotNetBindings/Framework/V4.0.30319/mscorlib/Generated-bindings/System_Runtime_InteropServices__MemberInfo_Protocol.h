...
//
@protocol System_Runtime_InteropServices__MemberInfo <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__MemberInfo
...
@protocol db_aux_System_Runtime_InteropServices__MemberInfo <NSObject>
