...
#pragma mark Methods
    ...
    - (BOOL)equals_withOther:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._MethodBase.Equals(object)" withNumArgs:1, [p1 monoValue]];
    ...
    - (DBSystem_Array *)getCustomAttributes_withAttributeType:(System_Type *)p1 inherit:(BOOL)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._MethodBase.GetCustomAttributes(System.Type,bool)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
...
;
    ...
    - (System_Object *)invoke_withObj:(System_Object *)p1 invokeAttr:(System_Reflection_BindingFlags)p2 binder:(System_Reflection_Binder *)p3 parameters:(DBSystem_Array *)p4 culture:(System_Globalization_CultureInfo *)p5
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._MethodBase.Invoke(object,System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo)" withNumArgs:5, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], [p4 monoValue], [p5 monoValue]];
    ...
    - (System_Object *)invoke_withObj:(System_Object *)p1 parameters:(DBSystem_Array *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._MethodBase.Invoke(object,object[])" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    ...
    - (BOOL)isDefined_withAttributeType:(System_Type *)p1 inherit:(BOOL)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.InteropServices._MethodBase.IsDefined(System.Type,bool)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
