...
//
@protocol System_Runtime_InteropServices__MethodRental <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__MethodRental
...
@protocol db_aux_System_Runtime_InteropServices__MethodRental <NSObject>
