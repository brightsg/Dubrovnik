...
//
@protocol System_Runtime_InteropServices__Module <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__Module
...
@protocol db_aux_System_Runtime_InteropServices__Module <NSObject>
