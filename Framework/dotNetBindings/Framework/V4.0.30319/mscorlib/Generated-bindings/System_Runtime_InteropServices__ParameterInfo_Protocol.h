...
//
@protocol System_Runtime_InteropServices__ParameterInfo <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__ParameterInfo
...
@protocol db_aux_System_Runtime_InteropServices__ParameterInfo <NSObject>
