...
//
@protocol System_Runtime_InteropServices__PropertyBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__PropertyBuilder
...
@protocol db_aux_System_Runtime_InteropServices__PropertyBuilder <NSObject>
