...
//
@protocol System_Runtime_InteropServices__Thread <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__Thread
...
@protocol db_aux_System_Runtime_InteropServices__Thread <NSObject>
