...
//
@protocol System_Runtime_InteropServices__TypeBuilder <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_InteropServices__TypeBuilder
...
@protocol db_aux_System_Runtime_InteropServices__TypeBuilder <NSObject>
