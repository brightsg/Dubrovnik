...
#pragma mark Properties
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.Remoting.Activation.IActivator.Level"];
    ...
    {
		MonoObject *monoObject = [self getMonoProperty:"System.Runtime.Remoting.Activation.IActivator.NextActivator"];
    ...
    - (void)setNextActivator:(System_Runtime_Remoting_Activation_IActivator *)value
	{
		...
		[self setMonoProperty:"System.Runtime.Remoting.Activation.IActivator.NextActivator" valueObject:monoObject];          
	}
...
#pragma mark Methods
    ...
    - (System_Runtime_Remoting_Activation_IConstructionReturnMessage *)activate_withMsg:(System_Runtime_Remoting_Activation_IConstructionCallMessage *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.Remoting.Activation.IActivator.Activate(System.Runtime.Remoting.Activation.IConstructionCallMessage)" withNumArgs:1, [p1 monoValue]];
