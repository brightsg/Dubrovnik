...
//
@protocol System_Runtime_Remoting_Activation_IActivator <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_Remoting_Activation_IActivator
...
@protocol db_aux_System_Runtime_Remoting_Activation_IActivator <NSObject>
