...
#ifdef  DEF_P_AND_M_System_Runtime_Remoting_Channels_IServerChannelSinkProvider
...
@protocol db_aux_System_Runtime_Remoting_Channels_IServerChannelSinkProvider <NSObject>
