...
//
@protocol System_Runtime_Remoting_Contexts_IContextProperty <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_Remoting_Contexts_IContextProperty
...
@protocol db_aux_System_Runtime_Remoting_Contexts_IContextProperty <NSObject>
