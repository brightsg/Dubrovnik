...
//
@protocol System_Runtime_Remoting_Messaging_IMessageSink <NSObject>
...
#ifdef  DEF_P_AND_M_System_Runtime_Remoting_Messaging_IMessageSink
...
@protocol db_aux_System_Runtime_Remoting_Messaging_IMessageSink <NSObject>
