#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Runtime_Remoting_Messaging_IMethodMessage.m
//
...
#pragma mark Methods
    ...
    - (System_Object *)getArg_withArgNum:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.Remoting.Messaging.IMethodMessage.GetArg(int)" withNumArgs:1, DB_VALUE(p1)];
    ...
    - (NSString *)getArgName_withIndex:(int32_t)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"System.Runtime.Remoting.Messaging.IMethodMessage.GetArgName(int)" withNumArgs:1, DB_VALUE(p1)];
