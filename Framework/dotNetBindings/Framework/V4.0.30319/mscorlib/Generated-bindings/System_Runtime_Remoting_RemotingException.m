...
#pragma mark Constructors
    ...
    + (System_Runtime_Remoting_RemotingException *)new_withMessage:(NSString *)p1
    {
		...
		System_Runtime_Remoting_RemotingException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Runtime_Remoting_RemotingException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Runtime_Remoting_RemotingException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
