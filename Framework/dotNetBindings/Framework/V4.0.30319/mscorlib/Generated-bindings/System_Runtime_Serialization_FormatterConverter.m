...
#pragma mark Methods
    ...
    - (System_Object *)convert_withValue:(System_Object *)p1 type:(System_Type *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Convert(object,System.Type)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    - (BOOL)toBoolean_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToBoolean(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (uint8_t)toByte_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToByte(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (uint16_t)toChar_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToChar(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (NSDate *)toDateTime_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToDateTime(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (NSDecimalNumber *)toDecimal_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToDecimal(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (double)toDouble_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToDouble(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int16_t)toInt16_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt16(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int32_t)toInt32_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt32(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int64_t)toInt64_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt64(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (int8_t)toSByte_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToSByte(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (float)toSingle_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToSingle(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (NSString *)toString_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToString(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (uint16_t)toUInt16_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToUInt16(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (uint32_t)toUInt32_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToUInt32(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (uint64_t)toUInt64_withValue:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"ToUInt64(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
