#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_AccessControl_DiscretionaryAcl.m
//
...
#pragma mark Constructors
    ...
    + (System_Security_AccessControl_DiscretionaryAcl *)new_withIsContainer:(BOOL)p1 isDS:(BOOL)p2 capacity:(int32_t)p3
    {
		...
		System_Security_AccessControl_DiscretionaryAcl * object = [[self alloc] initWithSignature:"bool,bool,int" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3)];
    ...
    + (System_Security_AccessControl_DiscretionaryAcl *)new_withIsContainer:(BOOL)p1 isDS:(BOOL)p2 revision:(uint8_t)p3 capacity:(int32_t)p4
    {
		...
		System_Security_AccessControl_DiscretionaryAcl * object = [[self alloc] initWithSignature:"bool,bool,byte,int" withNumArgs:4, DB_VALUE(p1), DB_VALUE(p2), DB_VALUE(p3), DB_VALUE(p4)];
    ...
    + (System_Security_AccessControl_DiscretionaryAcl *)new_withIsContainer:(BOOL)p1 isDS:(BOOL)p2 rawAcl:(System_Security_AccessControl_RawAcl *)p3
    {
		...
		System_Security_AccessControl_DiscretionaryAcl * object = [[self alloc] initWithSignature:"bool,bool,System.Security.AccessControl.RawAcl" withNumArgs:3, DB_VALUE(p1), DB_VALUE(p2), [p3 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (void)addAccess_withAccessType:(int32_t)p1 sid:(System_Security_Principal_SecurityIdentifier *)p2 rule:(System_Security_AccessControl_ObjectAccessRule *)p3
    {
		...
		[self invokeMonoMethod:"AddAccess(System.Security.AccessControl.AccessControlType,System.Security.Principal.SecurityIdentifier,System.Security.AccessControl.ObjectAccessRule)" withNumArgs:3, DB_VALUE(p1), [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
    ...
    - (BOOL)removeAccess_withAccessType:(int32_t)p1 sid:(System_Security_Principal_SecurityIdentifier *)p2 rule:(System_Security_AccessControl_ObjectAccessRule *)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAccess(System.Security.AccessControl.AccessControlType,System.Security.Principal.SecurityIdentifier,System.Security.AccessControl.ObjectAccessRule)" withNumArgs:3, DB_VALUE(p1), [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
    ...
    - (void)removeAccessSpecific_withAccessType:(int32_t)p1 sid:(System_Security_Principal_SecurityIdentifier *)p2 rule:(System_Security_AccessControl_ObjectAccessRule *)p3
    {
		...
		[self invokeMonoMethod:"RemoveAccessSpecific(System.Security.AccessControl.AccessControlType,System.Security.Principal.SecurityIdentifier,System.Security.AccessControl.ObjectAccessRule)" withNumArgs:3, DB_VALUE(p1), [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
    ...
    - (void)setAccess_withAccessType:(int32_t)p1 sid:(System_Security_Principal_SecurityIdentifier *)p2 rule:(System_Security_AccessControl_ObjectAccessRule *)p3
    {
		...
		[self invokeMonoMethod:"SetAccess(System.Security.AccessControl.AccessControlType,System.Security.Principal.SecurityIdentifier,System.Security.AccessControl.ObjectAccessRule)" withNumArgs:3, DB_VALUE(p1), [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
