#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_AccessControl_FileSystemSecurity.m
//
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"AddAccessRule(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"AddAuditRule(System.Security.AccessControl.FileSystemAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    - (BOOL)removeAccessRule_withRule:(System_Security_AccessControl_FileSystemAccessRule *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAccessRule(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    {
		[self invokeMonoMethod:"RemoveAccessRuleAll(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"RemoveAccessRuleSpecific(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    - (BOOL)removeAuditRule_withRule:(System_Security_AccessControl_FileSystemAuditRule *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAuditRule(System.Security.AccessControl.FileSystemAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    {
		[self invokeMonoMethod:"RemoveAuditRuleAll(System.Security.AccessControl.FileSystemAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"RemoveAuditRuleSpecific(System.Security.AccessControl.FileSystemAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"ResetAccessRule(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"SetAccessRule(System.Security.AccessControl.FileSystemAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"SetAuditRule(System.Security.AccessControl.FileSystemAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
