#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_AccessControl_ObjectSecurityA1.m
//
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"AddAccessRule(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"AddAuditRule(System.Security.AccessControl.AuditRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    - (BOOL)removeAccessRule_withRule:(System_Security_AccessControl_AccessRuleA1 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAccessRule(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    {
		[self invokeMonoMethod:"RemoveAccessRuleAll(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"RemoveAccessRuleSpecific(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    - (BOOL)removeAuditRule_withRule:(System_Security_AccessControl_AuditRuleA1 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAuditRule(System.Security.AccessControl.AuditRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    {
		[self invokeMonoMethod:"RemoveAuditRuleAll(System.Security.AccessControl.AuditRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"RemoveAuditRuleSpecific(System.Security.AccessControl.AuditRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"ResetAccessRule(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"SetAccessRule(System.Security.AccessControl.AccessRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
    ...
    {
		[self invokeMonoMethod:"SetAuditRule(System.Security.AccessControl.AuditRule`1<System.Security.AccessControl.ObjectSecurity`1+T>)" withNumArgs:1, [p1 monoRTInvokeArg]];;
    }
