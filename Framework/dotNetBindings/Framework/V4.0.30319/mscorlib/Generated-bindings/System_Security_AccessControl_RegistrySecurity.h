//++Dubrovnik.CodeGenerator System_Security_AccessControl_RegistrySecurity.h
//
// Managed class : RegistrySecurity
//
@interface System_Security_AccessControl_RegistrySecurity : System_Security_AccessControl_NativeObjectSecurity
