#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_AccessControl_RegistrySecurity.m
//
...
#pragma mark Methods
    ...
    - (void)addAccessRule_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		[self invokeMonoMethod:"AddAccessRule(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)addAuditRule_withRule:(System_Security_AccessControl_RegistryAuditRule *)p1
    {
		...
		[self invokeMonoMethod:"AddAuditRule(System.Security.AccessControl.RegistryAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)removeAccessRule_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAccessRule(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)removeAccessRuleAll_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		[self invokeMonoMethod:"RemoveAccessRuleAll(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)removeAccessRuleSpecific_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		[self invokeMonoMethod:"RemoveAccessRuleSpecific(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)removeAuditRule_withRule:(System_Security_AccessControl_RegistryAuditRule *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"RemoveAuditRule(System.Security.AccessControl.RegistryAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)removeAuditRuleAll_withRule:(System_Security_AccessControl_RegistryAuditRule *)p1
    {
		...
		[self invokeMonoMethod:"RemoveAuditRuleAll(System.Security.AccessControl.RegistryAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)removeAuditRuleSpecific_withRule:(System_Security_AccessControl_RegistryAuditRule *)p1
    {
		...
		[self invokeMonoMethod:"RemoveAuditRuleSpecific(System.Security.AccessControl.RegistryAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)resetAccessRule_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		[self invokeMonoMethod:"ResetAccessRule(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)setAccessRule_withRule:(System_Security_AccessControl_RegistryAccessRule *)p1
    {
		...
		[self invokeMonoMethod:"SetAccessRule(System.Security.AccessControl.RegistryAccessRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (void)setAuditRule_withRule:(System_Security_AccessControl_RegistryAuditRule *)p1
    {
		...
		[self invokeMonoMethod:"SetAuditRule(System.Security.AccessControl.RegistryAuditRule)" withNumArgs:1, [p1 monoRTInvokeArg]];
