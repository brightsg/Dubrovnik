//++Dubrovnik.CodeGenerator System_Security_Cryptography_DES.h
//
// Managed class : DES
//
@interface System_Security_Cryptography_DES : System_Security_Cryptography_SymmetricAlgorithm <System_IDisposable_>
