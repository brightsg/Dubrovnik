#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_Cryptography_DES.m
//
// Managed class : DES
//
...
#pragma mark Methods
    ...
    + (System_Security_Cryptography_DES *)create
    {
		...
		return [System_Security_Cryptography_DES bestObjectWithMonoObject:monoObject];
    }
    ...
    + (BOOL)isSemiWeakKey_withRgbKey:(NSData *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"IsSemiWeakKey(byte[])" withNumArgs:1, [p1 monoRTInvokeArg]];
