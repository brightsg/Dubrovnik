//++Dubrovnik.CodeGenerator System_Security_Cryptography_RijndaelManaged.h
//
// Managed class : RijndaelManaged
//
@interface System_Security_Cryptography_RijndaelManaged : System_Security_Cryptography_Rijndael <System_IDisposable_>
