#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_Permissions_SecurityPermission.m
//
...
@implementation System_Security_Permissions_SecurityPermission
...
#pragma mark Constructors
    ...
    + (System_Security_Permissions_SecurityPermission *)new_withState:(int32_t)p1
    {
		
		System_Security_Permissions_SecurityPermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.PermissionState" withNumArgs:1, DB_VALUE(p1)];
    ...
    + (System_Security_Permissions_SecurityPermission *)new_withFlag:(int32_t)p1
    {
		
		System_Security_Permissions_SecurityPermission * object = [[self alloc] initWithSignature:"System.Security.Permissions.SecurityPermissionFlag" withNumArgs:1, DB_VALUE(p1)];
