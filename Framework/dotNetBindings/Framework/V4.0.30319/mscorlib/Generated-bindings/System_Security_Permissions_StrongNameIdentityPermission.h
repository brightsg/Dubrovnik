...
//
@interface System_Security_Permissions_StrongNameIdentityPermission : System_Security_CodeAccessPermission <System_Security_IPermission_, System_Security_ISecurityEncodable_, System_Security_IStackWalk_>
...
#pragma mark Constructors
    ...
    + (System_Security_Permissions_StrongNameIdentityPermission *)new_withState:(int32_t)p1;
