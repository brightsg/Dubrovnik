//++Dubrovnik.CodeGenerator System_Security_Policy_Publisher.h
//
// Managed class : Publisher
//
@interface System_Security_Policy_Publisher : System_Security_Policy_EvidenceBase <System_Security_Policy_IIdentityPermissionFactory_>
