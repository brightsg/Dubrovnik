...
//
@protocol System_Security_Principal_IPrincipal <NSObject>
...
#ifdef  DEF_P_AND_M_System_Security_Principal_IPrincipal
...
@protocol db_aux_System_Security_Principal_IPrincipal <NSObject>
