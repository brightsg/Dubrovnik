#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_VerificationException.m
//
...
#pragma mark Constructors
    ...
    + (System_Security_VerificationException *)new_withMessage:(NSString *)p1
    {
		...
		System_Security_VerificationException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Security_VerificationException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Security_VerificationException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
