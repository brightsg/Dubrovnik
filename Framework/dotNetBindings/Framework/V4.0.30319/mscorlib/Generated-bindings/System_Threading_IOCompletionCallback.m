...
#pragma mark Constructors
    ...
    + (System_Threading_IOCompletionCallback *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		System_Threading_IOCompletionCallback * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withErrorCode:(uint32_t)p1 numBytes:(uint32_t)p2 pOVERLAP:(System_Threading_NativeOverlapped **)p3 callback:(System_AsyncCallback *)p4 object:(System_Object *)p5
    {
		
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(uint,uint,System.Threading.NativeOverlapped*,System.AsyncCallback,object)" withNumArgs:5, DB_VALUE(p1), DB_VALUE(p2), p3, [p4 monoRTInvokeArg], [p5 monoRTInvokeArg]];
