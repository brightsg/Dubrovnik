#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Threading_Monitor.m
//
...
#pragma mark Methods
    ...
    + (BOOL)isEntered_withObj:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"IsEntered(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)tryEnter_withObj:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryEnter(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (BOOL)tryEnter_withObj:(System_Object *)p1 millisecondsTimeout:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryEnter(object,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    + (BOOL)tryEnter_withObj:(System_Object *)p1 timeout:(System_TimeSpan *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryEnter(object,System.TimeSpan)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)wait_withObj:(System_Object *)p1 millisecondsTimeout:(int32_t)p2 exitContext:(BOOL)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Wait(object,int,bool)" withNumArgs:3, [p1 monoRTInvokeArg], DB_VALUE(p2), DB_VALUE(p3)];
    ...
    + (BOOL)wait_withObj:(System_Object *)p1 timeout:(System_TimeSpan *)p2 exitContext:(BOOL)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Wait(object,System.TimeSpan,bool)" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], DB_VALUE(p3)];
    ...
    + (BOOL)wait_withObj:(System_Object *)p1 millisecondsTimeout:(int32_t)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Wait(object,int)" withNumArgs:2, [p1 monoRTInvokeArg], DB_VALUE(p2)];
    ...
    + (BOOL)wait_withObj:(System_Object *)p1 timeout:(System_TimeSpan *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Wait(object,System.TimeSpan)" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (BOOL)wait_withObj:(System_Object *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"Wait(object)" withNumArgs:1, [p1 monoRTInvokeArg]];
