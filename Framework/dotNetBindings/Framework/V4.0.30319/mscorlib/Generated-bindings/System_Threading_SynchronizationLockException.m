#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Threading_SynchronizationLockException.m
//
...
#pragma mark Constructors
    ...
    + (System_Threading_SynchronizationLockException *)new_withMessage:(NSString *)p1
    {
		...
		System_Threading_SynchronizationLockException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_Threading_SynchronizationLockException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_Threading_SynchronizationLockException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
