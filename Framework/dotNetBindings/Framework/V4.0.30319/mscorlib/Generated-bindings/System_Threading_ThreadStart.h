//++Dubrovnik.CodeGenerator System_Threading_ThreadStart.h
//
// Managed class : ThreadStart
//
@interface System_Threading_ThreadStart : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
