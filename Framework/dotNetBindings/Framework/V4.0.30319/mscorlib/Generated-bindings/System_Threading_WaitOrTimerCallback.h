//++Dubrovnik.CodeGenerator System_Threading_WaitOrTimerCallback.h
//
// Managed class : WaitOrTimerCallback
//
@interface System_Threading_WaitOrTimerCallback : System_MulticastDelegate <System_ICloneable_, System_Runtime_Serialization_ISerializable_>
