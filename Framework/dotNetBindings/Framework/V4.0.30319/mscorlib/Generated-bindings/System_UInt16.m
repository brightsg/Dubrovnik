...
#pragma mark Methods
    ...
    + (BOOL)tryParse_withS:(NSString *)p1 resultRef:(uint16_t*)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryParse(string,uint16&)" withNumArgs:2, [p1 monoValue], p2];
    ...
    + (BOOL)tryParse_withS:(NSString *)p1 style:(System_Globalization_NumberStyles)p2 provider:(System_IFormatProvider *)p3 resultRef:(uint16_t*)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryParse(string,System.Globalization.NumberStyles,System.IFormatProvider,uint16&)" withNumArgs:4, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], p4];
