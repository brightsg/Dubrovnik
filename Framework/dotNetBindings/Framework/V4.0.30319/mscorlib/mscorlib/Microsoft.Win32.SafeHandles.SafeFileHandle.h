//++Dubrovnik.CodeGenerator Microsoft.Win32.SafeHandles.SafeFileHandle.h
//
// Managed class : SafeFileHandle
//
@interface Microsoft_Win32_SafeHandles_SafeFileHandle : Microsoft_Win32_SafeHandles_SafeHandleZeroOrMinusOneIsInvalid
