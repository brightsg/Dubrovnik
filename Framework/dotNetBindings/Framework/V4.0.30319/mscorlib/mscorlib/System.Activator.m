#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Activator.m
//
...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.Type,System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo)" withNumArgs:5, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], [p4 monoValue], [p5 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.Type,System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo,object[])" withNumArgs:6, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], [p4 monoValue], [p5 monoValue], [p6 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.Type,object[])" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.Type,object[],object[])" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.Type,bool)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance()" withNumArgs:0];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstance(System.AppDomain,string,string)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [System_Runtime_Remoting_ObjectHandle representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstanceFrom(System.AppDomain,string,string)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [System_Runtime_Remoting_ObjectHandle representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"CreateInstanceFrom(System.AppDomain,string,string,bool,System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo,object[],System.Security.Policy.Evidence)" withNumArgs:10, [p1 monoValue], [p2 monoValue], [p3 monoValue], DB_VALUE(p4), DB_VALUE(p5), [p6 monoValue], [p7 monoValue], [p8 monoValue], [p9 monoValue], [p10 monoValue]];
		return [System_Runtime_Remoting_ObjectHandle representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetObject(System.Type,string)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetObject(System.Type,string,object)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
@end
