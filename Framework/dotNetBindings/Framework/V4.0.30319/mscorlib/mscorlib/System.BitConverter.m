#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.BitConverter.m
//
...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"DoubleToInt64Bits(double)" withNumArgs:1, DB_VALUE(p1)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(bool)" withNumArgs:1, DB_VALUE(p1)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(char)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(int16)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(long)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(uint16)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(uint)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(ulong)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(single)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetBytes(double)" withNumArgs:1, DB_VALUE(p1)];
		return [NSData dataWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Int64BitsToDouble(long)" withNumArgs:1, DB_VALUE(p1)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToBoolean(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToChar(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToDouble(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return DB_UNBOX_DOUBLE(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt16(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt32(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToInt64(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return DB_UNBOX_INT64(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToSingle(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToString(byte[],int,int)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToString(byte[])" withNumArgs:1, [p1 monoValue]];
		return [NSString stringWithMonoString:DB_STRING(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToString(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return [NSString stringWithMonoString:DB_STRING(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToUInt16(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return DB_UNBOX_UINT16(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ToUInt32(byte[],int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
