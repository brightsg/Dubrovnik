...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"BlockCopy(System.Array,int,System.Array,int,int)" withNumArgs:5, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], DB_VALUE(p4), DB_VALUE(p5)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ByteLength(System.Array)" withNumArgs:1, [p1 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetByte(System.Array,int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
