//++Dubrovnik.CodeGenerator System.Collections.Concurrent.IProducerConsumerCollectionA1.h
//
// Managed interface : IProducerConsumerCollection`1<T>
//
@interface System_Collections_Concurrent_IProducerConsumerCollectionA1 : System_Object
