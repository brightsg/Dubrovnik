#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Collections.Generic.ComparerA1.m
//
...
#pragma mark Setup
	...
	{
		return "System.Collections.Generic.Comparer`1<T>";
	}
	// obligatory override
...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"Create(Comparison`1<T>)" withNumArgs:1, [p1 monoValue]];
