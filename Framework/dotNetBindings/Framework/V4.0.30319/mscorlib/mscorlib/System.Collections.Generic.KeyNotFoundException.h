//++Dubrovnik.CodeGenerator System.Collections.Generic.KeyNotFoundException.h
//
// Managed class : KeyNotFoundException
//
@interface System_Collections_Generic_KeyNotFoundException : System_SystemException
