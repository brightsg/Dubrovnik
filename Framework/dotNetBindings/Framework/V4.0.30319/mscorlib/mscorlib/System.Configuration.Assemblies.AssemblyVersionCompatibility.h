//++Dubrovnik.CodeGenerator System.Configuration.Assemblies.AssemblyVersionCompatibility.h
//
// Managed enumeration : AssemblyVersionCompatibility
//
typedef NS_ENUM(int32_t, System_Configuration_Assemblies_AssemblyVersionCompatibility) {
