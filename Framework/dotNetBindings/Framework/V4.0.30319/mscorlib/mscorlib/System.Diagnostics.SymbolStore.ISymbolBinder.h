//++Dubrovnik.CodeGenerator System.Diagnostics.SymbolStore.ISymbolBinder.h
//
// Managed interface : ISymbolBinder
//
@interface System_Diagnostics_SymbolStore_ISymbolBinder : DBMonoObjectRepresentation
