//++Dubrovnik.CodeGenerator System.Diagnostics.SymbolStore.ISymbolWriter.h
//
// Managed interface : ISymbolWriter
//
@interface System_Diagnostics_SymbolStore_ISymbolWriter : DBMonoObjectRepresentation
