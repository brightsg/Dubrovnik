#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Func_P8.m
//
// Managed class : Func`8
//
@implementation System_Func_P8
...
#pragma mark Constructors
    ...
    + (System_Func_P8 *)new_withObject:(DBMonoObjectRepresentation *)p1 method:(void *)p2
    {
...
#pragma mark Methods
    ...
    - (DBMonoObjectRepresentation *)invoke_withArg1:(DBMonoObjectRepresentation *)p1 arg2:(DBMonoObjectRepresentation *)p2 arg3:(DBMonoObjectRepresentation *)p3 arg4:(DBMonoObjectRepresentation *)p4 arg5:(DBMonoObjectRepresentation *)p5 arg6:(DBMonoObjectRepresentation *)p6 arg7:(DBMonoObjectRepresentation *)p7
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke(Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter,Dubrovnik.Generic.Parameter)" withNumArgs:7, [p1 monoValue], [p2 monoValue], [p3 monoValue], [p4 monoValue], [p5 monoValue], [p6 monoValue], [p7 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
@end
