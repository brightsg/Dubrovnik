//++Dubrovnik.CodeGenerator System.Globalization.CultureNotFoundException.h
//
// Managed class : CultureNotFoundException
//
@interface System_Globalization_CultureNotFoundException : System_ArgumentException
