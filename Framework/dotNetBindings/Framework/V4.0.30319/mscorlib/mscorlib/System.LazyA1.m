#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.LazyA1.m
//
...
#pragma mark Constructors
    ...
    + (System_LazyA1 *)new_withValueFactory:(FuncA1 *)p1
    {
    ...
    + (System_LazyA1 *)new_withValueFactory:(FuncA1 *)p1 isThreadSafe:(BOOL)p2
    {
	...
	// Managed method name : .ctor
	// Managed return type : System.Lazy`1<T>
	// Managed param types : Func`1<T>, System.Threading.LazyThreadSafetyMode
    + (System_LazyA1 *)new_withValueFactory:(FuncA1 *)p1 mode:(System_Threading_LazyThreadSafetyMode)p2
    {
		return [[self alloc] initWithSignature:"Func`1<T>,System.Threading.LazyThreadSafetyMode" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    }
