#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.ModuleHandle.m
//
...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"op_Equality(System.ModuleHandle,System.ModuleHandle)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return DB_UNBOX_BOOLEAN(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"op_Inequality(System.ModuleHandle,System.ModuleHandle)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return DB_UNBOX_BOOLEAN(monoObject);
    }
