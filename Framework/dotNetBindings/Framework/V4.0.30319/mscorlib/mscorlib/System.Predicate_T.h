//++Dubrovnik.CodeGenerator System.Predicate_T.h
//
// Managed class : Predicate<T>
//
@interface System_Predicate : System_MulticastDelegate
...
#pragma mark Constructors
    ...
    + (System_Predicate *)new_withObject:(System_Object *)p1 method:(void *)p2;
...
#pragma mark Methods
    ...
    - (BOOL)invoke_withObj:(DBManagedObject *)p1;
@end
