...
#pragma mark Fields
    ...
    + (System_Reflection_TypeFilter *)filterTypeName
    {
		...
		return [System_Reflection_TypeFilter representationWithMonoObject:monoObject];
	}
...
#pragma mark Properties
    ...
    - (System_ModuleHandle *)moduleHandle
    {
		...
		System_ModuleHandle * result = [System_ModuleHandle representationWithMonoObject:monoObject];
		return result;
	}
