//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.AssemblyRegistrationFlags.h
//
// Managed enumeration : AssemblyRegistrationFlags
//
typedef NS_ENUM(int32_t, System_Runtime_InteropServices_AssemblyRegistrationFlags) {
