//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.COMException.h
//
// Managed class : COMException
//
@interface System_Runtime_InteropServices_COMException : System_Runtime_InteropServices_ExternalException
