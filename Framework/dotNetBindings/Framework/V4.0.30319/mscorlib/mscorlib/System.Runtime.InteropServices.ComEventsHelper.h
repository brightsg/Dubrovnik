//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.ComEventsHelper.h
//
// Managed class : ComEventsHelper
//
@interface System_Runtime_InteropServices_ComEventsHelper : DBMonoObjectRepresentation
