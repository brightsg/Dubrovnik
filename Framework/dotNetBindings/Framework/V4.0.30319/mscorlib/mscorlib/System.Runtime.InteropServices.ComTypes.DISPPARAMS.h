//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.ComTypes.DISPPARAMS.h
//
// Managed struct : DISPPARAMS
//
@interface System_Runtime_InteropServices_ComTypes_DISPPARAMS : DBMonoObjectRepresentation
