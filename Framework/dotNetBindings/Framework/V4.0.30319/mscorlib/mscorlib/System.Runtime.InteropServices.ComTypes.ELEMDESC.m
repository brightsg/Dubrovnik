...
#pragma mark Fields
    ...
    - (System_Runtime_InteropServices_ComTypes_ELEMDESC__DESCUNION *)desc
    {
		...
		_desc = [System_Runtime_InteropServices_ComTypes_ELEMDESC__DESCUNION objectWithMonoObject:monoObject];
		return _desc;
	}
    ...
    - (System_Runtime_InteropServices_ComTypes_TYPEDESC *)tdesc
    {
		...
		_tdesc = [System_Runtime_InteropServices_ComTypes_TYPEDESC objectWithMonoObject:monoObject];
		return _tdesc;
	}
