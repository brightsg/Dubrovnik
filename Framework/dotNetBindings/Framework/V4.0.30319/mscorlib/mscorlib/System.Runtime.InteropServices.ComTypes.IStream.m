#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.ComTypes.IStream.m
//
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"Clone(System.Runtime.InteropServices.ComTypes.IStream&)" withNumArgs:1, [p1 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"Stat(System.Runtime.InteropServices.ComTypes.STATSTG&,int)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    }
