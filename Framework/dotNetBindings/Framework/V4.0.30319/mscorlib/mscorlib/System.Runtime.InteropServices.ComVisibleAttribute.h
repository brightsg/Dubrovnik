//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.ComVisibleAttribute.h
//
// Managed class : ComVisibleAttribute
//
@interface System_Runtime_InteropServices_ComVisibleAttribute : System_Attribute
