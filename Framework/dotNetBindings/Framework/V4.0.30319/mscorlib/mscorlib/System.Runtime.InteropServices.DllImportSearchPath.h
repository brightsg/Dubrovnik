//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.DllImportSearchPath.h
//
// Managed enumeration : DllImportSearchPath
//
typedef NS_ENUM(int32_t, System_Runtime_InteropServices_DllImportSearchPath) {
