//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.ITypeLibConverter.h
//
// Managed interface : ITypeLibConverter
//
@interface System_Runtime_InteropServices_ITypeLibConverter : DBMonoObjectRepresentation
