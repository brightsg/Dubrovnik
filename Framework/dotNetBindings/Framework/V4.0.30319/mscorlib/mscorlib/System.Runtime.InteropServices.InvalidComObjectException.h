//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.InvalidComObjectException.h
//
// Managed class : InvalidComObjectException
//
@interface System_Runtime_InteropServices_InvalidComObjectException : System_SystemException
