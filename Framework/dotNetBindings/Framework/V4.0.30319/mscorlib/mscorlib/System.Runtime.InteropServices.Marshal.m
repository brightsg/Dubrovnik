...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"CreateAggregatedObject(intptr,Dubrovnik.Generic.Parameter)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];
		return DB_UNBOX_PTR(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"CreateWrapperOfType(Dubrovnik.Generic.Parameter)" withNumArgs:1, [p1 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"GetComInterfaceForObject(Dubrovnik.Generic.Parameter)" withNumArgs:1, [p1 monoValue]];
		return DB_UNBOX_PTR(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"GetFunctionPointerForDelegate(Dubrovnik.Generic.Parameter)" withNumArgs:1, [p1 monoValue]];
		return DB_UNBOX_PTR(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"GetMethodInfoForComSlot(System.Type,int,System.Runtime.InteropServices.ComMemberType&)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), [p3 monoValue]];
    ...
    {
		[self invokeMonoClassMethod:"GetNativeVariantForObject(Dubrovnik.Generic.Parameter,intptr)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    }
    ...
    {
		[self invokeMonoClassMethod:"PtrToStructure(intptr,Dubrovnik.Generic.Parameter)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"QueryInterface(intptr,System.Guid&,intptr&)" withNumArgs:3, DB_VALUE(p1), [p2 monoValue], p3];
		return DB_UNBOX_INT32(monoObject);
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"SizeOf(Dubrovnik.Generic.Parameter)" withNumArgs:1, [p1 monoValue]];
		return DB_UNBOX_INT32(monoObject);
    }
    ...
    {
		[self invokeMonoClassMethod:"StructureToPtr(Dubrovnik.Generic.Parameter,intptr,bool)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3)];
    }
