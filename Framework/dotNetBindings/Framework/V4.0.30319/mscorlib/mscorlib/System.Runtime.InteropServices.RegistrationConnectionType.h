//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.RegistrationConnectionType.h
//
// Managed enumeration : RegistrationConnectionType
//
typedef NS_ENUM(int32_t, System_Runtime_InteropServices_RegistrationConnectionType) {
