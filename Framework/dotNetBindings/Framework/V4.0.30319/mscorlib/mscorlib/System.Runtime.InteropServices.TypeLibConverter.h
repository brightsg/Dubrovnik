//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.TypeLibConverter.h
//
// Managed class : TypeLibConverter
//
@interface System_Runtime_InteropServices_TypeLibConverter : DBMonoObjectRepresentation
...
#pragma mark Methods
    ...
    - (DBMonoObjectRepresentation *)convertAssemblyToTypeLib_withAssembly:(System_Reflection_Assembly *)p1 strTypeLibName:(NSString *)p2 flags:(System_Runtime_InteropServices_TypeLibExporterFlags)p3 notifySink:(System_Runtime_InteropServices_ITypeLibExporterNotifySink *)p4;
