//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.TypeLibExporterFlags.h
//
// Managed enumeration : TypeLibExporterFlags
//
typedef NS_ENUM(int32_t, System_Runtime_InteropServices_TypeLibExporterFlags) {
