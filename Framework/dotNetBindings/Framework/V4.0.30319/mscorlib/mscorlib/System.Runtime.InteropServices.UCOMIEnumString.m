#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.UCOMIEnumString.m
//
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"Clone(System.Runtime.InteropServices.UCOMIEnumString&)" withNumArgs:1, [p1 monoValue]];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Next(int,string[],int&)" withNumArgs:3, DB_VALUE(p1), [p2 monoValue], p3];
