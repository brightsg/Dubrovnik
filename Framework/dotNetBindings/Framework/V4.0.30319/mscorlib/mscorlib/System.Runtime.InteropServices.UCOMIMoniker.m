#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.UCOMIMoniker.m
//
...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"CommonPrefixWith(System.Runtime.InteropServices.UCOMIMoniker,System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"ComposeWith(System.Runtime.InteropServices.UCOMIMoniker,bool,System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), [p3 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"Enum(bool,System.Runtime.InteropServices.UCOMIEnumMoniker&)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];
    }
...
#warning object ref and out parameter implementation is pending
    {
		[self invokeMonoMethod:"GetDisplayName(System.Runtime.InteropServices.UCOMIBindCtx,System.Runtime.InteropServices.UCOMIMoniker,string&)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"GetTimeOfLastChange(System.Runtime.InteropServices.UCOMIBindCtx,System.Runtime.InteropServices.UCOMIMoniker,System.Runtime.InteropServices.FILETIME&)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"Inverse(System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:1, [p1 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"ParseDisplayName(System.Runtime.InteropServices.UCOMIBindCtx,System.Runtime.InteropServices.UCOMIMoniker,string,int&,System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:5, [p1 monoValue], [p2 monoValue], [p3 monoValue], p4, [p5 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"Reduce(System.Runtime.InteropServices.UCOMIBindCtx,int,System.Runtime.InteropServices.UCOMIMoniker&,System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:4, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], [p4 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"RelativePathTo(System.Runtime.InteropServices.UCOMIMoniker,System.Runtime.InteropServices.UCOMIMoniker&)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    }
