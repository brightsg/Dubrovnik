#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Runtime.InteropServices.UCOMITypeLib.m
//
...
#warning object ref and out parameter implementation is pending
    ...
    {
		[self invokeMonoMethod:"GetTypeInfo(int,System.Runtime.InteropServices.UCOMITypeInfo&)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"GetTypeInfoOfGuid(System.Guid&,System.Runtime.InteropServices.UCOMITypeInfo&)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    }
    ...
    {
		[self invokeMonoMethod:"GetTypeInfoType(int,System.Runtime.InteropServices.TYPEKIND&)" withNumArgs:2, DB_VALUE(p1), [p2 monoValue]];
    }
