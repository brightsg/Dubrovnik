...
#pragma mark Methods
	...
	// Managed param types : Func`2<T, System.Runtime.InteropServices.WindowsRuntime.EventRegistrationToken>, System.Action`1<System.Runtime.InteropServices.WindowsRuntime.EventRegistrationToken>, <T>
    + (void)addEventHandler_withAddMethod:(FuncA2 *)p1 removeMethod:(System_ActionA1 *)p2 handler:(DBManagedObject *)p3
    {
		[self invokeMonoClassMethod:"AddEventHandler(Func`2<T, System.Runtime.InteropServices.WindowsRuntime.EventRegistrationToken>,System.Action`1<System.Runtime.InteropServices.WindowsRuntime.EventRegistrationToken>,Dubrovnik.Generic.Parameter)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
    }
    ...
    + (void)removeEventHandler_withRemoveMethod:(System_ActionA1 *)p1 handler:(DBManagedObject *)p2
    {
		[self invokeMonoClassMethod:"RemoveEventHandler(System.Action`1<System.Runtime.InteropServices.WindowsRuntime.EventRegistrationToken>,Dubrovnik.Generic.Parameter)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    }
