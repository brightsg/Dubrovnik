//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._AssemblyBuilder.h
//
// Managed interface : _AssemblyBuilder
//
@interface System_Runtime_InteropServices__AssemblyBuilder : DBMonoObjectRepresentation
