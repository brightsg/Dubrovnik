//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._ConstructorInfo.h
//
// Managed interface : _ConstructorInfo
//
@interface System_Runtime_InteropServices__ConstructorInfo : DBMonoObjectRepresentation
