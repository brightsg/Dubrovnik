#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._ConstructorInfo.m
//
...
#pragma mark Methods
    ...
    - (DBMonoObjectRepresentation *)invoke_2_withObj:(DBMonoObjectRepresentation *)p1 invokeAttr:(System_Reflection_BindingFlags)p2 binder:(System_Reflection_Binder *)p3 parameters:(DBSystem_Array *)p4 culture:(System_Globalization_CultureInfo *)p5
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke_2(object,System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo)" withNumArgs:5, [p1 monoValue], DB_VALUE(p2), [p3 monoValue], [p4 monoValue], [p5 monoValue]];
    ...
    - (DBMonoObjectRepresentation *)invoke_3_withObj:(DBMonoObjectRepresentation *)p1 parameters:(DBSystem_Array *)p2
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke_3(object,object[])" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
    ...
    - (DBMonoObjectRepresentation *)invoke_4_withInvokeAttr:(System_Reflection_BindingFlags)p1 binder:(System_Reflection_Binder *)p2 parameters:(DBSystem_Array *)p3 culture:(System_Globalization_CultureInfo *)p4
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke_4(System.Reflection.BindingFlags,System.Reflection.Binder,object[],System.Globalization.CultureInfo)" withNumArgs:4, DB_VALUE(p1), [p2 monoValue], [p3 monoValue], [p4 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
	...
	// Managed return type : System.Object
	// Managed param types : System.Object[]
    - (DBMonoObjectRepresentation *)invoke_5_withParameters:(DBSystem_Array *)p1
    {
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke_5(object[])" withNumArgs:1, [p1 monoValue]];
		return [DBMonoObjectRepresentation representationWithMonoObject:monoObject];
    }
