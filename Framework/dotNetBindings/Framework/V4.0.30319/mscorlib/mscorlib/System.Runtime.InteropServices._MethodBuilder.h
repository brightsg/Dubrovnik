//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._MethodBuilder.h
//
// Managed interface : _MethodBuilder
//
@interface System_Runtime_InteropServices__MethodBuilder : DBMonoObjectRepresentation
