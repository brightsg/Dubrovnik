//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._ModuleBuilder.h
//
// Managed interface : _ModuleBuilder
//
@interface System_Runtime_InteropServices__ModuleBuilder : DBMonoObjectRepresentation
