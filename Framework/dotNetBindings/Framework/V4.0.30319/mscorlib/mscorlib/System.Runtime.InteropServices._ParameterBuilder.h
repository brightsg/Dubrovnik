//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._ParameterBuilder.h
//
// Managed interface : _ParameterBuilder
//
@interface System_Runtime_InteropServices__ParameterBuilder : DBMonoObjectRepresentation
