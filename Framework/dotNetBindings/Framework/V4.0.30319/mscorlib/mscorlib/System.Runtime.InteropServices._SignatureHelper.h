//++Dubrovnik.CodeGenerator System.Runtime.InteropServices._SignatureHelper.h
//
// Managed interface : _SignatureHelper
//
@interface System_Runtime_InteropServices__SignatureHelper : DBMonoObjectRepresentation
