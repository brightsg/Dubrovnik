//++Dubrovnik.CodeGenerator System.Runtime.Remoting.Channels.ClientChannelSinkStack.h
//
// Managed class : ClientChannelSinkStack
//
@interface System_Runtime_Remoting_Channels_ClientChannelSinkStack : DBMonoObjectRepresentation
