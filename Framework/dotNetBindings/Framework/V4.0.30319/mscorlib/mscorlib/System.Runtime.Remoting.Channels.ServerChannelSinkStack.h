//++Dubrovnik.CodeGenerator System.Runtime.Remoting.Channels.ServerChannelSinkStack.h
//
// Managed class : ServerChannelSinkStack
//
@interface System_Runtime_Remoting_Channels_ServerChannelSinkStack : DBMonoObjectRepresentation
