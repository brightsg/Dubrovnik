//++Dubrovnik.CodeGenerator System.Runtime.Remoting.Contexts.ContextAttribute.h
//
// Managed class : ContextAttribute
//
@interface System_Runtime_Remoting_Contexts_ContextAttribute : System_Attribute
