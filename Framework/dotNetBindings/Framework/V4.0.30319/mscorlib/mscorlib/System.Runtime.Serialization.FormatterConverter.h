//++Dubrovnik.CodeGenerator System.Runtime.Serialization.FormatterConverter.h
//
// Managed class : FormatterConverter
//
@interface System_Runtime_Serialization_FormatterConverter : DBMonoObjectRepresentation
