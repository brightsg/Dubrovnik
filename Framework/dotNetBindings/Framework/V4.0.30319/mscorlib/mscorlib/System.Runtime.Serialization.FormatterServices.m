...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"CheckTypeSecurity(System.Type,System.Runtime.Serialization.Formatters.TypeFilterLevel)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetObjectData(object,System.Array[])" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetSafeUninitializedObject(System.Type)" withNumArgs:1, [p1 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetSerializableMembers(System.Type)" withNumArgs:1, [p1 monoValue]];
		return [DBSystem_Array arrayWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetSerializableMembers(System.Type,System.Runtime.Serialization.StreamingContext)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [DBSystem_Array arrayWithMonoArray:DB_ARRAY(monoObject)];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetSurrogateForCyclicalReference(System.Runtime.Serialization.ISerializationSurrogate)" withNumArgs:1, [p1 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetTypeFromAssembly(System.Reflection.Assembly,string)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"GetUninitializedObject(System.Type)" withNumArgs:1, [p1 monoValue]];
		return [System_Object objectWithMonoObject:monoObject];
    }
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"PopulateObjectMembers(object,System.Array[],object[])" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [System_Object objectWithMonoObject:monoObject];
    }
