//++Dubrovnik.CodeGenerator System.Runtime.Serialization.Formatters.FormatterAssemblyStyle.h
//
// Managed enumeration : FormatterAssemblyStyle
//
typedef NS_ENUM(int32_t, System_Runtime_Serialization_Formatters_FormatterAssemblyStyle) {
