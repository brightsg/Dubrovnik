//++Dubrovnik.CodeGenerator System.Runtime.Serialization.IFormatterConverter.h
//
// Managed interface : IFormatterConverter
//
@interface System_Runtime_Serialization_IFormatterConverter : DBMonoObjectRepresentation
