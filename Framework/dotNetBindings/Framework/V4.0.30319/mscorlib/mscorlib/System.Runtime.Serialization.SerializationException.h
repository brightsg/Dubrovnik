//++Dubrovnik.CodeGenerator System.Runtime.Serialization.SerializationException.h
//
// Managed class : SerializationException
//
@interface System_Runtime_Serialization_SerializationException : System_SystemException
