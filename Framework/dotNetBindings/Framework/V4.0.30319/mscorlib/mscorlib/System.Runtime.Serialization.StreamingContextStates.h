//++Dubrovnik.CodeGenerator System.Runtime.Serialization.StreamingContextStates.h
//
// Managed enumeration : StreamingContextStates
//
typedef NS_ENUM(int32_t, System_Runtime_Serialization_StreamingContextStates) {
