//++Dubrovnik.CodeGenerator System.Runtime.Versioning.ComponentGuaranteesOptions.h
//
// Managed enumeration : ComponentGuaranteesOptions
//
typedef NS_ENUM(int32_t, System_Runtime_Versioning_ComponentGuaranteesOptions) {
