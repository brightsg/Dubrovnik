#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.RuntimeFieldHandle.m
//
...
#pragma mark Methods
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"op_Equality(System.RuntimeFieldHandle,System.RuntimeFieldHandle)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return DB_UNBOX_BOOLEAN(monoObject);
    }
