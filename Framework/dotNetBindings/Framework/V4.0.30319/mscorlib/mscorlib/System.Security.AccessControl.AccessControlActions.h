//++Dubrovnik.CodeGenerator System.Security.AccessControl.AccessControlActions.h
//
// Managed enumeration : AccessControlActions
//
typedef NS_ENUM(int32_t, System_Security_AccessControl_AccessControlActions) {
