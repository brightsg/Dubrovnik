//++Dubrovnik.CodeGenerator System.Security.AccessControl.AccessControlModification.h
//
// Managed enumeration : AccessControlModification
//
typedef NS_ENUM(int32_t, System_Security_AccessControl_AccessControlModification) {
