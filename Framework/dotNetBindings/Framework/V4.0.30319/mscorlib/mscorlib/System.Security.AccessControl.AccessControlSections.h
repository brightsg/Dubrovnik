//++Dubrovnik.CodeGenerator System.Security.AccessControl.AccessControlSections.h
//
// Managed enumeration : AccessControlSections
//
typedef NS_ENUM(int32_t, System_Security_AccessControl_AccessControlSections) {
