#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System.Security.AccessControl.AccessRuleA1.m
//
...
#pragma mark Setup
	...
	{
		return "System.Security.AccessControl.AccessRule`1<T>";
	}
	// obligatory override
...
#pragma mark Constructors
    ...
    + (System_Security_AccessControl_AccessRuleA1 *)new_withIdentitySSPIdentityReference:(System_Security_Principal_IdentityReference *)p1 rightsDGParameter:(DBManagedObject *)p2 typeSSAAccessControlType:(System_Security_AccessControl_AccessControlType)p3
    {
    ...
    + (System_Security_AccessControl_AccessRuleA1 *)new_withIdentityString:(NSString *)p1 rightsDGParameter:(DBManagedObject *)p2 typeSSAAccessControlType:(System_Security_AccessControl_AccessControlType)p3
    {
    ...
    + (System_Security_AccessControl_AccessRuleA1 *)new_withIdentityString:(NSString *)p1 rightsDGParameter:(DBManagedObject *)p2 inheritanceFlagsSSAInheritanceFlags:(System_Security_AccessControl_InheritanceFlags)p3 propagationFlagsSSAPropagationFlags:(System_Security_AccessControl_PropagationFlags)p4 typeSSAAccessControlType:(System_Security_AccessControl_AccessControlType)p5
    {
