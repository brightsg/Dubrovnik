...
#pragma mark Constructors
    ...
    + (System_Security_AccessControl_AuditRule *)new_withIdentitySSPIdentityReference:(System_Security_Principal_IdentityReference *)p1 rightsDGParameter:(DBManagedObject *)p2 flagsSSAAuditFlags:(System_Security_AccessControl_AuditFlags)p3
    {
    ...
    + (System_Security_AccessControl_AuditRule *)new_withIdentityString:(NSString *)p1 rightsDGParameter:(DBManagedObject *)p2 flagsSSAAuditFlags:(System_Security_AccessControl_AuditFlags)p3
    {
    ...
    + (System_Security_AccessControl_AuditRule *)new_withIdentityString:(NSString *)p1 rightsDGParameter:(DBManagedObject *)p2 inheritanceFlagsSSAInheritanceFlags:(System_Security_AccessControl_InheritanceFlags)p3 propagationFlagsSSAPropagationFlags:(System_Security_AccessControl_PropagationFlags)p4 flagsSSAAuditFlags:(System_Security_AccessControl_AuditFlags)p5
    {
