//++Dubrovnik.CodeGenerator System.Security.AccessControl.DiscretionaryAcl.h
//
// Managed class : DiscretionaryAcl
//
@interface System_Security_AccessControl_DiscretionaryAcl : System_Security_AccessControl_CommonAcl
