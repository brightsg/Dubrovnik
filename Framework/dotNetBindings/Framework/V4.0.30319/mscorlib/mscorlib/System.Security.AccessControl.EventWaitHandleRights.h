//++Dubrovnik.CodeGenerator System.Security.AccessControl.EventWaitHandleRights.h
//
// Managed enumeration : EventWaitHandleRights
//
typedef NS_ENUM(int32_t, System_Security_AccessControl_EventWaitHandleRights) {
