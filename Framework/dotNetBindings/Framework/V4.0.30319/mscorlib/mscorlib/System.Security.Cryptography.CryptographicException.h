//++Dubrovnik.CodeGenerator System.Security.Cryptography.CryptographicException.h
//
// Managed class : CryptographicException
//
@interface System_Security_Cryptography_CryptographicException : System_SystemException
