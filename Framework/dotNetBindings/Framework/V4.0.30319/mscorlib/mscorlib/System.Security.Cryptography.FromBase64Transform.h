//++Dubrovnik.CodeGenerator System.Security.Cryptography.FromBase64Transform.h
//
// Managed class : FromBase64Transform
//
@interface System_Security_Cryptography_FromBase64Transform : DBMonoObjectRepresentation
