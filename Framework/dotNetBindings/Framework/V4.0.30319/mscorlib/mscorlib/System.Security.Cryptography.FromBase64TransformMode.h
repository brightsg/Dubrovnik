//++Dubrovnik.CodeGenerator System.Security.Cryptography.FromBase64TransformMode.h
//
// Managed enumeration : FromBase64TransformMode
//
typedef NS_ENUM(int32_t, System_Security_Cryptography_FromBase64TransformMode) {
