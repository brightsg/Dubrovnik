//++Dubrovnik.CodeGenerator System.Security.Cryptography.RSACryptoServiceProvider.h
//
// Managed class : RSACryptoServiceProvider
//
@interface System_Security_Cryptography_RSACryptoServiceProvider : System_Security_Cryptography_RSA
