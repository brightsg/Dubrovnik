//++Dubrovnik.CodeGenerator System.Security.Cryptography.Rijndael.h
//
// Managed class : Rijndael
//
@interface System_Security_Cryptography_Rijndael : System_Security_Cryptography_SymmetricAlgorithm
