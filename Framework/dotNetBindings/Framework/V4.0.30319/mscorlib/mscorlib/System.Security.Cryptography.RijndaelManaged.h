//++Dubrovnik.CodeGenerator System.Security.Cryptography.RijndaelManaged.h
//
// Managed class : RijndaelManaged
//
@interface System_Security_Cryptography_RijndaelManaged : System_Security_Cryptography_Rijndael
