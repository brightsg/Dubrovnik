//++Dubrovnik.CodeGenerator System.Security.Permissions.EnvironmentPermission.h
//
// Managed class : EnvironmentPermission
//
@interface System_Security_Permissions_EnvironmentPermission : System_Security_CodeAccessPermission
