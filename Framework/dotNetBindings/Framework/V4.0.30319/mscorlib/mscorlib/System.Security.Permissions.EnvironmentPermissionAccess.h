//++Dubrovnik.CodeGenerator System.Security.Permissions.EnvironmentPermissionAccess.h
//
// Managed enumeration : EnvironmentPermissionAccess
//
typedef NS_ENUM(int32_t, System_Security_Permissions_EnvironmentPermissionAccess) {
