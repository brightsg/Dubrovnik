//++Dubrovnik.CodeGenerator System.Security.Permissions.FileDialogPermissionAccess.h
//
// Managed enumeration : FileDialogPermissionAccess
//
typedef NS_ENUM(int32_t, System_Security_Permissions_FileDialogPermissionAccess) {
