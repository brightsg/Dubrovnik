//++Dubrovnik.CodeGenerator System.Security.Permissions.FileIOPermissionAccess.h
//
// Managed enumeration : FileIOPermissionAccess
//
typedef NS_ENUM(int32_t, System_Security_Permissions_FileIOPermissionAccess) {
