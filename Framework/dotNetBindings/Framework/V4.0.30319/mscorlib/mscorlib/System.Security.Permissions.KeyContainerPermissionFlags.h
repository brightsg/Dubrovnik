//++Dubrovnik.CodeGenerator System.Security.Permissions.KeyContainerPermissionFlags.h
//
// Managed enumeration : KeyContainerPermissionFlags
//
typedef NS_ENUM(int32_t, System_Security_Permissions_KeyContainerPermissionFlags) {
