//++Dubrovnik.CodeGenerator System.Security.Permissions.PublisherIdentityPermission.h
//
// Managed class : PublisherIdentityPermission
//
@interface System_Security_Permissions_PublisherIdentityPermission : System_Security_CodeAccessPermission
