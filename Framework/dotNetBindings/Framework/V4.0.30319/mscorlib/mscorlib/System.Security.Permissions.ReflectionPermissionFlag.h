//++Dubrovnik.CodeGenerator System.Security.Permissions.ReflectionPermissionFlag.h
//
// Managed enumeration : ReflectionPermissionFlag
//
typedef NS_ENUM(int32_t, System_Security_Permissions_ReflectionPermissionFlag) {
