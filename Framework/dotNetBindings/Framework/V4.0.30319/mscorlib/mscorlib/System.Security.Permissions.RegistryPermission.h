//++Dubrovnik.CodeGenerator System.Security.Permissions.RegistryPermission.h
//
// Managed class : RegistryPermission
//
@interface System_Security_Permissions_RegistryPermission : System_Security_CodeAccessPermission
