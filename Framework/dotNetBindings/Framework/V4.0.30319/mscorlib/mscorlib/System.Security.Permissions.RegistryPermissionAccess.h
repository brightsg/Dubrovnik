//++Dubrovnik.CodeGenerator System.Security.Permissions.RegistryPermissionAccess.h
//
// Managed enumeration : RegistryPermissionAccess
//
typedef NS_ENUM(int32_t, System_Security_Permissions_RegistryPermissionAccess) {
