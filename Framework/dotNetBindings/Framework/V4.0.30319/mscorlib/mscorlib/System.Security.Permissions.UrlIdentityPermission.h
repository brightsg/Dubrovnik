//++Dubrovnik.CodeGenerator System.Security.Permissions.UrlIdentityPermission.h
//
// Managed class : UrlIdentityPermission
//
@interface System_Security_Permissions_UrlIdentityPermission : System_Security_CodeAccessPermission
