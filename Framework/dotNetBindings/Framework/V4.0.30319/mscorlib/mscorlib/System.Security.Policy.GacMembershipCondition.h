//++Dubrovnik.CodeGenerator System.Security.Policy.GacMembershipCondition.h
//
// Managed class : GacMembershipCondition
//
@interface System_Security_Policy_GacMembershipCondition : DBMonoObjectRepresentation
