//++Dubrovnik.CodeGenerator System.Security.Policy.SiteMembershipCondition.h
//
// Managed class : SiteMembershipCondition
//
@interface System_Security_Policy_SiteMembershipCondition : DBMonoObjectRepresentation
