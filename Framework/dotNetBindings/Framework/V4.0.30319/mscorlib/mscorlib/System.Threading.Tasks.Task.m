...
#pragma mark Methods
	...
	// Managed param types : Func`2<System.Threading.Tasks.Task, TResult>
    - (TaskA1 *)continueWith_withContinuationFunction:(FuncA2 *)p1
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`2<System.Threading.Tasks.Task, TResult>)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`2<System.Threading.Tasks.Task, TResult>, System.Threading.CancellationToken
    - (TaskA1 *)continueWith_withContinuationFunction:(FuncA2 *)p1 cancellationToken:(System_Threading_CancellationToken *)p2
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`2<System.Threading.Tasks.Task, TResult>,System.Threading.CancellationToken)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`2<System.Threading.Tasks.Task, TResult>, System.Threading.Tasks.TaskScheduler
    - (TaskA1 *)continueWith_withContinuationFunction:(FuncA2 *)p1 scheduler:(System_Threading_Tasks_TaskScheduler *)p2
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`2<System.Threading.Tasks.Task, TResult>,System.Threading.Tasks.TaskScheduler)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`2<System.Threading.Tasks.Task, TResult>, System.Threading.Tasks.TaskContinuationOptions
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`2<System.Threading.Tasks.Task, TResult>,System.Threading.Tasks.TaskContinuationOptions)" withNumArgs:2, [p1 monoValue], DB_VALUE(p2)];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`2<System.Threading.Tasks.Task, TResult>, System.Threading.CancellationToken, System.Threading.Tasks.TaskContinuationOptions, System.Threading.Tasks.TaskScheduler
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`2<System.Threading.Tasks.Task, TResult>,System.Threading.CancellationToken,System.Threading.Tasks.TaskContinuationOptions,System.Threading.Tasks.TaskScheduler)" withNumArgs:4, [p1 monoValue], [p2 monoValue], DB_VALUE(p3), [p4 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`3<System.Threading.Tasks.Task, System.Object, TResult>, System.Object
    - (TaskA1 *)continueWith_withContinuationFunction:(FuncA3 *)p1 state:(System_Object *)p2
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`3<System.Threading.Tasks.Task, System.Object, TResult>,object)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`3<System.Threading.Tasks.Task, System.Object, TResult>, System.Object, System.Threading.CancellationToken
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`3<System.Threading.Tasks.Task, System.Object, TResult>,object,System.Threading.CancellationToken)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`3<System.Threading.Tasks.Task, System.Object, TResult>, System.Object, System.Threading.Tasks.TaskScheduler
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`3<System.Threading.Tasks.Task, System.Object, TResult>,object,System.Threading.Tasks.TaskScheduler)" withNumArgs:3, [p1 monoValue], [p2 monoValue], [p3 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`3<System.Threading.Tasks.Task, System.Object, TResult>, System.Object, System.Threading.Tasks.TaskContinuationOptions
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`3<System.Threading.Tasks.Task, System.Object, TResult>,object,System.Threading.Tasks.TaskContinuationOptions)" withNumArgs:3, [p1 monoValue], [p2 monoValue], DB_VALUE(p3)];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : ContinueWith
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`3<System.Threading.Tasks.Task, System.Object, TResult>, System.Object, System.Threading.CancellationToken, System.Threading.Tasks.TaskContinuationOptions, System.Threading.Tasks.TaskScheduler
    ...
    {
		MonoObject *monoObject = [self invokeMonoMethod:"ContinueWith(Func`3<System.Threading.Tasks.Task, System.Object, TResult>,object,System.Threading.CancellationToken,System.Threading.Tasks.TaskContinuationOptions,System.Threading.Tasks.TaskScheduler)" withNumArgs:5, [p1 monoValue], [p2 monoValue], [p3 monoValue], DB_VALUE(p4), [p5 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
    ...
    + (TaskA1 *)fromResult_withResult:(DBManagedObject *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"FromResult(Dubrovnik.Generic.Parameter)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
    ...
    + (TaskA1 *)run_withFunctionFuncA1_TResult:(FuncA1 *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"Run(Func`1<TResult>)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
    ...
    + (TaskA1 *)run_withFunctionFuncA1_TResult:(FuncA1 *)p1 cancellationTokenSTCancellationToken:(System_Threading_CancellationToken *)p2
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"Run(Func`1<TResult>,System.Threading.CancellationToken)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
	...
	// Managed method name : Run
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`1<Task`1<TResult>>
    + (TaskA1 *)run_withFunctionFuncA1_TaskA1_TResult:(FuncA1 *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"Run(Func`1<Task`1<TResult>>)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }

	// Managed method name : Run
	// Managed return type : Task`1<TResult>
	// Managed param types : Func`1<Task`1<TResult>>, System.Threading.CancellationToken
    + (TaskA1 *)run_withFunctionFuncA1_TaskA1_TResult:(FuncA1 *)p1 cancellationTokenSTCancellationToken:(System_Threading_CancellationToken *)p2
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"Run(Func`1<Task`1<TResult>>,System.Threading.CancellationToken)" withNumArgs:2, [p1 monoValue], [p2 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
    ...
    + (System_Threading_Tasks_Task *)whenAll_withTasksSCGITTTask:(System_Collections_Generic_IEnumerableA1 *)p1
    {
	...
	// Managed method name : WhenAll
	// Managed return type : Task`1<TResult[]>
	// Managed param types : IEnumerable`1<Task`1<TResult>>
    + (TaskA1 *)whenAll_withTasksIEnumerableA1_TaskA1_TResult:(IEnumerableA1 *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"WhenAll(IEnumerable`1<Task`1<TResult>>)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
    ...
    + (TaskA1 *)whenAll_withTasksSArray:(DBSystem_Array *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"WhenAll(System.Array[])" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
	...
	// Managed return type : System.Threading.Tasks.Task`1<System.Threading.Tasks.Task>
	// Managed param types : System.Collections.Generic.IEnumerable`1<System.Threading.Tasks.Task>
    + (System_Threading_Tasks_TaskA1 *)whenAny_withTasksSCGITTTask:(System_Collections_Generic_IEnumerableA1 *)p1
    {
	...
	// Managed method name : WhenAny
	// Managed return type : Task`1<Task`1<TResult>>
	// Managed param types : Task`1[]
    + (TaskA1 *)whenAny_withTasksSArray:(DBSystem_Array *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"WhenAny(System.Array[])" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
	...
	// Managed return type : Task`1<Task`1<TResult>>
	// Managed param types : IEnumerable`1<Task`1<TResult>>
    + (TaskA1 *)whenAny_withTasksIEnumerableA1_TaskA1_TResult:(IEnumerableA1 *)p1
    {
		MonoObject *monoObject = [self invokeMonoClassMethod:"WhenAny(IEnumerable`1<Task`1<TResult>>)" withNumArgs:1, [p1 monoValue]];
		return [TaskA1 objectWithMonoObject:monoObject];
    }
