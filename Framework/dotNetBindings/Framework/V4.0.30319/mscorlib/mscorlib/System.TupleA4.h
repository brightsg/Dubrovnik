//++Dubrovnik.CodeGenerator System.TupleA4.h
//
// Managed class : Tuple`4<T1, T2, T3, T4>
//
@interface System_TupleA4 : System_Object
...
#pragma mark Constructors
    ...
    + (System_TupleA4 *)new_withItem1:(DBManagedObject *)p1 item2:(DBManagedObject *)p2 item3:(DBManagedObject *)p3 item4:(DBManagedObject *)p4;
