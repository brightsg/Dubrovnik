//++Dubrovnik.CodeGenerator System.TupleA7.h
//
// Managed class : Tuple`7
//
@interface System_TupleA7 : System_Object
...
#pragma mark Properties
    ...
    @property (nonatomic, strong, readonly) DBManagedObject * item6;

	// Managed property name : Item7
	// Managed property type : <T7>
    @property (nonatomic, strong, readonly) DBManagedObject * item7;
