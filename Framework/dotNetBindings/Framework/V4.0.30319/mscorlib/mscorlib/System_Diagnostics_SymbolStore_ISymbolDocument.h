//++Dubrovnik.CodeGenerator System_Diagnostics_SymbolStore_ISymbolDocument.h
//
...
@interface System_Diagnostics_SymbolStore_ISymbolDocument : System_Object <System_Diagnostics_SymbolStore_ISymbolDocument>
