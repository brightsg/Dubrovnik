//++Dubrovnik.CodeGenerator System_Diagnostics_SymbolStore_ISymbolMethod.h
//
...
@interface System_Diagnostics_SymbolStore_ISymbolMethod : System_Object <System_Diagnostics_SymbolStore_ISymbolMethod>
