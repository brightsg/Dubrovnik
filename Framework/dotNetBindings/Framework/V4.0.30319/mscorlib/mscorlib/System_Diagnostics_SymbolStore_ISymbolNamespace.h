//++Dubrovnik.CodeGenerator System_Diagnostics_SymbolStore_ISymbolNamespace.h
//
...
@interface System_Diagnostics_SymbolStore_ISymbolNamespace : System_Object <System_Diagnostics_SymbolStore_ISymbolNamespace>
