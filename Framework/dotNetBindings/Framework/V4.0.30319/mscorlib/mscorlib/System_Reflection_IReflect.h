//++Dubrovnik.CodeGenerator System_Reflection_IReflect.h
//
// Managed interface : IReflect
//
@protocol System_Reflection_IReflect <NSObject>
...
@interface System_Reflection_IReflect : System_Object <System_Reflection_IReflect>
