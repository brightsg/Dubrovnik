...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"EnumObjectParam(System.Runtime.InteropServices.ComTypes.IEnumString&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetBindOptions(System.Runtime.InteropServices.ComTypes.BIND_OPTS&)" withNumArgs:1, &refPtr1];
;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"GetRunningObjectTable(System.Runtime.InteropServices.ComTypes.IRunningObjectTable&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"SetBindOptions(System.Runtime.InteropServices.ComTypes.BIND_OPTS&)" withNumArgs:1, &refPtr1];
;
    }
