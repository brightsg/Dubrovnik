//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IConnectionPoint.h
//
...
@interface System_Runtime_InteropServices_ComTypes_IConnectionPoint : System_Object <System_Runtime_InteropServices_ComTypes_IConnectionPoint>
