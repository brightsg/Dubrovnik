...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"EnumConnections(System.Runtime.InteropServices.ComTypes.IEnumConnections&)" withNumArgs:1, &refPtr1];
;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"GetConnectionPointContainer(System.Runtime.InteropServices.ComTypes.IConnectionPointContainer&)" withNumArgs:1, &refPtr1];
;
    }
