//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IEnumConnections.h
//
...
@interface System_Runtime_InteropServices_ComTypes_IEnumConnections : System_Object <System_Runtime_InteropServices_ComTypes_IEnumConnections>
