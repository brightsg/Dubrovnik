//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IEnumString.h
//
...
@interface System_Runtime_InteropServices_ComTypes_IEnumString : System_Object <System_Runtime_InteropServices_ComTypes_IEnumString>
