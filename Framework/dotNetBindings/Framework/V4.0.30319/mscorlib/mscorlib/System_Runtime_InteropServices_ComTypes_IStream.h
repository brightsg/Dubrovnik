//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_IStream.h
//
...
@interface System_Runtime_InteropServices_ComTypes_IStream : System_Object <System_Runtime_InteropServices_ComTypes_IStream>
