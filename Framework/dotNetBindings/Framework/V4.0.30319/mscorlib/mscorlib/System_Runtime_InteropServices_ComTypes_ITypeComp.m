...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"Bind(string,int,int16,System.Runtime.InteropServices.ComTypes.ITypeInfo&,System.Runtime.InteropServices.ComTypes.DESCKIND&,System.Runtime.InteropServices.ComTypes.BINDPTR&)" withNumArgs:6, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3), &refPtr4, &refPtr5, &refPtr6];
;
    }
    ...
    {
		[self invokeMonoMethod:"BindType(string,int,System.Runtime.InteropServices.ComTypes.ITypeInfo&,System.Runtime.InteropServices.ComTypes.ITypeComp&)" withNumArgs:4, [p1 monoValue], DB_VALUE(p2), &refPtr3, &refPtr4];
;
    }
