//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ComTypes_ITypeInfo.h
//
...
@interface System_Runtime_InteropServices_ComTypes_ITypeInfo : System_Object <System_Runtime_InteropServices_ComTypes_ITypeInfo>
