...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"CreateInstance(object,System.Guid&,object&)" withNumArgs:3, [p1 monoValue], &refPtr2, &refPtr3];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetContainingTypeLib(System.Runtime.InteropServices.ComTypes.ITypeLib&,int&)" withNumArgs:2, &refPtr1, p2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetCustData(System.Guid&,object&)" withNumArgs:2, &refPtr1, &refPtr2];
;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"GetDocumentation2(int,string&,int&,string&)" withNumArgs:4, DB_VALUE(p1), &refPtr2, p3, &refPtr4];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetFuncCustData(int,System.Guid&,object&)" withNumArgs:3, DB_VALUE(p1), &refPtr2, &refPtr3];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetImplTypeCustData(int,System.Guid&,object&)" withNumArgs:3, DB_VALUE(p1), &refPtr2, &refPtr3];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetImplTypeFlags(int,System.Runtime.InteropServices.ComTypes.IMPLTYPEFLAGS&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetMops(int,string&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetParamCustData(int,int,System.Guid&,object&)" withNumArgs:4, DB_VALUE(p1), DB_VALUE(p2), &refPtr3, &refPtr4];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetRefTypeInfo(int,System.Runtime.InteropServices.ComTypes.ITypeInfo&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"GetTypeKind(System.Runtime.InteropServices.ComTypes.TYPEKIND&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetVarCustData(int,System.Guid&,object&)" withNumArgs:3, DB_VALUE(p1), &refPtr2, &refPtr3];
;
    }
    ...
    {
		[self invokeMonoMethod:"Invoke(object,int,int16,System.Runtime.InteropServices.ComTypes.DISPPARAMS&,intptr,intptr,int&)" withNumArgs:7, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3), &refPtr4, DB_VALUE(p5), DB_VALUE(p6), p7];
;
    }
