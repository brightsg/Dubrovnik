//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_ICustomMarshaler.h
//
...
@interface System_Runtime_InteropServices_ICustomMarshaler : System_Object <System_Runtime_InteropServices_ICustomMarshaler>
