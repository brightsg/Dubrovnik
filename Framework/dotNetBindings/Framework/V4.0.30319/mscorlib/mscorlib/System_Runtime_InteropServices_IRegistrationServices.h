//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_IRegistrationServices.h
//
...
@interface System_Runtime_InteropServices_IRegistrationServices : System_Object <System_Runtime_InteropServices_IRegistrationServices>
