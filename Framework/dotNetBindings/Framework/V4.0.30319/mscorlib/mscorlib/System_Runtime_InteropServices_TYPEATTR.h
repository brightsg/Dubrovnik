//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_TYPEATTR.h
//
// Managed struct : TYPEATTR
//
@interface System_Runtime_InteropServices_TYPEATTR : DBManagedObject
...
#pragma mark Fields
    ...
    @property (nonatomic, strong) System_Runtime_InteropServices_IDLDESC * idldescType;
    ...
    @property (nonatomic, strong) System_Runtime_InteropServices_TYPEDESC * tdescAlias;

	// Managed field name : typekind
	// Managed field type : System.Runtime.InteropServices.TYPEKIND
    @property (nonatomic) System_Runtime_InteropServices_TYPEKIND typekind;
    ...
    @property (nonatomic) System_Runtime_InteropServices_TYPEFLAGS wTypeFlags;
@end
