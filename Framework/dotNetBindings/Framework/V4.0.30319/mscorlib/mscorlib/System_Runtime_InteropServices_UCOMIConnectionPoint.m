...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"EnumConnections(System.Runtime.InteropServices.UCOMIEnumConnections&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetConnectionInterface(System.Guid&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetConnectionPointContainer(System.Runtime.InteropServices.UCOMIConnectionPointContainer&)" withNumArgs:1, &refPtr1];
;
    }
