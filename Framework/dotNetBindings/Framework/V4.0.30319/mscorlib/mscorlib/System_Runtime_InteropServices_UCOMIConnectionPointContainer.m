...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"EnumConnectionPoints(System.Runtime.InteropServices.UCOMIEnumConnectionPoints&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"FindConnectionPoint(System.Guid&,System.Runtime.InteropServices.UCOMIConnectionPoint&)" withNumArgs:2, &refPtr1, &refPtr2];
;
    }
