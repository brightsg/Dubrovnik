//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_UCOMIEnumString.h
//
...
@interface System_Runtime_InteropServices_UCOMIEnumString : System_Object <System_Runtime_InteropServices_UCOMIEnumString>
