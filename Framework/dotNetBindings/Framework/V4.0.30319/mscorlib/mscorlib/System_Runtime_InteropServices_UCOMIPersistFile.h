//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_UCOMIPersistFile.h
//
...
@interface System_Runtime_InteropServices_UCOMIPersistFile : System_Object <System_Runtime_InteropServices_UCOMIPersistFile>
