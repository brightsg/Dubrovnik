//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_UCOMIStream.h
//
...
@interface System_Runtime_InteropServices_UCOMIStream : System_Object <System_Runtime_InteropServices_UCOMIStream>
