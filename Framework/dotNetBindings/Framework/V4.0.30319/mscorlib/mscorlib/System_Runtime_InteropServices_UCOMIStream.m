...
#pragma mark Methods
    ...
    {
		[self invokeMonoMethod:"Clone(System.Runtime.InteropServices.UCOMIStream&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"Stat(System.Runtime.InteropServices.STATSTG&,int)" withNumArgs:2, &refPtr1, DB_VALUE(p2)];
;
    }
