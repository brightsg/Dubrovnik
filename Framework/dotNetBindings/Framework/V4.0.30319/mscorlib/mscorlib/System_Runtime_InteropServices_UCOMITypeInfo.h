//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_UCOMITypeInfo.h
//
...
@interface System_Runtime_InteropServices_UCOMITypeInfo : System_Object <System_Runtime_InteropServices_UCOMITypeInfo>
