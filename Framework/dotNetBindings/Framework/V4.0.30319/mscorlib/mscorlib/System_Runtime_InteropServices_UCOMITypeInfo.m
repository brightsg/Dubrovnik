...
;
    ...
    {
		[self invokeMonoMethod:"GetContainingTypeLib(System.Runtime.InteropServices.UCOMITypeLib&,int&)" withNumArgs:2, &refPtr1, p2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetDllEntry(int,System.Runtime.InteropServices.INVOKEKIND,string&,string&,int16&)" withNumArgs:5, DB_VALUE(p1), DB_VALUE(p2), &refPtr3, &refPtr4, p5];
;
    }
...
;
    ...
    {
		[self invokeMonoMethod:"GetRefTypeInfo(int,System.Runtime.InteropServices.UCOMITypeInfo&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetTypeComp(System.Runtime.InteropServices.UCOMITypeComp&)" withNumArgs:1, &refPtr1];
;
    }
    ...
    {
		[self invokeMonoMethod:"Invoke(object,int,int16,System.Runtime.InteropServices.DISPPARAMS&,object&,System.Runtime.InteropServices.EXCEPINFO&,int&)" withNumArgs:7, [p1 monoValue], DB_VALUE(p2), DB_VALUE(p3), &refPtr4, &refPtr5, &refPtr6, p7];
;
    }
