//++Dubrovnik.CodeGenerator System_Runtime_InteropServices_UCOMITypeLib.h
//
...
@interface System_Runtime_InteropServices_UCOMITypeLib : System_Object <System_Runtime_InteropServices_UCOMITypeLib>
