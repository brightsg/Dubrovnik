...
;
    ...
    {
		[self invokeMonoMethod:"GetTypeInfo(int,System.Runtime.InteropServices.UCOMITypeInfo&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetTypeInfoOfGuid(System.Guid&,System.Runtime.InteropServices.UCOMITypeInfo&)" withNumArgs:2, &refPtr1, &refPtr2];
;
    }
    ...
    {
		[self invokeMonoMethod:"GetTypeInfoType(int,System.Runtime.InteropServices.TYPEKIND&)" withNumArgs:2, DB_VALUE(p1), &refPtr2];
;
    }
