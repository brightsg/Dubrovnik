//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__Activator.h
//
...
@interface System_Runtime_InteropServices__Activator : System_Object <System_Runtime_InteropServices__Activator>
