//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__AssemblyBuilder.h
//
...
@interface System_Runtime_InteropServices__AssemblyBuilder : System_Object <System_Runtime_InteropServices__AssemblyBuilder>
