//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__AssemblyName.h
//
...
@interface System_Runtime_InteropServices__AssemblyName : System_Object <System_Runtime_InteropServices__AssemblyName>
