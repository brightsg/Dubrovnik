//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ConstructorBuilder.h
//
...
@interface System_Runtime_InteropServices__ConstructorBuilder : System_Object <System_Runtime_InteropServices__ConstructorBuilder>
