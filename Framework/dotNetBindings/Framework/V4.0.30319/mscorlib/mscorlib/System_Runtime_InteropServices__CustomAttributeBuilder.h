//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__CustomAttributeBuilder.h
//
...
@interface System_Runtime_InteropServices__CustomAttributeBuilder : System_Object <System_Runtime_InteropServices__CustomAttributeBuilder>
