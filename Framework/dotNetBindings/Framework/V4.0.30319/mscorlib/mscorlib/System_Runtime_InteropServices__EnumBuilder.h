//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__EnumBuilder.h
//
...
@interface System_Runtime_InteropServices__EnumBuilder : System_Object <System_Runtime_InteropServices__EnumBuilder>
