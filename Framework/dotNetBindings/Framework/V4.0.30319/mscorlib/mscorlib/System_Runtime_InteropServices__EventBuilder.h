//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__EventBuilder.h
//
...
@interface System_Runtime_InteropServices__EventBuilder : System_Object <System_Runtime_InteropServices__EventBuilder>
