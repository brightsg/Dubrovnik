//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__FieldBuilder.h
//
...
@interface System_Runtime_InteropServices__FieldBuilder : System_Object <System_Runtime_InteropServices__FieldBuilder>
