//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__FieldInfo.h
//
...
@interface System_Runtime_InteropServices__FieldInfo : System_Object <System_Runtime_InteropServices__FieldInfo>
