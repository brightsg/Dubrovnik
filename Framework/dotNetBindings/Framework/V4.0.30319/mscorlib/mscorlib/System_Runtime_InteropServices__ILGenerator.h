//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ILGenerator.h
//
...
@interface System_Runtime_InteropServices__ILGenerator : System_Object <System_Runtime_InteropServices__ILGenerator>
