//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__LocalBuilder.h
//
...
@interface System_Runtime_InteropServices__LocalBuilder : System_Object <System_Runtime_InteropServices__LocalBuilder>
