//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__MethodBase.h
//
...
@interface System_Runtime_InteropServices__MethodBase : System_Object <System_Runtime_InteropServices__MethodBase>
