//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__MethodBuilder.h
//
...
@interface System_Runtime_InteropServices__MethodBuilder : System_Object <System_Runtime_InteropServices__MethodBuilder>
