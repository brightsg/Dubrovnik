//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__MethodRental.h
//
...
@interface System_Runtime_InteropServices__MethodRental : System_Object <System_Runtime_InteropServices__MethodRental>
