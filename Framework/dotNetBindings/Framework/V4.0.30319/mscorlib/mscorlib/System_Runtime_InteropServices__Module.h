//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__Module.h
//
...
@interface System_Runtime_InteropServices__Module : System_Object <System_Runtime_InteropServices__Module>
