//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ModuleBuilder.h
//
...
@interface System_Runtime_InteropServices__ModuleBuilder : System_Object <System_Runtime_InteropServices__ModuleBuilder>
