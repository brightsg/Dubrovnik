//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ParameterBuilder.h
//
...
@interface System_Runtime_InteropServices__ParameterBuilder : System_Object <System_Runtime_InteropServices__ParameterBuilder>
