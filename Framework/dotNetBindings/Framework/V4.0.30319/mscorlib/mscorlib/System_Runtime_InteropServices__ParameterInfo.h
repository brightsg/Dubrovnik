//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__ParameterInfo.h
//
...
@interface System_Runtime_InteropServices__ParameterInfo : System_Object <System_Runtime_InteropServices__ParameterInfo>
