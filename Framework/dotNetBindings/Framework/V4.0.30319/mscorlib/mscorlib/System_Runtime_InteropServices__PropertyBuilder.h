//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__PropertyBuilder.h
//
...
@interface System_Runtime_InteropServices__PropertyBuilder : System_Object <System_Runtime_InteropServices__PropertyBuilder>
