//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__Thread.h
//
...
@interface System_Runtime_InteropServices__Thread : System_Object <System_Runtime_InteropServices__Thread>
