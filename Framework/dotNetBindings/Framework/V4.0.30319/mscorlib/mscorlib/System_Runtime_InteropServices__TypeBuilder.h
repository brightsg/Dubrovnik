//++Dubrovnik.CodeGenerator System_Runtime_InteropServices__TypeBuilder.h
//
...
@interface System_Runtime_InteropServices__TypeBuilder : System_Object <System_Runtime_InteropServices__TypeBuilder>
