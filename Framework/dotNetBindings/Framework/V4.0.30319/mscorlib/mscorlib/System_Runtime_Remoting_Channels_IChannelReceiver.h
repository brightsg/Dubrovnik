...
//
@protocol System_Runtime_Remoting_Channels_IChannelReceiver <NSObject>
...
@interface System_Runtime_Remoting_Channels_IChannelReceiver : System_Object <System_Runtime_Remoting_Channels_IChannelReceiver>
