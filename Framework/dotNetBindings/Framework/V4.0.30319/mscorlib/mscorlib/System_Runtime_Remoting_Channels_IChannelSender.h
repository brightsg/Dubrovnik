...
//
@protocol System_Runtime_Remoting_Channels_IChannelSender <NSObject>
...
@interface System_Runtime_Remoting_Channels_IChannelSender : System_Object <System_Runtime_Remoting_Channels_IChannelSender>
