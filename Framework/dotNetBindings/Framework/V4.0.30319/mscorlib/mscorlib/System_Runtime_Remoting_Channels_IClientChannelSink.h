...
//
@protocol System_Runtime_Remoting_Channels_IClientChannelSink <NSObject>
...
@interface System_Runtime_Remoting_Channels_IClientChannelSink : System_Object <System_Runtime_Remoting_Channels_IClientChannelSink>
