//++Dubrovnik.CodeGenerator System_Runtime_Remoting_IEnvoyInfo.h
//
...
@interface System_Runtime_Remoting_IEnvoyInfo : System_Object <System_Runtime_Remoting_IEnvoyInfo>
