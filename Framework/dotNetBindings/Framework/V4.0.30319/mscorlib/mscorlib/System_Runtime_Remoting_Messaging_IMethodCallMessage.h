...
//
@protocol System_Runtime_Remoting_Messaging_IMethodCallMessage <NSObject>
...
@interface System_Runtime_Remoting_Messaging_IMethodCallMessage : System_Object <System_Runtime_Remoting_Messaging_IMethodCallMessage>
