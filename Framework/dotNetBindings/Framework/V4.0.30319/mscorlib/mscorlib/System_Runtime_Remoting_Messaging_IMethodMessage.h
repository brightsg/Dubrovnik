...
//
@protocol System_Runtime_Remoting_Messaging_IMethodMessage <NSObject>
...
@interface System_Runtime_Remoting_Messaging_IMethodMessage : System_Object <System_Runtime_Remoting_Messaging_IMethodMessage>
