...
//
@protocol System_Runtime_Remoting_Messaging_IMethodReturnMessage <NSObject>
...
@interface System_Runtime_Remoting_Messaging_IMethodReturnMessage : System_Object <System_Runtime_Remoting_Messaging_IMethodReturnMessage>
