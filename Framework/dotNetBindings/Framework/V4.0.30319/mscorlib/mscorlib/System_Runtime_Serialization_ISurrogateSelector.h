//++Dubrovnik.CodeGenerator System_Runtime_Serialization_ISurrogateSelector.h
//
...
@interface System_Runtime_Serialization_ISurrogateSelector : System_Object <System_Runtime_Serialization_ISurrogateSelector>
