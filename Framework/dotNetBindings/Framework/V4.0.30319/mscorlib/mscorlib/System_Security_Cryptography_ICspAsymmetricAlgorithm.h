//++Dubrovnik.CodeGenerator System_Security_Cryptography_ICspAsymmetricAlgorithm.h
//
...
@interface System_Security_Cryptography_ICspAsymmetricAlgorithm : System_Object <System_Security_Cryptography_ICspAsymmetricAlgorithm>
