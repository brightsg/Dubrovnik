#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_Security_Cryptography_RijndaelManagedTransform.m
//
...
@implementation System_Security_Cryptography_RijndaelManagedTransform
...
#pragma mark Setup
	...
	{
		return "System.Security.Cryptography.RijndaelManagedTransform";
	}
	// obligatory override
...
#pragma mark Properties
    ...
    @synthesize blockSizeValue = _blockSizeValue;
    - (int32_t)blockSizeValue
    {
		MonoObject *monoObject = [self getMonoProperty:"BlockSizeValue"];
		_blockSizeValue = DB_UNBOX_INT32(monoObject);
