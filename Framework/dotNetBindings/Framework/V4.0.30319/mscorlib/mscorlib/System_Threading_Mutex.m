...
#pragma mark Methods
    ...
    + (BOOL)tryOpenExisting_withName:(NSString *)p1 resultRef:(System_Threading_Mutex **)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryOpenExisting(string,System.Threading.Mutex&)" withNumArgs:2, [p1 monoValue], &refPtr2];
    ...
    + (BOOL)tryOpenExisting_withName:(NSString *)p1 rights:(System_Security_AccessControl_MutexRights)p2 resultRef:(System_Threading_Mutex **)p3
    {
		...
		MonoObject *monoObject = [self invokeMonoClassMethod:"TryOpenExisting(string,System.Security.AccessControl.MutexRights,System.Threading.Mutex&)" withNumArgs:3, [p1 monoValue], DB_VALUE(p2), &refPtr3];
