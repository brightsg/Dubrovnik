//++Dubrovnik.CodeGenerator System_Data_Entity_Core_Common_CommandTrees_DbGroupByExpression.h
//
// Managed class : DbGroupByExpression
//
@interface System_Data_Entity_Core_Common_CommandTrees_DbGroupByExpression : System_Data_Entity_Core_Common_CommandTrees_DbExpression
...
#pragma mark Properties
	...
	// Managed property name : Aggregates
	// Managed property type : System.Collections.Generic.IList`1<System.Data.Entity.Core.Common.CommandTrees.DbAggregate>
    @property (nonatomic, strong, readonly) System_Collections_Generic_IListA1 * aggregates;

	// Managed property name : Input
	// Managed property type : System.Data.Entity.Core.Common.CommandTrees.DbGroupExpressionBinding
    @property (nonatomic, strong, readonly) System_Data_Entity_Core_Common_CommandTrees_DbGroupExpressionBinding * input;
