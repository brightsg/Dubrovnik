//++Dubrovnik.CodeGenerator System_Data_Entity_Core_Common_CommandTrees_DbJoinExpression.h
//
// Managed class : DbJoinExpression
//
@interface System_Data_Entity_Core_Common_CommandTrees_DbJoinExpression : System_Data_Entity_Core_Common_CommandTrees_DbExpression
...
#pragma mark Properties
	...
	// Managed property name : JoinCondition
	// Managed property type : System.Data.Entity.Core.Common.CommandTrees.DbExpression
    @property (nonatomic, strong, readonly) System_Data_Entity_Core_Common_CommandTrees_DbExpression * joinCondition;

	// Managed property name : Left
	// Managed property type : System.Data.Entity.Core.Common.CommandTrees.DbExpressionBinding
    @property (nonatomic, strong, readonly) System_Data_Entity_Core_Common_CommandTrees_DbExpressionBinding * left;

	// Managed property name : Right
	// Managed property type : System.Data.Entity.Core.Common.CommandTrees.DbExpressionBinding
    @property (nonatomic, strong, readonly) System_Data_Entity_Core_Common_CommandTrees_DbExpressionBinding * right;
