...
#pragma mark Methods
    ...
    - (System_Data_Entity_Infrastructure_Interception_DbCommandInterceptionContext *)withObjectContext_withContext:(DBSystem_Data_Entity_Core_Objects_ObjectContext *)p1;
@end
