...
- (NSArray *)allKeys
{
    ...
    NSArray *keys = [[DBLinq toList:(System_Object <System_Collections_Generic_IEnumerableA1_> *)object] array];
...
- (NSArray *)allValues
{
    ...
    NSArray *values = [[DBLinq toList:(System_Object <System_Collections_Generic_IEnumerableA1_> *)object genericTypeIndex:1] array];
