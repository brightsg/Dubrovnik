...
{
	DBManagedMethod *method = [DBGenericTypeHelper.sharedHelper methodWithMonoMethodNamed:"System.Linq.IOrderedEnumerable`1<System.Linq.IOrderedEnumerable`1+TElement>.CreateOrderedEnumerable(System.Func`2<System.Linq.IOrderedEnumerable`1/TElement, System.Linq.IOrderedEnumerable`1/TKey>,System.Collections.Generic.IComparer`1<System.Linq.IOrderedEnumerable`1/TKey>,bool)" typeParameters:typeParameter];
	MonoObject *monoObject = [self invokeMethod:method withNumArgs:3, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject], DB_VALUE(p3)];
