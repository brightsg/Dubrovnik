//++Dubrovnik.CodeGenerator System_BadImageFormatException.m
//
...
@implementation System_BadImageFormatException
...
#pragma mark Constructors
    ...
    + (System_BadImageFormatException *)new_withMessage:(NSString *)p1
    {
		...
		System_BadImageFormatException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_BadImageFormatException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_BadImageFormatException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_BadImageFormatException *)new_withMessage:(NSString *)p1 fileName:(NSString *)p2
    {
		...
		System_BadImageFormatException * object = [[self alloc] initWithSignature:"string,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_BadImageFormatException *)new_withMessage:(NSString *)p1 fileName:(NSString *)p2 inner:(System_Exception *)p3
    {
		...
		System_BadImageFormatException * object = [[self alloc] initWithSignature:"string,string,System.Exception" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
