...
- (System_Object *)addOrUpdate_withKey:(System_Object *)p1 addValueFactory:(System_FuncA3 *)p2 updateValueFactory:(System_FuncA4 *)p3 factoryArgument:(System_Object *)p4 typeParameter:(id)typeParameter
{
	...
	MonoObject *monoObject = [self invokeMethod:managedMethod withNumArgs:4, [self monoRTInvokeArg:p1 typeParameterIndex:0], [p2 monoRTInvokeObject], [p3 monoRTInvokeObject], [self monoRTInvokeArg:p4 typeParameterIndex:0]];
	return [System_Object bestObjectWithMonoObject:monoObject];
}
...
- (System_Object *)getOrAdd_withKey:(System_Object *)p1 valueFactory:(System_FuncA3 *)p2 factoryArgument:(System_Object *)p3 typeParameter:(id)typeParameter
{
	...
	MonoObject *monoObject = [self invokeMethod:managedMethod withNumArgs:3, [self monoRTInvokeArg:p1 typeParameterIndex:0], [p2 monoRTInvokeObject], [self monoRTInvokeArg:p3 typeParameterIndex:0]];
	return [System_Object bestObjectWithMonoObject:monoObject];
}
