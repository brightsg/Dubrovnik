...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Create(System.Collections.Generic.IEnumerable`1<System.Collections.Concurrent.Partitioner/TSource>)" withNumArgs:1, [p1 monoRTInvokeObject]];
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Create(System.Collections.Generic.IEnumerable`1<System.Collections.Concurrent.Partitioner/TSource>,System.Collections.Concurrent.EnumerablePartitionerOptions)" withNumArgs:2, [p1 monoRTInvokeObject], DB_VALUE(p2)];
	return [System_Collections_Concurrent_OrderablePartitionerA1 bestObjectWithMonoObject:monoObject];
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Create(System.Collections.Generic.IList`1<System.Collections.Concurrent.Partitioner/TSource>,bool)" withNumArgs:2, [p1 monoRTInvokeObject], DB_VALUE(p2)];
	return [System_Collections_Concurrent_OrderablePartitionerA1 bestObjectWithMonoObject:monoObject];
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Create(TSource[],bool)" withNumArgs:2, [p1 monoRTInvokeObject], DB_VALUE(p2)];
	return [System_Collections_Concurrent_OrderablePartitionerA1 bestObjectWithMonoObject:monoObject];
}
