//++Dubrovnik.CodeGenerator System_IO_EndOfStreamException.m
//
...
#pragma mark Constructors
    ...
    + (System_IO_EndOfStreamException *)new_withMessage:(NSString *)p1
    {
		...
		System_IO_EndOfStreamException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_IO_EndOfStreamException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_IO_EndOfStreamException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
