...
#pragma mark Constructors
    ...
    + (System_IO_FileNotFoundException *)new_withMessage:(NSString *)p1
    {
		...
		System_IO_FileNotFoundException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_IO_FileNotFoundException *)new_withMessage:(NSString *)p1 innerException:(System_Exception *)p2
    {
		...
		System_IO_FileNotFoundException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_IO_FileNotFoundException *)new_withMessage:(NSString *)p1 fileName:(NSString *)p2
    {
		...
		System_IO_FileNotFoundException * object = [[self alloc] initWithSignature:"string,string" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
    ...
    + (System_IO_FileNotFoundException *)new_withMessage:(NSString *)p1 fileName:(NSString *)p2 innerException:(System_Exception *)p3
    {
		...
		System_IO_FileNotFoundException * object = [[self alloc] initWithSignature:"string,string,System.Exception" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
