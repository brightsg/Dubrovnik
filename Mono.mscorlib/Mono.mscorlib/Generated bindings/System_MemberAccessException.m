//++Dubrovnik.CodeGenerator System_MemberAccessException.m
//
...
@implementation System_MemberAccessException
...
#pragma mark Constructors
    ...
    + (System_MemberAccessException *)new_withMessage:(NSString *)p1
    {
		...
		System_MemberAccessException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_MemberAccessException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_MemberAccessException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
