//++Dubrovnik.CodeGenerator System_MulticastNotSupportedException.m
//
...
#pragma mark Constructors
    ...
    + (System_MulticastNotSupportedException *)new_withMessage:(NSString *)p1
    {
		...
		System_MulticastNotSupportedException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_MulticastNotSupportedException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_MulticastNotSupportedException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
