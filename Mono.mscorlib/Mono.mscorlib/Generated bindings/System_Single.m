...
{
	MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(single)" withNumArgs:1, &p1];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"Equals(single)" withNumArgs:1, &p1];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"IsNaN(single)" withNumArgs:1, &p1];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_GreaterThan_withLeft:(float)p1 right:(float)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_GreaterThan(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_GreaterThanOrEqual_withLeft:(float)p1 right:(float)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_GreaterThanOrEqual(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_Inequality_withLeft:(float)p1 right:(float)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_LessThan_withLeft:(float)p1 right:(float)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_LessThan(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_LessThanOrEqual_withLeft:(float)p1 right:(float)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_LessThanOrEqual(single,single)" withNumArgs:2, &p1, &p2];
	return DB_UNBOX_BOOLEAN(monoObject);
}
