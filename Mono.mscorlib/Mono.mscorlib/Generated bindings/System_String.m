...
{
	System_String * object = [[self alloc] initWithSignature:"char[]" withNumArgs:1, [p1 monoRTInvokeObject]];
	return object;
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Compare(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"CompareOrdinal(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	DBManagedMethod *method = [DBGenericTypeHelper.sharedHelper methodWithMonoMethodNamed:"Concat(System.Collections.Generic.IEnumerable`1<string/T>)" typeParameters:typeParameter];
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Concat(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}

+ (NSString *)concat_withStr0:(NSString *)p1 str1:(NSString *)p2 str2:(NSString *)p3
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Concat(string,string,string)" withNumArgs:3, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject], [p3 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}

+ (NSString *)concat_withStr0:(NSString *)p1 str1:(NSString *)p2 str2:(NSString *)p3 str3:(NSString *)p4
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Concat(string,string,string,string)" withNumArgs:4, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject], [p3 monoRTInvokeObject], [p4 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Copy(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"EndsWith(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"Equals(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Equals(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"IndexOfAny(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Intern(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}

+ (NSString *)isInterned_withStr:(NSString *)p1
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"IsInterned(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"IsNullOrEmpty(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)isNullOrWhiteSpace_withValue:(NSString *)p1
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"IsNullOrWhiteSpace(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (NSString *)join_withSeparator:(NSString *)p1 value:(System_Array *)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Join(string,string[])" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}

+ (NSString *)join_withSeparatorString:(NSString *)p1 valuesObjectArray:(System_Array *)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"Join(string,object[])" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	DBManagedMethod *method = [DBGenericTypeHelper.sharedHelper methodWithMonoMethodNamed:"Join(string,System.Collections.Generic.IEnumerable`1<string/T>)" typeParameters:typeParameter];
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"LastIndexOf(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"LastIndexOfAny(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_INT32(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_Equality(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}

+ (BOOL)op_Inequality_withA:(NSString *)p1 b:(NSString *)p2
{
	MonoObject *monoObject = [self invokeMonoClassMethod:"op_Inequality(string,string)" withNumArgs:2, [p1 monoRTInvokeObject], [p2 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"Split(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"StartsWith(string)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return DB_UNBOX_BOOLEAN(monoObject);
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"ToLower(System.Globalization.CultureInfo)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"ToUpper(System.Globalization.CultureInfo)" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"Trim(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
...
{
	MonoObject *monoObject = [self invokeMonoMethod:"TrimEnd(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}

- (NSString *)trimStart_withTrimChars:(System_Array *)p1
{
	MonoObject *monoObject = [self invokeMonoMethod:"TrimStart(char[])" withNumArgs:1, [p1 monoRTInvokeObject]];
	return [NSString stringWithMonoString:DB_STRING(monoObject)];
}
