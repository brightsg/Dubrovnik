//++Dubrovnik.CodeGenerator System_TypeLoadException.m
//
...
@implementation System_TypeLoadException
...
#pragma mark Constructors
    ...
    + (System_TypeLoadException *)new_withMessage:(NSString *)p1
    {
		...
		System_TypeLoadException * object = [[self alloc] initWithSignature:"string" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    + (System_TypeLoadException *)new_withMessage:(NSString *)p1 inner:(System_Exception *)p2
    {
		...
		System_TypeLoadException * object = [[self alloc] initWithSignature:"string,System.Exception" withNumArgs:2, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg]];
