#import "mscorlib.h"
//++Dubrovnik.CodeGenerator System_ValueTupleA3.m
//
...
@implementation System_ValueTupleA3
...
#pragma mark Constructors
    ...
    + (System_ValueTupleA3 *)new_withItem1:(System_Object *)p1 item2:(System_Object *)p2 item3:(System_Object *)p3
    {
		...
		System_ValueTupleA3 * object = [[self alloc] initWithSignature:"<_T_0>,<_T_1>,<_T_2>" withNumArgs:3, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)compareTo_withOther:(System_ValueTupleA3 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(System.ValueTuple`3<System.ValueTuple`3/T1, System.ValueTuple`3/T2, System.ValueTuple`3/T3>)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)equals_withOther:(System_ValueTupleA3 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.ValueTuple`3<System.ValueTuple`3/T1, System.ValueTuple`3/T2, System.ValueTuple`3/T3>)" withNumArgs:1, [p1 monoRTInvokeArg]];
