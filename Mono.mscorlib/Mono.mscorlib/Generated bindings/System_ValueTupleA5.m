//++Dubrovnik.CodeGenerator System_ValueTupleA5.m
//
...
@implementation System_ValueTupleA5
...
#pragma mark Constructors
    ...
    + (System_ValueTupleA5 *)new_withItem1:(System_Object *)p1 item2:(System_Object *)p2 item3:(System_Object *)p3 item4:(System_Object *)p4 item5:(System_Object *)p5
    {
		...
		System_ValueTupleA5 * object = [[self alloc] initWithSignature:"<_T_0>,<_T_1>,<_T_2>,<_T_3>,<_T_4>" withNumArgs:5, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg], [p5 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)compareTo_withOther:(System_ValueTupleA5 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(System.ValueTuple`5)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)equals_withOther:(System_ValueTupleA5 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.ValueTuple`5)" withNumArgs:1, [p1 monoRTInvokeArg]];
