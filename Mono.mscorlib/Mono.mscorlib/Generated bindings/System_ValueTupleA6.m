//++Dubrovnik.CodeGenerator System_ValueTupleA6.m
//
...
@implementation System_ValueTupleA6
...
#pragma mark Constructors
    ...
    + (System_ValueTupleA6 *)new_withItem1:(System_Object *)p1 item2:(System_Object *)p2 item3:(System_Object *)p3 item4:(System_Object *)p4 item5:(System_Object *)p5 item6:(System_Object *)p6
    {
		...
		System_ValueTupleA6 * object = [[self alloc] initWithSignature:"<_T_0>,<_T_1>,<_T_2>,<_T_3>,<_T_4>,<_T_5>" withNumArgs:6, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg], [p5 monoRTInvokeArg], [p6 monoRTInvokeArg]];
...
#pragma mark Methods
    ...
    - (int32_t)compareTo_withOther:(System_ValueTupleA6 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(System.ValueTuple`6)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)equals_withOther:(System_ValueTupleA6 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.ValueTuple`6)" withNumArgs:1, [p1 monoRTInvokeArg]];
