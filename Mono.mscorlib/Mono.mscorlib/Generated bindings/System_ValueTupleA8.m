//++Dubrovnik.CodeGenerator System_ValueTupleA8.m
//
...
@implementation System_ValueTupleA8
...
#pragma mark Constructors
    ...
    + (System_ValueTupleA8 *)new_withItem1:(System_Object *)p1 item2:(System_Object *)p2 item3:(System_Object *)p3 item4:(System_Object *)p4 item5:(System_Object *)p5 item6:(System_Object *)p6 item7:(System_Object *)p7 rest:(System_Object *)p8
    {
		...
		System_ValueTupleA8 * object = [[self alloc] initWithSignature:"<_T_0>,<_T_1>,<_T_2>,<_T_3>,<_T_4>,<_T_5>,<_T_6>,<_T_7>" withNumArgs:8, [p1 monoRTInvokeArg], [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg], [p5 monoRTInvokeArg], [p6 monoRTInvokeArg], [p7 monoRTInvokeArg], [p8 monoRTInvokeArg]];
...
#pragma mark Fields
    ...
    - (System_Object *)rest
    {
		MonoObject *monoObject = [self getMonoField:"Rest"];
		if ([self object:_rest isEqualToMonoObject:monoObject]) return _rest;					
		_rest = [System_Object bestObjectWithMonoObject:monoObject];

		return _rest;
	}
    - (void)setRest:(System_Object *)value
	{
		_rest = value;
		MonoObject *monoObject = [value monoRTInvokeArg];
		[self setMonoField:"Rest" valueObject:monoObject];          
	}
...
#pragma mark Methods
    ...
    - (int32_t)compareTo_withOther:(System_ValueTupleA8 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"CompareTo(System.ValueTuple`8)" withNumArgs:1, [p1 monoRTInvokeArg]];
    ...
    - (BOOL)equals_withOther:(System_ValueTupleA8 *)p1
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Equals(System.ValueTuple`8)" withNumArgs:1, [p1 monoRTInvokeArg]];
