//++Dubrovnik.CodeGenerator System_Collections_Generic_IComparerA1_Protocol.h
//
...
#ifdef  DEF_P_AND_M_System_Collections_Generic_IComparerA1
...
@protocol db_aux_System_Collections_Generic_IComparerA1 <NSObject>
