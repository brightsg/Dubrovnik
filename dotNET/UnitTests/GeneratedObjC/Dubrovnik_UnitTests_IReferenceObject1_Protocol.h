...
#ifdef  DEF_P_AND_M_Dubrovnik_UnitTests_IReferenceObject1
...
@protocol db_aux_Dubrovnik_UnitTests_IReferenceObject1 <NSObject, Dubrovnik_UnitTests_IReferenceObjectBase>
