...
#pragma mark Constructors
    ...
    + (Dubrovnik_UnitTests_ReferenceObject__FunctionDelegate2 *)new_withObject:(System_Object *)p1 method:(void *)p2
    {
		...
		Dubrovnik_UnitTests_ReferenceObject__FunctionDelegate2 * object = [[self alloc] initWithSignature:"object,intptr" withNumArgs:2, [p1 monoRTInvokeArg], &p2];
...
#pragma mark Methods
    ...
    - (id <System_IAsyncResult>)beginInvoke_withValue:(int32_t)p1 message:(NSString *)p2 callback:(System_AsyncCallback *)p3 object:(System_Object *)p4
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"BeginInvoke(int,string,System.AsyncCallback,object)" withNumArgs:4, &p1, [p2 monoRTInvokeArg], [p3 monoRTInvokeArg], [p4 monoRTInvokeArg]];
    ...
    - (int32_t)invoke_withValue:(int32_t)p1 message:(NSString *)p2
    {
		...
		MonoObject *monoObject = [self invokeMonoMethod:"Invoke(int,string)" withNumArgs:2, &p1, [p2 monoRTInvokeArg]];
