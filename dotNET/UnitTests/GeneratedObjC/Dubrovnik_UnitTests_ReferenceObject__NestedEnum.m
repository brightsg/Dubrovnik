...
static enumDubrovnik_UnitTests_ReferenceObject__NestedEnum m_val1;
+ (enumDubrovnik_UnitTests_ReferenceObject__NestedEnum)val1
{
...
static enumDubrovnik_UnitTests_ReferenceObject__NestedEnum m_val2;
+ (enumDubrovnik_UnitTests_ReferenceObject__NestedEnum)val2
{
...
static enumDubrovnik_UnitTests_ReferenceObject__NestedEnum m_val3;
+ (enumDubrovnik_UnitTests_ReferenceObject__NestedEnum)val3
{
...
static enumDubrovnik_UnitTests_ReferenceObject__NestedEnum m_val4;
+ (enumDubrovnik_UnitTests_ReferenceObject__NestedEnum)val4
{
